...
public class SSTextArea {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.maximumLines == sSTextArea.maximumLines && this.maximumLineLength == sSTextArea.maximumLineLength && this.maximumWidth == sSTextArea.maximumWidth && this.maximumHeight == sSTextArea.maximumHeight && this.splitVersion == sSTextArea.splitVersion) {
                return true;
            }
        }
        return false;
