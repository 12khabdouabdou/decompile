...
public class SSScenario {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.scenarioId.equals(sSScenario.scenarioId) && Objects.equals(this.cameoId, sSScenario.cameoId) && equalTexts(this.printableText, sSScenario.printableText) && this.gendersSwapped == sSScenario.gendersSwapped && equalResources(getPreviewResources(), sSScenario.getPreviewResources())) {
            return true;
        }
        return false;
    }
