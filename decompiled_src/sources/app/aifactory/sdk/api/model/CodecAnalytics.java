...
public final class CodecAnalytics {
    ...
    public int hashCode() {
        return ((((((((((((((((((((((AbstractC31823n9f.c(this.colorFormat * 31, 31, this.codecName) + this.width) * 31) + this.height) * 31) + this.tileWidth) * 31) + this.tileHeight) * 31) + this.tileGridRows) * 31) + this.tileGridColumns) * 31) + this.strideValue) * 31) + this.sliceHeight) * 31) + this.cropTop) * 31) + this.cropLeft) * 31) + this.cropRight) * 31) + this.cropBottom;
    }
    ...
    public String toString() {
        ...
        return AbstractC30172lva.B(sb, this.cropBottom, ')');
    }
    ...
    public /* synthetic */ CodecAnalytics(int i, String str, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, AbstractC4267Hr5 abstractC4267Hr5) {
        this((i14 & 1) != 0 ? 0 : i, (i14 & 2) != 0 ? "" : str, (i14 & 4) != 0 ? 0 : i2, (i14 & 8) != 0 ? 0 : i3, (i14 & 16) != 0 ? 0 : i4, (i14 & 32) != 0 ? 0 : i5, (i14 & 64) != 0 ? 0 : i6, (i14 & 128) != 0 ? 0 : i7, (i14 & 256) != 0 ? 0 : i8, (i14 & Chrysalis.PIXEL_LAYOUT_ARGB) != 0 ? 0 : i9, (i14 & 1024) != 0 ? 0 : i10, (i14 & 2048) != 0 ? 0 : i11, (i14 & 4096) != 0 ? 0 : i12, (i14 & 8192) != 0 ? 0 : i13);
    }
}
