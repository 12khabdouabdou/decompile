...
public final class WarpingProcessorSettings {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.premultiplyAlpha == warpingProcessorSettings.premultiplyAlpha && Float.valueOf(this.fpsMultiplier).equals(Float.valueOf(warpingProcessorSettings.fpsMultiplier)) && this.minFramesBeforeStart == warpingProcessorSettings.minFramesBeforeStart) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return AbstractC31823n9f.b(r0 * 31, this.fpsMultiplier, 31) + this.minFramesBeforeStart;
    }
    ...
    public String toString() {
        ...
        return AbstractC30172lva.B(sb, this.minFramesBeforeStart, ')');
    }

    public /* synthetic */ WarpingProcessorSettings(boolean z, float f, int i, int i2, AbstractC4267Hr5 abstractC4267Hr5) {
