...
public final class ScenarioItemKt {
    ...
    static {
        ...
        EMPTY_SCENARIO_ITEM = new ScenarioItem(EMPTY_SCENARIO_ID, null, "", ScenarioType.PERSON1, "", ReenactmentType.FULLSCREEN, ResourceId.EmptyResourceId.INSTANCE, AbstractC41469uN2.a, "", scenarioResources, false);
    }
    ...
    public static final boolean isEmpty(ScenarioItem scenarioItem) {
        return scenarioItem.equals(EMPTY_SCENARIO_ITEM);
    }
