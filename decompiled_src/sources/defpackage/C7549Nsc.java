...
public final class C7549Nsc extends ConnectivityManager.NetworkCallback {
    public LinkProperties a;
    public NetworkCapabilities b;
    public final /* synthetic */ b c;

    public C7549Nsc(b bVar) {
        this.c = bVar;
    }

    public final C11353Usc a(Network network) {
        int i;
        int i2;
        ...
        if (!this.b.hasTransport(1) && !this.b.hasTransport(5)) {
            ...
            if (hasTransport) {
                ...
                return new C11353Usc(true, i, i2, valueOf, isPrivateDnsActive, privateDnsServerName);
            }
        ...
        isPrivateDnsActive = this.a.isPrivateDnsActive();
        privateDnsServerName = this.a.getPrivateDnsServerName();
        return new C11353Usc(true, i, i2, valueOf2, isPrivateDnsActive, privateDnsServerName);
    }
    ...
    public final void onLost(Network network) {
        ...
        b bVar = this.c;
        if (bVar.k) {
            bVar.b(new C11353Usc(false, -1, -1, null, false, ""));
        }
    }
}
