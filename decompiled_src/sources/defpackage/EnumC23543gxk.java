...
public enum EnumC23543gxk implements Nhk {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_IMAGE_LABEL_CREATE(Tweaks.CALLBACK_FETCH_ON_FEED_DELEGATE),
    ON_DEVICE_IMAGE_LABEL_CLOSE(Tweaks.CALLBACK_QUERY_ON_FEED_DELEGATE),
    ON_DEVICE_IMAGE_LABEL_LOAD(Tweaks.CALLBACK_SYNC_ON_FEED_DELEGATE),
    ON_DEVICE_SMART_REPLY_DETECT(Tweaks.LOGIN_PREFETCH_MAX_ENTRIES),
    ON_DEVICE_SMART_REPLY_CREATE(Tweaks.LOGIN_PREFETCH_PAGE_SIZE),
    ON_DEVICE_SMART_REPLY_CLOSE(153),
    ON_DEVICE_SMART_REPLY_BLACKLIST_UPDATE(Tweaks.ENABLE_LOGIN_PREFETCH),
    ON_DEVICE_SMART_REPLY_LOAD(Tweaks.ENABLE_POST_SYNC_QUERY),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_DETECT(Tweaks.ENABLE_AD_SYNC_ON_P2R),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CREATE(Tweaks.ENABLE_STREAK_SETTINGS),
