...
public class IKe extends AbstractC34774pMe {
    public String s;
    public C27321jn9 t;

    public IKe() {
        super("REGISTRATION_FEATURE_AGE_REJECT", EnumC1516Cre.BUSINESS, 1.0d, 0.1d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.A0(ak3, 3, bArr, this.t, set);
