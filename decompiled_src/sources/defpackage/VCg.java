...
@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = WCg.class, schema = "'authClaimMedia':f|m|(r:'[0]', r:'[1]', f(), f(s)),'removeClaimForKey':f|m|(r:'[0]', r:'[1]', f(), f(s)),'addMediaReferenceForKey':f|m|(r:'[0]', r:'[1]', t, d, f(r:'[1]', r:'[2]'), f(s)),'retrieveMediaForId':f|m|(r:'[2]', r:'[1]', r:'[3]', f(t), f(s))", typeReferences = {NativeSnapDocKey.class, NativeSnapDoc.class, Long.class, NativeRequestContext.class})
/* loaded from: classes6.dex */
public interface VCg extends ComposerMarshallable {
