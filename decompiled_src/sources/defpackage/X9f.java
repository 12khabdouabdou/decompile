...
public final class X9f extends Drawable {
    public float a;
    ...
    public X9f(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(Y9f.a(this.e, this.a, this.g)), (int) Math.ceil(Y9f.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
