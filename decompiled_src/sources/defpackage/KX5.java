...
public final class KX5 extends RX5 implements QX5 {
    public final UUID b;
    public final ReplaySubject c;
    public final C11750Vlb d;
    public final SX5 e;

    public KX5(UUID uuid, ReplaySubject replaySubject, C11750Vlb c11750Vlb, SX5 sx5) {
        super("Initialized");
        this.b = uuid;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof KX5) {
                KX5 kx5 = (KX5) obj;
                if (!AbstractC2032Dq9.j(this.b, kx5.b) || !this.c.equals(kx5.c) || !AbstractC2032Dq9.j(this.d, kx5.d) || !AbstractC2032Dq9.j(this.e, kx5.e)) {
                    return false;
                }
                return true;
            }
