...
public final class C43621vyj extends AbstractC47630yyj {
    ...
    public C43621vyj(String str, int i, byte[] bArr, int i2, C36936qyj c36936qyj) {
        this.a = str;
        this.b = i;
        this.c = bArr;
        this.d = i2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C43621vyj) || !super.equals(obj)) {
            return false;
        }
        C43621vyj c43621vyj = (C43621vyj) obj;
        if (!AbstractC2032Dq9.j(this.a, c43621vyj.a)) {
            return false;
        }
        if (this.b != c43621vyj.b) {
            return false;
        }
        if (!Arrays.equals(this.c, c43621vyj.c)) {
            return false;
        }
        if (this.d == c43621vyj.d) {
            return true;
        }
        return false;
    }
