...
public final class C13803Zfi extends SparseArray {
    /* JADX WARN: Type inference failed for: r1v0, types: [android.util.SparseArray, Zfi] */
    public static C13803Zfi a(SparseArray sparseArray) {
        if (sparseArray == null) {
            return null;
        }
        if (sparseArray instanceof C13803Zfi) {
            return (C13803Zfi) sparseArray;
        }
