...
public final class C15948bHj {
    ...
    public static int b(int i, String str) {
        ...
        throw new RuntimeException(EU0.w("Error compiling shader: ", GLES20.glGetShaderInfoLog(glCreateShader)));
    }
    ...
    public final void d() {
        ...
        throw new RuntimeException(EU0.w("Error linking program: ", GLES20.glGetProgramInfoLog(this.a)));
    }
