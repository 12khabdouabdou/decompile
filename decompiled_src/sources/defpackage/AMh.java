...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'displayInfo':g<c>:'[0]'<r:'[1]'>,'viewDelegate':r?:'[2]','cofStore':r?:'[3]','onTap':f(),'snapPlayerViewFactory':r:'[4]','onProfileTap':f?(),'onActionButtonTapped':f?(r<e>:'[5]'),'template':r?<e>:'[6]','onPlayerViewStateUpdate':f?(r<e>:'[7]')", typeReferences = {BridgeObservable.class, C48146zMh.class, StoryChatShareViewDelegate.class, ICOFSynchronousStore.class, ViewFactory.class, StoryChatActionButtonType.class, StoryChatShareViewTemplate.class, StoryChatSharePlayerViewState.class})
/* loaded from: classes3.dex */
public final class AMh extends b {
    private ICOFSynchronousStore _cofStore;
    private BridgeObservable<C48146zMh> _displayInfo;
    ...
    public final void b(C14195Zye c14195Zye) {
        this._onActionButtonTapped = c14195Zye;
    }

    public final void c(DCg dCg) {
        this._onProfileTap = dCg;
    }
    ...
    public AMh(BridgeObservable bridgeObservable, Function0 function0, ViewFactory viewFactory) {
        this._displayInfo = bridgeObservable;
