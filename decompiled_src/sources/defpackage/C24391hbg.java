...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'key':s?,'previewImage':m?<s,u>,'title':s?,'subtitle':s?,'source':r?<e>:'[0]','onTap':f?(),'onSendTap':f?(),'onDeleteTap':f?()", typeReferences = {SharableAttachmentSource.class})
/* renamed from: hbg, reason: case insensitive filesystem */
/* loaded from: classes6.dex */
public final class C24391hbg extends b {
    private String _key;
    ...
    public C24391hbg(String str, Map<String, ? extends Object> map, String str2, String str3, SharableAttachmentSource sharableAttachmentSource, Function0 function0, Function0 function02, Function0 function03) {
        this._key = str;
