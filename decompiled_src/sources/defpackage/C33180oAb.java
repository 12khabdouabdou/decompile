...
public final class C33180oAb implements MemoriesFeatureProvider {
    public final Function4 a;
    public final Function1 b;
    public final Function1 c;

    public C33180oAb(Function4 function4, Function1 function1, Function1 function12) {
        this.a = function4;
        this.b = function1;
        this.c = function12;
    }
    ...
    public BridgeObservable<List<String>> getNearbySnapIds(double d, double d2, double d3, double d4) {
        return (BridgeObservable) this.a.n(Double.valueOf(d), Double.valueOf(d2), Double.valueOf(d3), Double.valueOf(d4));
    }

    @Override // com.snap.memories.api.MemoriesFeatureProvider
    public BridgeObservable<C2511En8> getNearbySnapIdsWithRequest(GetNearbySnapsRequest getNearbySnapsRequest) {
