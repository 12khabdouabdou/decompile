...
public final class C1137Bzd extends b {
    ...
    public C1137Bzd(Ref ref, StoryManifestItem storyManifestItem, PublisherItem publisherItem, StoryDocItem storyDocItem, INativeItem iNativeItem, SpotlightOnlyHighlightItem spotlightOnlyHighlightItem, FeedCardItem feedCardItem) {
        this._baseView = ref;
