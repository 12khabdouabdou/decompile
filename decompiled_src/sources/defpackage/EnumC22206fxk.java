...
public enum EnumC22206fxk implements Nhk {
    NO_ERROR(0),
    ...
    /* JADX INFO: Fake field, exist only in values array */
    REMOTE_MODEL_INVALID(Tweaks.ENABLE_STREAK_EDUCATION),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    LOW_LIGHT_AUTO_EXPOSURE_COMPUTATION_FAILURE(RankingSignals.DEFAULT_IMPORTANCE),
    /* JADX INFO: Fake field, exist only in values array */
