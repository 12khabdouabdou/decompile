...
public class C5028Jbh extends AbstractC29761lch {
    public String o;
    public EnumC5570Kbh p;
    public EnumC6113Lbh q;

    public C5028Jbh() {
        super("SPECTACLES_SNAP_CUSTOM_EXPORT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
