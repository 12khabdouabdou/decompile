...
public abstract class SVe implements InterfaceC33945okb, InterfaceC36129qNb {
    public final PCg a;
    ...
    public final C14845aT3 b(C18893dV3 c18893dV3, List list, int i, IRb iRb) {
        return C14845aT3.a(AbstractC26061iqk.d(((MediaReferenceList) list.get(0)).getMediaReferences(), ICg.i(c18893dV3.h().a()).f0).getContentObject());
    }
    ...
    public final C10622Tjb d(C18893dV3 c18893dV3, String str, int i, IRb iRb) {
        C28594kkb c28594kkb = (C28594kkb) ((ArrayList) h(c18893dV3, str, iRb)).get(0);
    ...
    public final List h(C18893dV3 c18893dV3, String str, IRb iRb) {
        return this.a.c(0, str, Collections.singletonList(c18893dV3.h().a()));
    }
