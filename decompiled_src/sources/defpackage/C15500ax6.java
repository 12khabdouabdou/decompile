...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'packId':s,'price':d,'localizedPrice':s,'localizedTitle':s?,'appleProductId':s?,'googleProductId':s?", typeReferences = {})
/* renamed from: ax6, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C15500ax6 extends b {
    ...
    public C15500ax6(String str, double d, String str2) {
        this._packId = str;
        this._price = d;
    ...
    public C15500ax6(String str, double d, String str2, String str3, String str4, String str5) {
        this._packId = str;
        this._price = d;
        this._localizedPrice = str2;
