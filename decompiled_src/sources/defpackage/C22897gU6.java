...
public final class C22897gU6 extends FilterInputStream {
    ...
    public C22897gU6(InputStream inputStream, int i) {
        super(inputStream);
        if (i >= -1 && i <= 8) {
            this.a = (byte) i;
            return;
        }
        throw new IllegalArgumentException(AbstractC31823n9f.m(i, "Cannot add invalid orientation: "));
    }
