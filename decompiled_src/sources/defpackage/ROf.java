...
public abstract /* synthetic */ class ROf {
    ...
    static {
        ...
        try {
            iArr[ContentType.MY_AI_SPECTACLES_BOT_RESPONSE.ordinal()] = 24;
        } catch (NoSuchFieldError unused24) {
        }
        try {
            iArr[ContentType.STATUS_SNAP_REMIX_CAPTURE.ordinal()] = 25;
        } catch (NoSuchFieldError unused25) {
        }
        try {
            iArr[ContentType.STATUS_STICKER_CUTOUT.ordinal()] = 26;
        } catch (NoSuchFieldError unused26) {
        }
        try {
            iArr[ContentType.STATUS_FRIEND_PLACE_ALERT.ordinal()] = 27;
        } catch (NoSuchFieldError unused27) {
        }
        try {
            iArr[ContentType.UNKNOWN.ordinal()] = 28;
