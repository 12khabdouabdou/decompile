...
public final class NEi extends b {
    ...
    public NEi(String str, String str2, String str3, String str4, double d, double d2, String str5, String str6, TivDeviceData tivDeviceData, double d3, boolean z, TivTransactionDescription tivTransactionDescription) {
        this._userId = str;
        this._username = str2;
        this._avatarId = null;
    ...
    public NEi(String str, String str2, String str3, String str4, String str5, double d, double d2, String str6, String str7, TivDeviceData tivDeviceData, double d3, boolean z, TivTransactionDescription tivTransactionDescription, TivBootstrapReencryptionData tivBootstrapReencryptionData) {
        this._userId = str;
        this._username = str2;
        this._avatarId = str3;
