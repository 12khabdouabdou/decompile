...
public class C29401lLe extends AbstractC30738mLe {
    public Boolean v;
    public Boolean w;
    public String x;
    public Boolean y;
    ...
    public C29401lLe() {
        super("REGISTRATION_RESPONSE_SUGGEST_USERNAME", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.w0(ak3, 3, bArr, this.w, set);
        ...
        AbstractC20835ew8.w0(ak3, 14, bArr, this.y, set);
        AbstractC20835ew8.w0(ak3, 15, bArr, this.z, set);
        AbstractC20835ew8.w0(ak3, 16, bArr, this.o, set);
        AbstractC20835ew8.y0(ak3, 17, bArr, this.p, set);
        AbstractC20835ew8.y0(ak3, 18, bArr, this.r, set);
        AbstractC20835ew8.y0(ak3, 19, bArr, this.q, set);
        ak3.m(bArr);
    }
