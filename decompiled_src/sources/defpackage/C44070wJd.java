...
public final class C44070wJd extends AbstractC32978o17 implements Cloneable {
    public float[] X;
    public float[] Y;
    public float Z;
    public float e0;
    ...
    public final C44070wJd mo0clone() {
        try {
            C44070wJd c44070wJd = (C44070wJd) super.mo0clone();
            float[] fArr = this.X;
            if (fArr != null && fArr.length > 0) {
                c44070wJd.X = (float[]) fArr.clone();
            }
            float[] fArr2 = this.Y;
            if (fArr2 != null && fArr2.length > 0) {
                c44070wJd.Y = (float[]) fArr2.clone();
            }
            return c44070wJd;
