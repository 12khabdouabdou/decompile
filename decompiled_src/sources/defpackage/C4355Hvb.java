...
public final class C4355Hvb extends b {
    ...
    public C4355Hvb(String str, IMembersDataProvider iMembersDataProvider, IMembersActionHandler iMembersActionHandler, INavigator iNavigator, Map<String, ? extends Object> map, Boolean bool, Boolean bool2, ICOFStore iCOFStore, Boolean bool3) {
        this._groupId = str;
