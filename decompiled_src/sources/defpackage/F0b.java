...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'layerIdentifier':s,'api':r:'[0]','componentName':s,'scrollOffsetSubject':g?<c>:'[1]'<d@>,'closeHandler':r:'[2]','options':r?:'[3]'", typeReferences = {MapLayerApi.class, BridgeSubject.class, MapLayerCloseHandler.class, MapLayerOptions.class})
/* loaded from: classes5.dex */
public final class F0b extends b {
    ...
    public F0b(String str, MapLayerApi mapLayerApi, String str2, BridgeSubject<Double> bridgeSubject, MapLayerCloseHandler mapLayerCloseHandler, MapLayerOptions mapLayerOptions) {
