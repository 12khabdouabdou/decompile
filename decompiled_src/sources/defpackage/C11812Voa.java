...
public final class C11812Voa extends AbstractC16175bSi implements ListIterator {
    public final /* synthetic */ int b;
    public final /* synthetic */ AbstractList c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ C11812Voa(AbstractList abstractList, ListIterator listIterator, int i) {
        super(listIterator);
        this.b = i;
        this.c = abstractList;
    }
    ...
    public final Object a(Object obj) {
        switch (this.b) {
            case 0:
                return ((C12355Woa) this.c).b.apply(obj);
            default:
                return ((C12898Xoa) this.c).b.apply(obj);
        }
    }
