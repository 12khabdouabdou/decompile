...
public final class C11996Vx7 {
    ...
    public final int i(C43229vh1 c43229vh1, int[] iArr) {
        ByteBuffer byteBuffer = this.a;
        Integer[] numArr = new Integer[iArr.length];
        for (int i = 0; i < iArr.length; i++) {
            numArr[i] = Integer.valueOf(iArr[i]);
        }
        Arrays.sort(numArr, new C40989u0g(c43229vh1, byteBuffer));
