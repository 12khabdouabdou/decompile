...
public class W01 extends AbstractC24724hqj {
    ...
    public W01() {
        super("BITMOJI_AVATAR_BUILDER_CATEGORY_EXIT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final int e(Map map) {
        ...
        Long l = (Long) map.get("bitmoji_avatar_builder_category_session_length");
        this.p = l;
        if (l != null) {
            e++;
        }
