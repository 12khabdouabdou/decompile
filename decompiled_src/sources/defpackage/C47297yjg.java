...
public final class C47297yjg extends b {
    ...
    public C47297yjg(IAlertPresenter iAlertPresenter) {
    ...
    public final void d(C0265Ajg c0265Ajg) {
        this._dismissShoppingPreferencePage = c0265Ajg;
    }
    ...
    public C47297yjg(IAlertPresenter iAlertPresenter, Function0 function0, GrpcServiceProtocol grpcServiceProtocol, BridgeObservable<ShowcaseRouteTagType> bridgeObservable, INotificationPresenter iNotificationPresenter, Logging logging, ShoppingHubBaseBlizzardEvent shoppingHubBaseBlizzardEvent, BridgeObservable<String> bridgeObservable2, Function0 function02, BridgeObservable<Double> bridgeObservable3, INavigator iNavigator, IActionSheetPresenter iActionSheetPresenter, BridgeObservable<VU8> bridgeObservable4, String str) {
        this._alertPresenter = iAlertPresenter;
