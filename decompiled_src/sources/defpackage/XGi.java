...
public final class XGi extends b {
    ...
    private BridgeSubject<C42224uw3> _heroBannerMetadataObserver;
    ...
    public final void e(TokenShopCarouselHandler tokenShopCarouselHandler) {
    ...
    public final void n(C19728e6h c19728e6h) {
        this._showOnboardingDialog = c19728e6h;
    }
    ...
    public XGi(TokenShopService tokenShopService, String str, IAlertPresenter iAlertPresenter, INotificationPresenter iNotificationPresenter, TokenShopCarouselHandler tokenShopCarouselHandler, BridgeSubject<ComposerCarouselMetadata> bridgeSubject, BridgeSubject<C42224uw3> bridgeSubject2, IActionSheetPresenter iActionSheetPresenter, Function1 function1, TokenShopSourceType tokenShopSourceType, Boolean bool, Logging logging, Function0 function0, Function2 function2, GamesActionHandler gamesActionHandler, CognacGameMetadataFetcher cognacGameMetadataFetcher, ICOFStore iCOFStore, Boolean bool2, String str2) {
        this._tokenShopService = tokenShopService;
        this._locale = str;
        this._alertPresenter = iAlertPresenter;
        this._notificationPresenter = iNotificationPresenter;
