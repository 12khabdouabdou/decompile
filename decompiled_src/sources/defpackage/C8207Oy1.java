...
public final class C8207Oy1 extends AbstractC44253wS8 {
    public final String h;
    public final String i;

    public C8207Oy1(String str, String str2) {
        this.g = str;
        this.h = str2;
        this.i = "2018-03-06";
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [java.lang.Throwable, By1, java.lang.Exception] */
    /* JADX WARN: Type inference failed for: r2v3, types: [java.lang.Throwable, pR6, java.lang.Exception] */
    @Override // defpackage.AbstractC44253wS8
        ...
        try {
            ...
            if (optJSONArray != null) {
                    ...
                    if (optJSONObject != null) {
                        ...
                        if (!optString.equals("50000")) {
                            if (!optJSONObject.isNull("errorType")) {
                                str2 = optJSONObject.optString("errorType", "");
                            }
                            if (!str2.equals("user_error")) {
                ...
                try {
                    ...
                    ArrayList b = C3322Fy1.b(jSONArray);
                    exc.t = b;
                    if (b.isEmpty()) {
                        exc.b = jSONArray.getJSONObject(0).getString("message");
                    } else {
                        exc.b = "Input is invalid.";
                    }
                    throw exc;
            ...
            try {
                ...
                exc2.a = Zsk.g(jSONObject2, "developer_message", "No message was returned");
                ...
                for (int i2 = 0; i2 < optJSONArray2.length(); i2++) {
                    try {
                        arrayList.add(C0561Ay1.a(optJSONArray2.getJSONObject(i2)));
