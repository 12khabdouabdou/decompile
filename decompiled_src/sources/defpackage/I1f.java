...
public final class I1f extends b {
    ...
    public I1f(byte[] bArr, List<C47173ye2> list, SubscriptionInfo subscriptionInfo, BillboardStringsService billboardStringsService, byte[] bArr2, Logging logging) {
        this._config = bArr;
        this._products = list;
