...
public final class RGd {
    ...
    public RGd(String str, List list, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        this.a = list;
        this.b = z;
        this.c = z2;
        this.d = str;
    ...
    public final boolean equals(Object obj) {
        ...
        RGd rGd = (RGd) obj;
        if (AbstractC2032Dq9.j(this.a, rGd.a) && this.b == rGd.b && this.c == rGd.c && AbstractC2032Dq9.j(this.d, rGd.d) && this.e == rGd.e && this.f == rGd.f && this.g == rGd.g) {
            return true;
        }
        return false;
    }
