...
public class C1390Cld extends AbstractC34774pMe {
    public EnumC28985l26 s;
    public EnumC1932Dld t;
    public String u;

    public C1390Cld() {
        super("PHONE_VERIFICATION_RECEIVER_RESULT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
