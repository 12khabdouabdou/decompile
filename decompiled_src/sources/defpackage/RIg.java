...
public class RIg extends PIg {
    public Boolean p;
    public EnumC23988hIa q;
    public Boolean r;
    public Long s;
    public EnumC44025wHa t;
    public Boolean u;
    public Boolean v;
    public ArrayList w;
    public ArrayList x;
    ...
    public RIg() {
        super("SNAP_KIT_USER_CONNECT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.I0(ak3, 10, bArr, this.x, set);
        AbstractC20835ew8.I0(ak3, 11, bArr, this.w, set);
