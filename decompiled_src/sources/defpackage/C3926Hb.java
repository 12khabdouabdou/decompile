...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'type':r:'[0]','text':s,'accessibilityId':s?,'desc':s?,'thumbnail':r?:'[1]','icon':r?:'[1]','nested':r?:'[2]','toggled':b@?,'onTap':f?(),'onToggle':f?(b@),'isActionSheetItemEnabled':b@?", typeReferences = {ActionSheetItemType.class, Asset.class, ActionSheetOptions.class})
/* renamed from: Hb, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C3926Hb extends b {
    ...
    public C3926Hb(ActionSheetItemType actionSheetItemType, String str, String str2, String str3, Asset asset, Asset asset2, ActionSheetOptions actionSheetOptions, Boolean bool, Function0 function0, Function1 function1, Boolean bool2) {
