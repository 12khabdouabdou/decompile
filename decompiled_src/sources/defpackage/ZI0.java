...
public final class ZI0 {
    public static final int[] a = AbstractC31519mvk.a("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");
    public static final int[] b = AbstractC31519mvk.a("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=");
    ...
    public static String c(byte[] bArr, boolean z) {
        ...
        if (length != 1) {
            if (length == 2) {
                int i3 = i + 1;
                int i4 = (bArr[i3] & 255) | ((bArr[i] & 255) << 8);
    ...
    public static /* synthetic */ String d(int i, byte[] bArr) {
        boolean z;
        if ((i & 2) != 0) {
            z = false;
        } else {
