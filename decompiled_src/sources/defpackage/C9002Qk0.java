...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'attachmentCardType':r<e>:'[0]','primaryText':s?,'secondaryText':s?,'tertiaryText':s?,'previewUrl':s?,'badgeUrl':s?,'onTap':f?(),'onDoubleTap':f?(r:'[1]'),'onLongPress':f?(r:'[1]'),'onThumbnailLoaded':f?(b@),'ctaButtons':a?<r:'[2]'>", typeReferences = {AttachmentCardType.class, Ref.class, C41895uh4.class})
/* renamed from: Qk0, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C9002Qk0 extends b {
    ...
    public C9002Qk0(AttachmentCardType attachmentCardType) {
    ...
    public C9002Qk0(AttachmentCardType attachmentCardType, String str, String str2, String str3, String str4, String str5, Function0 function0, Function1 function1, Function1 function12, Function1 function13, List<C41895uh4> list) {
        this._attachmentCardType = attachmentCardType;
        this._primaryText = str;
