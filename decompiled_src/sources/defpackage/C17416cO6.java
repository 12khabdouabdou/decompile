...
public final class C17416cO6 extends AbstractC32978o17 {
    public int a = 0;
    public long b = 0;
    public long c = 0;
    public long t = 0;
    ...
    public final int computeSerializedSize() {
        ...
        if ((this.a & SQLiteDatabase.OPEN_PRIVATECACHE) != 0) {
            computeSerializedSize += C39067sa3.k(19, this.q0);
        }
        if ((this.a & ImageMetadata.LENS_APERTURE) != 0) {
            computeSerializedSize += C39067sa3.k(20, this.r0);
        }
        if ((this.a & ImageMetadata.SHADING_MODE) != 0) {
            computeSerializedSize += C39067sa3.k(21, this.s0);
        }
        if ((this.a & 2097152) != 0) {
            computeSerializedSize += C39067sa3.k(22, this.t0);
        }
        if ((this.a & 4194304) != 0) {
            computeSerializedSize += C39067sa3.k(23, this.u0);
        }
        if ((this.a & 8388608) != 0) {
            computeSerializedSize += C39067sa3.k(24, this.v0);
        }
        if ((this.a & 16777216) != 0) {
            computeSerializedSize += C39067sa3.k(25, this.w0);
        }
        if ((this.a & 33554432) != 0) {
            computeSerializedSize += C39067sa3.k(26, this.x0);
        }
        if ((this.a & 67108864) != 0) {
            computeSerializedSize += C39067sa3.k(27, this.y0);
        }
        if ((this.a & 134217728) != 0) {
            computeSerializedSize += C39067sa3.k(28, this.z0);
        }
        if ((this.a & 268435456) != 0) {
            return C39067sa3.k(29, this.A0) + computeSerializedSize;
        }
    ...
    public final void writeTo(C39067sa3 c39067sa3) {
        ...
        if ((this.a & SQLiteDatabase.OPEN_PRIVATECACHE) != 0) {
            c39067sa3.J(19, this.q0);
        }
        if ((this.a & ImageMetadata.LENS_APERTURE) != 0) {
            c39067sa3.J(20, this.r0);
        }
        if ((this.a & ImageMetadata.SHADING_MODE) != 0) {
            c39067sa3.J(21, this.s0);
        }
        if ((this.a & 2097152) != 0) {
            c39067sa3.J(22, this.t0);
        }
        if ((this.a & 4194304) != 0) {
            c39067sa3.J(23, this.u0);
        }
        if ((this.a & 8388608) != 0) {
            c39067sa3.J(24, this.v0);
        }
        if ((this.a & 16777216) != 0) {
            c39067sa3.J(25, this.w0);
        }
        if ((this.a & 33554432) != 0) {
            c39067sa3.J(26, this.x0);
        }
        if ((this.a & 67108864) != 0) {
            c39067sa3.J(27, this.y0);
        }
        if ((this.a & 134217728) != 0) {
            c39067sa3.J(28, this.z0);
        }
        if ((this.a & 268435456) != 0) {
            c39067sa3.J(29, this.A0);
        }
