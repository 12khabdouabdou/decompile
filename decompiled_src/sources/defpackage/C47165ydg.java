...
public final class C47165ydg extends b {
    ...
    public C47165ydg(List<? extends ShareDestination> list, List<? extends ShareDestination> list2, ShareSheetStyle shareSheetStyle, Boolean bool, ShareSheetTitle shareSheetTitle, ShareSheetStyleConfig shareSheetStyleConfig, Boolean bool2, Boolean bool3) {
        this._availableDestinations = list;
