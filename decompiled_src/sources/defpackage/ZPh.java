...
public enum ZPh implements InterfaceC22815gQ6 {
    VIEW(0),
    OPEN_ACTION_MENU(1),
    SEND(2),
    SHARE_EXTERNALLY(3),
    ...
    BLOCK_USER(119),
    SCRUB(120),
    REPOST_PUBLIC_CONTENT(121),
    UNREPOST_PUBLIC_CONTENT(122),
    OPEN_ORGANIC_ATTACHMENT(123),
    CHAT_OPEN(124),
    OPEN_PUBLIC_STORY(126),
    HIDE_NOT_INTERESTED(127),
    FEED_TOGGLE(128),
    OPEN_REPOSTERS_TRAY(129),
    SUBTITLES_TURN_ON(130),
    SUBTITLES_TURN_OFF(131),
    DESCRIPTION_EXPAND(132),
    DESCRIPTION_COLLAPSE(133);
