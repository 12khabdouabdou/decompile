...
public class P7h extends AbstractC29761lch {
    public String o;
    public String p;
    public EnumC38866sQa q;
    public TQa r;
    public WQa s;
    public A5h t;
    public Double u;
    ...
    public P7h() {
        super("SPECTACLES_MAGIC_MOMENT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.x0(ak3, 5, bArr, this.u, set);
        ...
        AbstractC20835ew8.y0(ak3, 15, bArr, this.s, set);
        AbstractC20835ew8.x0(ak3, 16, bArr, this.w, set);
