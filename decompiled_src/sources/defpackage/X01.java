...
public class X01 extends AbstractC24724hqj {
    ...
    public X01() {
        super("BITMOJI_AVATAR_BUILDER_CATEGORY_LOAD", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final int e(Map map) {
        ...
        if (map.containsKey("source")) {
            ...
            if (obj5 instanceof String) {
                this.n = Z8d.valueOf((String) obj5);
            } else {
                this.n = (Z8d) obj5;
            }
            return e + 1;
