...
public final class L79 extends b {
    ...
    public final void h(VPc vPc) {
        this._showMyNameDeprecation = vPc;
    }

    public final void i(C27872kCa c27872kCa) {
        this._updatePublicProfiles = c27872kCa;
    }

    public L79(ClientProtocol clientProtocol, IAlertPresenter iAlertPresenter, Function1 function1, String str, String str2, ImpalaMainServiceConfig impalaMainServiceConfig, Logging logging, ImpalaProfileOnboardingType impalaProfileOnboardingType, Boolean bool, OnboardingShowMyName onboardingShowMyName, Boolean bool2) {
