...
public final class LX5 extends RX5 implements QX5 {
    public final UUID b;
    public final ReplaySubject c;

    public LX5(UUID uuid, ReplaySubject replaySubject) {
        super("Initializing");
        this.b = uuid;
    ...
    public final boolean equals(Object obj) {
        ...
        LX5 lx5 = (LX5) obj;
        if (AbstractC2032Dq9.j(this.b, lx5.b) && AbstractC2032Dq9.j(this.c, lx5.c)) {
            return true;
        }
        return false;
    }
