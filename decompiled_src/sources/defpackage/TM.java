...
public final class TM extends YM implements InterfaceC33712oZj {
    public final int a;
    public final EnumC19796e9j b;
    public final AbstractC43575vwh c;

    public TM(int i, EnumC19796e9j enumC19796e9j, AbstractC43575vwh abstractC43575vwh) {
        this.a = i;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof TM) {
                TM tm = (TM) obj;
                if (this.a != tm.a || this.b != tm.b || !AbstractC2032Dq9.j(this.c, tm.c)) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        return "AddUnlock(source=" + OOi.m(this.a) + ", unlockType=" + this.b + ", status=" + this.c + ")";
    }
}
