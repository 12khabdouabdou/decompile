...
public final class C9954Sdb extends b {
    ...
    public C9954Sdb(ClientProtocol clientProtocol, LensMarkerServerEnv lensMarkerServerEnv, MarkerProfileActionHandler markerProfileActionHandler, ILensActionHandler iLensActionHandler, Logging logging, Map<String, ? extends Object> map, BridgeObservable<Boolean> bridgeObservable, BridgeObservable<Boolean> bridgeObservable2) {
