...
public final class C34261oyj extends AbstractC35598pyj {
    ...
    public C34261oyj(String str, String str2, int i, byte[] bArr, int i2, C36936qyj c36936qyj) {
        this.a = str;
        this.b = str2;
        this.c = i;
        this.d = bArr;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C34261oyj) || !super.equals(obj)) {
            return false;
        }
        C34261oyj c34261oyj = (C34261oyj) obj;
        if (!AbstractC2032Dq9.j(this.a, c34261oyj.a)) {
            return false;
        }
        if (!AbstractC2032Dq9.j(this.b, c34261oyj.b)) {
            return false;
        }
        if (this.c != c34261oyj.c) {
            return false;
        }
        if (!Arrays.equals(this.d, c34261oyj.d)) {
            return false;
        }
        if (this.e == c34261oyj.e) {
            return true;
        }
        return false;
    }
