...
public final class Gw2 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                Fw2 fw2 = (Fw2) arrayList.get(size);
                int i = fw2.c;
                if (i == length) {
                    fw2.c = i - 1;
                } else {
    ...
    public final C5162Ji4 c(int i) {
        ...
        return new C5162Ji4(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i9, 1, Imgproc.CV_CANNY_L2_GRADIENT, f, i2, Imgproc.CV_CANNY_L2_GRADIENT, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Imgproc.CV_CANNY_L2_GRADIENT, 0.0f);
    }
