...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'onTapUrl':f?(s),'handleOnboardingResponse':f?(b@),'tokenShopGrpcService':r?:'[0]','tokenShopService':r?:'[1]','blizzardLogger':r?:'[2]','entryPoint':r?:'[3]'", typeReferences = {GrpcServiceProtocol.class, TokenShopService.class, Logging.class, TokenShopSourceType.class})
/* loaded from: classes8.dex */
public final class HRg extends b {
    ...
    public final void c(LRg lRg) {
        this._handleOnboardingResponse = lRg;
    }
    ...
    public HRg(Function1 function1, Function1 function12, GrpcServiceProtocol grpcServiceProtocol, TokenShopService tokenShopService, Logging logging, TokenShopSourceType tokenShopSourceType) {
        this._onTapUrl = function1;
