...
public final class C24335hZ3 extends b {
    ...
    private Function1 _onUpdateMentionButtonVisibility;
    private ContextReplyAllTweaks _tweaks;

    public C24335hZ3(FriendStoring friendStoring, IBlockedUserStore iBlockedUserStore) {
        ...
        this._onUpdateMentionButtonVisibility = null;
    ...
    public final void f(C20252eVe c20252eVe) {
        this._onAndroidViewNeedsFocus = c20252eVe;
    }
    ...
    public final void h(C20252eVe c20252eVe) {
        this._onEnterSelection = c20252eVe;
    }

    public final void i(C45658xVe c45658xVe) {
        this._onExitSelection = c45658xVe;
    }

    public final void j(C36821qte c36821qte) {
        this._onSelectionComplete = c36821qte;
    }
    ...
    public C24335hZ3(FriendStoring friendStoring, IBlockedUserStore iBlockedUserStore, Function0 function0, Function0 function02, Function1 function1, Function0 function03, Function0 function04, IApplication iApplication, ContextReplyAllTweaks contextReplyAllTweaks, IAlertPresenter iAlertPresenter, BridgeObservable<List<String>> bridgeObservable, BridgeObservable<Boolean> bridgeObservable2, Function1 function12, BridgeObservable<Boolean> bridgeObservable3, BridgeSubject<Double> bridgeSubject, BridgeObservable<Boolean> bridgeObservable4) {
        ...
        this._onUpdateMentionButtonVisibility = function12;
