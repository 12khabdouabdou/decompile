...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'user':r:'[0]','localizedSuggestionReason':s?,'suggestionToken':s?,'isViewed':b@?,'showFeedback':b@?,'isDismissed':b@?,'isInMyContacts':b@?,'hasActiveStory':b@?,'isSelected':b@?", typeReferences = {User.class})
/* loaded from: classes4.dex */
public final class W8i extends b {
    ...
    public W8i(User user, String str, String str2, Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, Boolean bool6) {
        this._user = user;
        this._localizedSuggestionReason = str;
