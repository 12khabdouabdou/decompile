...
public class C37448rMe extends AbstractC34774pMe {
    public String s;
    public EnumC28985l26 t;
    public Boolean u;

    public C37448rMe() {
        super("REGISTRATION_USER_VERIFY_PHONE", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.w0(ak3, 10, bArr, this.u, set);
