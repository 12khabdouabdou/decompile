...
public final class C6861Mld implements InterfaceC33304oG8 {
    ...
    public C6861Mld(C18656dJe c18656dJe, C13923Zld c13923Zld, long j, String str, SingleEmitter singleEmitter) {
        this.a = c18656dJe;
        this.b = c13923Zld;
        this.c = j;
        this.d = str;
    ...
    public final void a(MessageNano messageNano, Status status) {
        ...
        if (i6 != null) {
            num = Integer.valueOf(i6.t);
        } else {
            num = null;
        }
        Integer num2 = num;
        c44666wld.b(status, num2, 2, true, this.d, c18656dJe.a, 10, null);
        this.e.onSuccess(new C24366had(i6, status));
    }
}
