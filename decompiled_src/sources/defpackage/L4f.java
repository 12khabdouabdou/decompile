...
public final class L4f extends b {
    ...
    public L4f(INavigator iNavigator, Logging logging, RestorePageLoggingContext restorePageLoggingContext, IAlertPresenter iAlertPresenter, Service service, RestorePageActionHandler restorePageActionHandler, String str, ICOFRxStore iCOFRxStore, LocalSubscriptionStore localSubscriptionStore, SubscribePagePresenter subscribePagePresenter, InAppBrowserPresenter inAppBrowserPresenter) {
