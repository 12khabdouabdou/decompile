...
public class T3g extends AbstractC24724hqj {
    public Z8d j;
    ...
    public T3g() {
        super("SETTING_BITMOJI_EDIT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final int e(Map map) {
        ...
        String str4 = (String) map.get("bitmoji_session_id");
        this.n = str4;
        if (str4 != null) {
            e++;
        }
        String str5 = (String) map.get("profile_session_id");
        this.r = str5;
        if (str5 != null) {
            e++;
        }
