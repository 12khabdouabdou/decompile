...
public class C43363vn3 extends C42026un3 {
    public C43363vn3() {
        super("COMMERCE_STORE_CATEGORY_HEADER_TAP_EVENT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.z0(ak3, 45, bArr, this.l0, set);
        AbstractC20835ew8.y0(ak3, 46, bArr, this.y, set);
        AbstractC20835ew8.y0(ak3, 47, bArr, this.x, set);
        AbstractC20835ew8.B0(ak3, 48, bArr, this.j, set);
        AbstractC20835ew8.B0(ak3, 49, bArr, this.Y, set);
        AbstractC20835ew8.B0(ak3, 50, bArr, this.d0, set);
        AbstractC20835ew8.y0(ak3, 51, bArr, this.Z, set);
        AbstractC20835ew8.B0(ak3, 52, bArr, this.c0, set);
        AbstractC20835ew8.w0(ak3, 53, bArr, this.e0, set);
        AbstractC20835ew8.B0(ak3, 54, bArr, this.a0, set);
        AbstractC20835ew8.B0(ak3, 55, bArr, this.b0, set);
