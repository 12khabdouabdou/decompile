...
public final class C37761rbd {
    ...
    public C37761rbd(byte[] bArr, int i, int i2) {
        this.a = 1;
        this.b = bArr;
        this.d = i;
        this.c = i2;
    ...
    public C37761rbd(byte[] bArr) {
        this.a = 2;
        this.b = bArr;
        this.c = bArr.length;
    }

    public C37761rbd(byte[] bArr, int i) {
        this.a = 0;
        this.b = bArr;
        this.e = i;
    }
