...
public final class C40504tef implements Comparable {
    ...
    public C40504tef(long j) {
        this.a = j;
    }

    public static C40504tef a(C41840uef c41840uef) {
        int i;
        double d;
        double d2;
        double d3;
        ...
        double d5;
        double d6;
        double d7 = c41840uef.a;
        double cos = Math.cos(d7);
        double d8 = c41840uef.b;
        double cos2 = Math.cos(d8) * cos;
        double sin = Math.sin(d8) * cos;
        double sin2 = Math.sin(d7);
        C35155pef c35155pef = AbstractC43177vef.a;
        ...
        int max = (int) Math.max(0L, Math.min(1073741823L, Math.round((AbstractC43177vef.a(d2) * 5.36870912E8d) + 5.368709115E8d)));
        int max2 = (int) Math.max(0L, Math.min(1073741823L, Math.round((AbstractC43177vef.a(d3) * 5.36870912E8d) + 5.368709115E8d)));
        ...
        return new C40504tef((((jArr[1] << 32) + jArr[0]) << 1) + 1);
    }
    ...
    public static void b(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        for (int i13 = 0; i13 < 4; i13++) {
            ...
            int i14 = AbstractC36492qef.b[i6][i13];
            if (i13 >= 0 && i13 < 4) {
                z3 = true;
            } else {
                z3 = false;
            ...
            b(i9, (i14 >>> 1) + i10, (i14 & 1) + i11, i4, i12 + i13, i6 ^ AbstractC36492qef.a[i13]);
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C40504tef)) {
            return false;
        }
        if (this.a != ((C40504tef) obj).a) {
            return false;
        }
        return true;
    }
