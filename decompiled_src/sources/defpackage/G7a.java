...
public final class G7a extends AbstractC37275rE9 implements Function1 {
    public final /* synthetic */ int a;
    public final /* synthetic */ Z9a b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ G7a(Z9a z9a, int i) {
        super(1);
        this.a = i;
        this.b = z9a;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        switch (this.a) {
            case 0:
                ...
                Iterator it = ((X9a) this.b).a.iterator();
                while (true) {
                    if (it.hasNext()) {
                        obj2 = it.next();
            ...
            default:
                ...
                Iterator it2 = ((X9a) this.b).a.iterator();
                while (true) {
                    if (it2.hasNext()) {
                        obj3 = it2.next();
