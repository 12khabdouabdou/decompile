...
public final class C20451eek extends g implements InterfaceC21932fla {
    ...
    public final void Y0(I6k i6k) {
        ...
        if (!map.containsKey("ConnectionlessLifecycleHelper")) {
            ...
            if (this.b > 0) {
                new HandlerC42484v7k(Looper.getMainLooper()).post(new RunnableC11946Vuj(this, i6k, false, 25));
                return;
            }
            return;
        }
