...
public class C8423Pi7 extends AbstractC3518Gh7 {
    public EnumC29743lc t;
    public Double u;
    public Double v;

    public C8423Pi7() {
        super("FEED_PAGE_SCROLL", EnumC1516Cre.BEST_EFFORT, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.x0(ak3, 6, bArr, this.v, set);
        AbstractC20835ew8.x0(ak3, 7, bArr, this.u, set);
