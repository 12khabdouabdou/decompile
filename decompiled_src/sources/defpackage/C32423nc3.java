...
public class C32423nc3 extends C44436wb3 {
    public Boolean l;
    public Long m;
    public EnumC22639gHi n;
    public String o;

    public C32423nc3() {
        super("COGNAC_SHOP_BANNER_IMPRESSION", EnumC1516Cre.BUSINESS, 1.0d, 0.1d, 1.0d);
    }
    ...
    public final int e(Map map) {
        ...
        if (map.containsKey("source")) {
            ...
            if (obj instanceof String) {
                this.n = EnumC22639gHi.valueOf((String) obj);
            } else {
                this.n = (EnumC22639gHi) obj;
            }
            return e + 1;
        }
        return e;
