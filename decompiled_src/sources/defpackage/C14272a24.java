...
public final class C14272a24 extends b {
    ...
    private ConversationService _streakRestoreService;
    private SubscribePagePresenter _subscribePagePresenter;
    private LocalSubscriptionStore _subscriptionStore;

    public C14272a24(INavigator iNavigator, Logging logging, RestorePageLoggingContext restorePageLoggingContext, IAlertPresenter iAlertPresenter, ConversationService conversationService, RestorePageActionHandler restorePageActionHandler, String str, ICOFRxStore iCOFRxStore, LocalSubscriptionStore localSubscriptionStore, SubscribePagePresenter subscribePagePresenter, InAppBrowserPresenter inAppBrowserPresenter) {
        this._navigator = iNavigator;
        this._blizzardLogger = logging;
        this._loggingContext = restorePageLoggingContext;
        this._alertPresenter = iAlertPresenter;
        this._streakRestoreService = conversationService;
