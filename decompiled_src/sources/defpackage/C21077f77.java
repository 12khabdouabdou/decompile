...
public final class C21077f77 extends b {
    ...
    public C21077f77(INavigator iNavigator) {
    ...
    public C21077f77(INavigator iNavigator, IAlertPresenter iAlertPresenter, EmptyStateController emptyStateController, IMemoriesFaceClusterStore iMemoriesFaceClusterStore, IMemoriesPickerActionHandler iMemoriesPickerActionHandler, IMemoriesFaceTaggingClickHandler iMemoriesFaceTaggingClickHandler, IMemoriesFaceTaggingActionsHandler iMemoriesFaceTaggingActionsHandler, IMemoriesFriendsStore iMemoriesFriendsStore, IActionSheetPresenter iActionSheetPresenter, TrackedThumbnailNotifier trackedThumbnailNotifier) {
        this._navigator = iNavigator;
        this._alertPresenter = iAlertPresenter;
