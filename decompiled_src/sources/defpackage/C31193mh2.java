...
public final class C31193mh2 implements Function {
    public final /* synthetic */ int a;
    public final /* synthetic */ int b;
    public final /* synthetic */ Canvas c;

    public C31193mh2(int i, int i2, Canvas canvas) {
        this.a = i;
        this.b = i2;
        this.c = canvas;
    }
    ...
    public final Object apply(Object obj) {
        ...
        canvas.drawBitmap(A2, Dmk.c(i, width, height, width2, height2, width3, height3, doubleValue, ((float) c25823ig2.d().b().doubleValue()) - (height / 2), 1.0f, (float) Math.toRadians(c25823ig2.p())), null);
        c22676gJe.dispose();
