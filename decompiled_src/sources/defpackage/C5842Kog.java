...
public final class C5842Kog {
    ...
    public C5842Kog(Context context, String str) {
        this.a = C39004sX3.c(context, R.color.f23190_resource_name_obfuscated_res_0x7f060314);
        Paint paint = new Paint(1);
        paint.setStyle(Paint.Style.FILL);
        this.b = paint;
        this.c = AbstractC37619rUi.r(str);
        this.d = 255;
    }

    public final void a(Canvas canvas) {
        C44490wdd c44490wdd = this.e;
        if (c44490wdd != null) {
            Paint paint = this.b;
            paint.setStyle(Paint.Style.FILL);
            int i = this.c;
            paint.setColor(Color.argb(this.d, Color.red(i), Color.green(i), Color.blue(i)));
            canvas.drawPath(c44490wdd.a, paint);
            int i2 = this.d / 5;
            int i3 = this.a;
            paint.setColor(Color.argb(i2, Color.red(i3), Color.green(i3), Color.blue(i3)));
            canvas.drawPath(c44490wdd.b, paint);
        }
    }
    ...
    public final void b(int i, int i2) {
        ...
        if (obj == null) {
            ...
            C44490wdd c44490wdd = new C44490wdd(path, path2);
            Object putIfAbsent = r2.putIfAbsent(valueOf, c44490wdd);
            if (putIfAbsent == null) {
                obj = c44490wdd;
            } else {
                obj = putIfAbsent;
