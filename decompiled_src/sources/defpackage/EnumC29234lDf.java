...
public enum EnumC29234lDf implements InterfaceC22815gQ6 {
    UNKNOWN(0),
    ...
    NEARBY_MEMORIES(121),
    SETTINGS(123),
    SEARCH_QUERY_SUGGESTIONS(133),
    TOP_GROUPS(135),
    MY_AI(Tweaks.SPONSORED_SNAPS_FEED_INSERT_MODE),
    QUERY_SUGGESTIONS_POST_TYPE(Tweaks.SPONSORED_SNAPS_USER_INPUT_MODE),
    HOW_TO_PRETYPE(124),
    LENS_PRETYPE(125),
    GAMES_PRETYPE(126),
    STARS_PRETYPE(127),
    PLACES_PRETYPE(128),
    PUBLISHERS_PRETYPE(131),
    ACTIVITY_CENTER_PRETYPE(134),
    PLACES_FOR_YOU(120),
    PLACES_CATEGORIES(132),
    FROM_CONTACTS(122),
