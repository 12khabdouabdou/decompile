...
public abstract /* synthetic */ class AbstractC20343ea0 {
    ...
    static {
        ...
        c = iArr3;
        int[] iArr4 = new int[KZ7.values().length];
        try {
            iArr4[KZ7.TEXT.ordinal()] = 1;
        } catch (NoSuchFieldError unused9) {
        }
        try {
            iArr4[KZ7.TEXT_STORY_REPLY.ordinal()] = 2;
        } catch (NoSuchFieldError unused10) {
        }
        try {
            iArr4[KZ7.CHAT_MEDIA.ordinal()] = 3;
        } catch (NoSuchFieldError unused11) {
        }
        try {
            iArr4[KZ7.AUDIO_NOTE.ordinal()] = 4;
        } catch (NoSuchFieldError unused12) {
        }
        try {
            iArr4[KZ7.SNAPDOC.ordinal()] = 5;
        } catch (NoSuchFieldError unused13) {
        }
        try {
            iArr4[KZ7.EMOJI_STICKER.ordinal()] = 6;
        } catch (NoSuchFieldError unused14) {
        }
        try {
            iArr4[KZ7.INCLUDED_STICKER.ordinal()] = 7;
        } catch (NoSuchFieldError unused15) {
        }
        try {
            iArr4[KZ7.CUSTOM_STICKER.ordinal()] = 8;
        } catch (NoSuchFieldError unused16) {
        }
        try {
            iArr4[KZ7.STORY_SHARE.ordinal()] = 9;
        } catch (NoSuchFieldError unused17) {
        }
        try {
            iArr4[KZ7.MAP_SHARE_SNAP.ordinal()] = 10;
        } catch (NoSuchFieldError unused18) {
        }
        try {
            iArr4[KZ7.MAP_SHARE_STORY.ordinal()] = 11;
        } catch (NoSuchFieldError unused19) {
        }
        try {
            iArr4[KZ7.SEARCH_SHARE_SNAP.ordinal()] = 12;
        } catch (NoSuchFieldError unused20) {
        }
        try {
            iArr4[KZ7.SEARCH_SHARE_STORY.ordinal()] = 13;
        } catch (NoSuchFieldError unused21) {
        }
        try {
            iArr4[KZ7.DISCOVER_SHARE_PUBLISHER_STORY_SNAP.ordinal()] = 14;
        } catch (NoSuchFieldError unused22) {
        }
        try {
            iArr4[KZ7.AD_SHARE.ordinal()] = 15;
        } catch (NoSuchFieldError unused23) {
        }
        try {
            iArr4[KZ7.MEMORIES_STORY.ordinal()] = 16;
        } catch (NoSuchFieldError unused24) {
        }
        try {
            iArr4[KZ7.SNAP_PRO_PROFILE_SHARE.ordinal()] = 17;
        } catch (NoSuchFieldError unused25) {
        }
        try {
            iArr4[KZ7.SNAP_PRO_PROFILE_SNAP_SHARE.ordinal()] = 18;
        } catch (NoSuchFieldError unused26) {
        }
        try {
            iArr4[KZ7.LOCATION_SHARE.ordinal()] = 19;
        } catch (NoSuchFieldError unused27) {
        }
        try {
            iArr4[KZ7.LOCATION_REQUEST.ordinal()] = 20;
        } catch (NoSuchFieldError unused28) {
        }
        try {
            iArr4[KZ7.SCREENSHOT.ordinal()] = 21;
        } catch (NoSuchFieldError unused29) {
        }
        try {
            iArr4[KZ7.SAVE_TO_CAMERA_ROLL_MESSAGE.ordinal()] = 22;
        } catch (NoSuchFieldError unused30) {
        }
        try {
            iArr4[KZ7.SPOTLIGHT_STORY_SHARE.ordinal()] = 23;
        } catch (NoSuchFieldError unused31) {
        }
        try {
            iArr4[KZ7.BITMOJI_OUTFIT_SHARE.ordinal()] = 24;
        } catch (NoSuchFieldError unused32) {
        }
        try {
            iArr4[KZ7.BLOOPS_STORY_SHARE.ordinal()] = 25;
        ...
        try {
            iArr5[ContentType.MY_AI_SPECTACLES_BOT_RESPONSE.ordinal()] = 17;
        } catch (NoSuchFieldError unused50) {
        }
        try {
            iArr5[ContentType.STATUS_SNAP_REMIX_CAPTURE.ordinal()] = 18;
        } catch (NoSuchFieldError unused51) {
        }
        try {
            iArr5[ContentType.STATUS_STICKER_CUTOUT.ordinal()] = 19;
        } catch (NoSuchFieldError unused52) {
        }
        try {
            iArr5[ContentType.STATUS_FRIEND_PLACE_ALERT.ordinal()] = 20;
