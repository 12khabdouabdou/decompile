...
public class C3423Gch extends AbstractC18316d3h {
    public EnumC27043jah C;
    public Long D;
    public Long E;

    public C3423Gch() {
        super("SPECTACLES_TRANSFER_SESSION_START", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.x0(ak3, 8, bArr, this.B, set);
        ...
        AbstractC20835ew8.w0(ak3, 12, bArr, this.y, set);
        ...
        AbstractC20835ew8.z0(ak3, 20, bArr, this.E, set);
        AbstractC20835ew8.z0(ak3, 21, bArr, this.x, set);
        AbstractC20835ew8.z0(ak3, 22, bArr, this.r, set);
        AbstractC20835ew8.B0(ak3, 23, bArr, this.n, set);
        ak3.m(bArr);
    }
