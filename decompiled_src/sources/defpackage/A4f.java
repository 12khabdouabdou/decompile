...
public final class A4f extends ViewGroup {
    public C47759z4f a;
    ...
    public final void a(C47759z4f c47759z4f) {
        C47759z4f c47759z4f2 = this.a;
        if (c47759z4f == null) {
            C47759z4f c47759z4f3 = C47759z4f.c;
            c47759z4f = C47759z4f.c;
        }
        this.a = c47759z4f;
        if (!AbstractC2032Dq9.j(c47759z4f, c47759z4f2)) {
            requestLayout();
        }
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth;
        int measuredHeight;
        C36998r1f c36998r1f = new C36998r1f(this.a.a.width(), this.a.a.height());
        if (c36998r1f.getWidth() > 0) {
            measuredWidth = c36998r1f.getWidth();
        } else {
            measuredWidth = getMeasuredWidth();
        }
        if (c36998r1f.getHeight() > 0) {
            measuredHeight = c36998r1f.getHeight();
        } else {
