...
public class C25737ic4 extends AbstractC20391ec4 {
    public Boolean y;
    public Long z;

    public C25737ic4() {
        super("CREATIVE_KIT_CAMERA_LOAD", EnumC1516Cre.BUSINESS, 1.0d, 0.1d, 1.0d);
    }

    @Override // defpackage.InterfaceC5193Jje
    public final void c(AK3 ak3, Set set) {
        byte[] bArr = new byte[3];
        AbstractC20835ew8.B0(ak3, 2, bArr, this.x, set);
        AbstractC20835ew8.w0(ak3, 3, bArr, this.v, set);
        AbstractC20835ew8.w0(ak3, 4, bArr, this.u, set);
        ...
        AbstractC20835ew8.w0(ak3, 9, bArr, this.w, set);
