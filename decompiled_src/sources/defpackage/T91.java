...
public class T91 {
    ...
    private Map<EnumC1516Cre, List<String>> e;
    ...
    public final int hashCode() {
        ...
        int i13 = (i12 + i4) * 31;
        Map<EnumC1516Cre, List<String>> map = this.e;
        if (map != null) {
            i5 = map.hashCode();
        } else {
            i5 = 0;
    ...
    public T91(Long l, Boolean bool, List<String> list, List<FFa> list2, Map<EnumC1516Cre, List<String>> map, Double d, String str, Long l2, Long l3) {
        this.a = l;
        this.b = bool;
        this.c = list;
        this.d = list2;
