...
public class C42349v1h extends C37000r1h {
    public String y;

    public C42349v1h() {
        super("SPECTACLES_APP_R_T_C_SERVICE_EVENT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.B0(ak3, 8, bArr, this.y, set);
