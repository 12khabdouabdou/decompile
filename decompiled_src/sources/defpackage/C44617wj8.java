...
public final class C44617wj8 extends AbstractC32978o17 {
    public C18347d54 a = null;
    public C18347d54[] b = C18347d54.a();
    ...
    public final int computeSerializedSize() {
        ...
        C18347d54 c18347d54 = this.a;
        if (c18347d54 != null) {
            computeSerializedSize += C39067sa3.l(1, c18347d54);
        }
        C18347d54[] c18347d54Arr = this.b;
        if (c18347d54Arr != null && c18347d54Arr.length > 0) {
            int i = 0;
            while (true) {
                C18347d54[] c18347d54Arr2 = this.b;
                if (i >= c18347d54Arr2.length) {
                    break;
                }
                C18347d54 c18347d542 = c18347d54Arr2[i];
                if (c18347d542 != null) {
                    computeSerializedSize = C39067sa3.l(2, c18347d542) + computeSerializedSize;
                }
                i++;
            }
        }
        ...
        while (true) {
            ...
            if (u != 10) {
                if (u != 18) {
                    ...
                    this.b = c18347d54Arr2;
                }
            } else {
                if (this.a == null) {
                    this.a = new C18347d54();
                }
                c36392qa3.k(this.a);
            }
        }
