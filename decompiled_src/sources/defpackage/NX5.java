...
public final class NX5 extends RX5 implements QX5 {
    public final UUID b;
    public final ReplaySubject c;

    public NX5(UUID uuid, ReplaySubject replaySubject) {
        super("PendingStop");
        this.b = uuid;
    ...
    public final boolean equals(Object obj) {
        ...
        NX5 nx5 = (NX5) obj;
        if (AbstractC2032Dq9.j(this.b, nx5.b) && AbstractC2032Dq9.j(this.c, nx5.c)) {
            return true;
        }
        return false;
    }
