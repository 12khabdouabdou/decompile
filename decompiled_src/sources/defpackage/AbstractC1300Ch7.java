...
public abstract /* synthetic */ class AbstractC1300Ch7 {
    ...
    static {
        ...
        try {
            iArr[SnapItemState.SELFDESTRUCTED.ordinal()] = 16;
        } catch (NoSuchFieldError unused16) {
        }
        try {
            iArr[SnapItemState.REACTION.ordinal()] = 17;
        ...
        try {
            iArr2[ChatItemState.REPLIEDTOSTORY.ordinal()] = 16;
        } catch (NoSuchFieldError unused33) {
        }
        try {
            iArr2[ChatItemState.REMOVEDREACTION.ordinal()] = 17;
        } catch (NoSuchFieldError unused34) {
        }
        try {
            iArr2[ChatItemState.WAITING_TO_SEND.ordinal()] = 18;
        ...
        try {
            iArr4[ConversationItemState.UPDATE_CHAT_WALLPAPER.ordinal()] = 6;
        } catch (NoSuchFieldError unused43) {
        }
        try {
            iArr4[ConversationItemState.UNKNOWN.ordinal()] = 7;
