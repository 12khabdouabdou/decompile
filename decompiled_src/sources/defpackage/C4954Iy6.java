...
public final class C4954Iy6 {
    ...
    public C4954Iy6() {
        ...
        this.n = behaviorSubject.S(Functions.a);
        this.o = new ObservableHide(publishSubject2);
        this.p = new ObservableHide(c1);
        this.q = new ObservableHide(c12);
    ...
    public final boolean a() {
        ...
        Boolean bool = (Boolean) this.e.d1();
        if (bool == null) {
            booleanValue = false;
        } else {
        ...
        if (!booleanValue) {
            Boolean bool2 = (Boolean) this.f.d1();
            if (bool2 == null) {
                booleanValue2 = false;
            } else {
