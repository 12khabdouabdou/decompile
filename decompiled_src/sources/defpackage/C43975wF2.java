...
public class C43975wF2 extends AbstractC24724hqj {
    public String j;
    public String k;
    public String l;
    public String m;
    public EnumC19880eDh n;
    public String o;
    public EnumC25227iDh p;
    public String q;
    public String r;

    public C43975wF2() {
        super("CHAT_DRAWER_TAB_SESSION", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
