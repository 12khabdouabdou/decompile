...
public abstract /* synthetic */ class AbstractC46717yI9 {
    ...
    static {
        ...
        try {
            iArr[StandardFieldType.STANDARD_BDAY.ordinal()] = 7;
        } catch (NoSuchFieldError unused7) {
        }
        try {
            iArr[StandardFieldType.UNKNOWN_STANDARD_UNSET.ordinal()] = 8;
        } catch (NoSuchFieldError unused8) {
        }
        try {
            iArr[StandardFieldType.CUSTOM.ordinal()] = 9;
