...
public class CG0 extends AbstractC25294iH0 {
    public Long A;
    public String u;
    public String v;
    public String w;
    ...
    public CG0() {
        super("BACKUP_OPERATION_STEP_ATTEMPT", EnumC1516Cre.BEST_EFFORT, 0.1d, 0.1d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.B0(ak3, 9, bArr, this.x, set);
        AbstractC20835ew8.B0(ak3, 10, bArr, this.l, set);
        AbstractC20835ew8.z0(ak3, 11, bArr, this.y, set);
        AbstractC20835ew8.z0(ak3, 12, bArr, this.A, set);
        AbstractC20835ew8.z0(ak3, 13, bArr, this.z, set);
        ...
        AbstractC20835ew8.w0(ak3, 18, bArr, this.o, set);
        AbstractC20835ew8.z0(ak3, 19, bArr, this.q, set);
        AbstractC20835ew8.B0(ak3, 20, bArr, this.n, set);
        AbstractC20835ew8.z0(ak3, 21, bArr, this.p, set);
        AbstractC20835ew8.w0(ak3, 22, bArr, this.t, set);
        AbstractC20835ew8.z0(ak3, 23, bArr, this.j, set);
