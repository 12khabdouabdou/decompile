...
public final class QW8 implements INativeStoriesAnalytics {
    public final Function2 a;
    public final Function1 b;
    public final Function4 c;
    public final Function3 t;

    public QW8(Function2 function2, Function1 function1, Function4 function4, Function3 function3) {
        this.a = function2;
        this.b = function1;
        this.c = function4;
        this.t = function3;
    ...
    public final int pushToMarshaller(ComposerMarshaller composerMarshaller) {
        ...
        return C46564yB3.b.marshallObject(INativeStoriesAnalytics.class, composerMarshaller, this);
    }
    ...
    public void reportFeedPageScrollEvent(double d, double d2, double d3) {
        this.t.I(Double.valueOf(d), Double.valueOf(d2), Double.valueOf(d3));
    }

    @Override // com.snap.composer.discoverfeed.INativeStoriesAnalytics
    public void reportSubscribeStory(IRawStoryCard iRawStoryCard, boolean z) {
        this.a.N(iRawStoryCard, Boolean.valueOf(z));
    }

    @Override // com.snap.composer.discoverfeed.INativeStoriesAnalytics
    public void reportThumbnailLoad(String str, double d, boolean z, double d2) {
        this.c.n(str, Double.valueOf(d), Boolean.valueOf(z), Double.valueOf(d2));
    }
