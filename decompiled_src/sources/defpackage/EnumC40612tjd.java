...
public enum EnumC40612tjd {
    ...
    /* JADX INFO: Fake field, exist only in values array */
    IN_APP_PHONE_VERIFY(Chrysalis.PIXEL_LAYOUT_ARGB),
    ...
    SIMPLIFIED_LOCATION(563),
    CAMERA_ROLL_METADATA_LOCATION(564),
    CAMERA_AGE_COMPLIANCE(565),
    LOCATION_SHARE_UPSELL(566),
    UNKNOWN(-500);
