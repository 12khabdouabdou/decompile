...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'showActionMenuEnabled':b@?,'showSubscriptionEnabled':b@?,'showShareButtonEnabled':b@?,'notificationButtonEnabled':b@?,'smallIconV3Enabled':b@?,'cofStore':r?:'[0]','uccStyleIconsEnabled':b@?", typeReferences = {ICOFStore.class})
/* renamed from: lAj, reason: case insensitive filesystem */
/* loaded from: classes4.dex */
public final class C29174lAj extends b {
    ...
    public final void f() {
        this._smallIconV3Enabled = Boolean.FALSE;
    }

    public final void g() {
        this._uccStyleIconsEnabled = Boolean.FALSE;
    }

    public C29174lAj(Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, ICOFStore iCOFStore, Boolean bool6) {
        this._showActionMenuEnabled = bool;
