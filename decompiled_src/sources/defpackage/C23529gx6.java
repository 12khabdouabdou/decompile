...
public final class C23529gx6 extends b {
    ...
    public C23529gx6(String str, String str2, String str3, String str4, String str5, double d, MemoriesUploadState memoriesUploadState, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, double d2, GenAIType genAIType, Double d3, Double d4, Boolean bool, BridgeObservable<MemoriesUploadState> bridgeObservable, MediaTimeRange mediaTimeRange, DreamsRarity dreamsRarity, DreamsMetadata dreamsMetadata, boolean z6, String str6) {
        this._entryId = str;
        this._snapId = str2;
        this._packId = str3;
