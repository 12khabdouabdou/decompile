...
public enum EnumC38982sW1 implements InterfaceC22815gQ6 {
    NONE(0),
    VIEW_FINDER(1),
    FLIP_BTN(2),
    NIGHT_BTN(3),
    ...
    SELFIE_SETTINGS_DEEPLINK_BTN(88),
    AI_MODE_BTN(75),
    SWIPE_TO_FLIP_BTN(83),
    CCC_PULL_TAB(36),
    CCC_DISMISS_BTN(37),
    CCC_NIGHT_BTN(38),
    CCC_GRID_BTN(39),
    ...
    LENS_CAROUSEL(82),
    ZOOM_FACTORS_PILL_DEFAULT(84),
    ZOOM_FACTORS_PILL_ULTRAWIDE(85),
    ZOOM_FACTORS_PILL_TELEPHOTO(86),
    ZOOM_FACTORS_PILL_SCROLLABLE_DIAL(87),
    ASPECT_RATIO_BUTTON(89),
    MY_AI_QUICK_CAPTURE(90),
    ZOOM_CAPTURE_CONTROL_BTN(91),
    HD_MODE_BTN(92);
