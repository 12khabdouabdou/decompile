...
public final class C29574lU {
    public static final C29574lU a = new C29574lU();
    ...
    public final Person a(String str, Icon icon) {
        ...
        Person build;
        name = AbstractC39724t4.c().setName(str);
    ...
    public final Collection<BluetoothDevice> i(CallAudioState callAudioState) {
