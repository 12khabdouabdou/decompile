...
public final class C13571Yug {
    private final BehaviorSubject<Integer> a = BehaviorSubject.c1();
    private int b;
    private boolean c;
    ...
    public static final class a extends WindowInsetsAnimation.Callback {
        ...
        public void onEnd(WindowInsetsAnimation windowInsetsAnimation) {
            ...
            C13571Yug.this.c = false;
        }

        @Override // android.view.WindowInsetsAnimation.Callback
        public void onPrepare(WindowInsetsAnimation windowInsetsAnimation) {
            super.onPrepare(windowInsetsAnimation);
            C13571Yug.this.c = true;
        }

        @Override // android.view.WindowInsetsAnimation.Callback
        public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
            C13571Yug.this.f(windowInsets);
            return windowInsets;
        }
    }
