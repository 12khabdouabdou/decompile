...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'reasonId':s,'reasonText':s,'type':r:'[0]','listItem':r?:'[1]','submitItem':r?:'[2]','commentItem':r?:'[3]','webViewItem':r?:'[4]'", typeReferences = {ReportReasonType.class, ReportReasonListItem.class, ReportReasonSubmitItem.class, ReportReasonCommentItem.class, ReportReasonWebViewItem.class})
/* loaded from: classes7.dex */
public final class MXe extends b {
    ...
    public MXe(String str, String str2, ReportReasonType reportReasonType) {
        this._reasonId = str;
    ...
    public MXe(String str, String str2, ReportReasonType reportReasonType, ReportReasonListItem reportReasonListItem, ReportReasonSubmitItem reportReasonSubmitItem, ReportReasonCommentItem reportReasonCommentItem, ReportReasonWebViewItem reportReasonWebViewItem) {
        this._reasonId = str;
        this._reasonText = str2;
        this._type = reportReasonType;
        this._listItem = reportReasonListItem;
