...
public class CT9 extends C48284zT9 {
    public Double x;

    public CT9() {
        super("LENS_EXPLORER_FEED_ITEM_LONG_IMP", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }

    @Override // defpackage.C48284zT9, defpackage.InterfaceC5193Jje
    public final void c(AK3 ak3, Set set) {
        byte[] bArr = new byte[2];
        AbstractC20835ew8.x0(ak3, 2, bArr, this.x, set);
