...
public class IFi extends OFi {
    public JFi y;
    public String z;

    public IFi() {
        super("TO_SNAPPABLE_FAILURE", EnumC1516Cre.BEST_EFFORT, 0.1d, 0.1d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.y0(ak3, 6, bArr, this.y, set);
        ...
        AbstractC20835ew8.w0(ak3, 16, bArr, this.p, set);
