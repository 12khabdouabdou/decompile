...
public final class C48271zSh extends b {
    ...
    public C48271zSh(String str, String str2, String str3, StoryInviteSheetStoryType storyInviteSheetStoryType, String str4, boolean z, String str5) {
    ...
    public C48271zSh(String str, String str2, String str3, StoryInviteSheetStoryType storyInviteSheetStoryType, String str4, boolean z, String str5, List<C38914sSh> list, StoryInviteStoryThumbnailData storyInviteStoryThumbnailData) {
        this._bitmojiStickerId = str;
        this._bitmojiAvatarId = str2;
        this._storyTitle = str3;
        this._storyType = storyInviteSheetStoryType;
