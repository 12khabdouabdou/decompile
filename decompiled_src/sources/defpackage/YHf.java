...
public final class YHf {
    ...
    public YHf(String str, Long l, Long l2, Long l3, JSh jSh, Boolean bool) {
        this.a = str;
        this.b = l;
        this.c = l2;
        this.d = l3;
    ...
    public final boolean equals(Object obj) {
        ...
        YHf yHf = (YHf) obj;
        if (AbstractC2032Dq9.j(this.a, yHf.a) && AbstractC2032Dq9.j(this.b, yHf.b) && AbstractC2032Dq9.j(this.c, yHf.c) && AbstractC2032Dq9.j(this.d, yHf.d) && this.e == yHf.e && AbstractC2032Dq9.j(this.f, yHf.f)) {
            return true;
        }
        return false;
    }
