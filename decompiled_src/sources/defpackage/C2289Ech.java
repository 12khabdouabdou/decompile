...
public class C2289Ech extends AbstractC3965Hch {
    public C2289Ech() {
        super("SPECTACLES_TRANSFER_SESSION_COMPLETE", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.z0(ak3, 4, bArr, this.z, set);
        AbstractC20835ew8.B0(ak3, 5, bArr, this.j, set);
        AbstractC20835ew8.z0(ak3, 6, bArr, this.A, set);
        AbstractC20835ew8.x0(ak3, 7, bArr, this.B, set);
        ...
        AbstractC20835ew8.w0(ak3, 11, bArr, this.y, set);
        AbstractC20835ew8.z0(ak3, 12, bArr, this.p, set);
        AbstractC20835ew8.z0(ak3, 13, bArr, this.E, set);
        AbstractC20835ew8.z0(ak3, 14, bArr, this.F, set);
        AbstractC20835ew8.z0(ak3, 15, bArr, this.D, set);
        AbstractC20835ew8.y0(ak3, 16, bArr, this.C, set);
        ...
        AbstractC20835ew8.B0(ak3, 20, bArr, this.u, set);
        AbstractC20835ew8.y0(ak3, 21, bArr, this.w, set);
        AbstractC20835ew8.z0(ak3, 22, bArr, this.x, set);
