...
public class SIg extends PIg {
    public Boolean p;
    public Boolean q;
    public EnumC23988hIa r;
    public Boolean s;
    public Boolean t;
    public ArrayList u;
    public ArrayList v;
    ...
    public SIg() {
        super("SNAP_KIT_USER_REAUTHORIZE", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.I0(ak3, 10, bArr, this.v, set);
        AbstractC20835ew8.I0(ak3, 11, bArr, this.u, set);
