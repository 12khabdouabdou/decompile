...
public final class C4620Ii4 {
    ...
    public int j = Imgproc.CV_CANNY_L2_GRADIENT;
    ...
    public final C5162Ji4 a() {
        return new C5162Ji4(this.a, this.c, this.d, this.b, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m, this.n, this.o, this.p, this.q);
    }
}
