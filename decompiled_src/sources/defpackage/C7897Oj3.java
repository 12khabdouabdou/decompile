...
public class C7897Oj3 extends C23218gj3 {
    public EnumC7353Nj3 l0;

    public C7897Oj3() {
        super("COMMERCE_BUTTON_ACTION_EVENT", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.y0(ak3, 45, bArr, this.l0, set);
    ...
    public final int e(Map map) {
        ...
        if (map.containsKey("target")) {
            ...
            if (obj instanceof String) {
                this.l0 = EnumC7353Nj3.valueOf((String) obj);
            } else {
                this.l0 = (EnumC7353Nj3) obj;
            }
            return e + 1;
        }
        return e;
