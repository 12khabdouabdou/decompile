...
public final class C11955Vv7 extends AbstractC32978o17 {
    public int a = 0;
    public String b = "";
    public String c = "";
    public String t = "";
    ...
    public final int computeSerializedSize() {
        ...
        SZf sZf = this.Z;
        if (sZf != null) {
            computeSerializedSize += C39067sa3.l(8, sZf);
        }
        if ((this.a & 32) != 0) {
            return C39067sa3.k(9, this.e0) + computeSerializedSize;
        }
