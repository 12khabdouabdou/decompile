...
public class C15441aud extends AbstractC24724hqj {
    public EnumC13548Ytd j;
    public Double k;
    public EnumC16777bud l;
    public Long m;
    public Long n;
    public Long o;
    public Long p;
    ...
    public C15441aud() {
        super("PLACES_SUGGEST_PLACE", EnumC1516Cre.BUSINESS, 1.0d, 1.0d, 1.0d);
    }
    ...
    public final void c(AK3 ak3, Set set) {
        ...
        AbstractC20835ew8.L0(ak3, 6, bArr, this.u, set);
    ...
    public final int e(Map map) {
        ...
        if (map.containsKey("source")) {
            ...
            if (obj2 instanceof String) {
                this.l = EnumC16777bud.valueOf((String) obj2);
            } else {
                this.l = (EnumC16777bud) obj2;
            }
            e++;
        }
