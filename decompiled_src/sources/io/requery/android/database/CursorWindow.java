...
public class CursorWindow extends SQLiteClosable {
    ...
    public String toString() {
        return AbstractC21001f3j.f(getName(), " {", Long.toHexString(this.mWindowPtr), "}");
    }
    ...
    public CursorWindow(String str, int i) {
        ...
        if (nativeCreate == 0) {
            throw new CursorWindowAllocationException(AbstractC30628mG8.l("Cursor window allocation of ", i / 1024, " kb failed. "));
        }
    }
}
