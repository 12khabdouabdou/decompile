...
public final class ObservableDelaySubscriptionOther<T, U> extends Observable<T> {
    ...
    public final class DelayObserver implements Observer<U> {
        ...
        public final void onComplete() {
            ...
            this.c = true;
            ObservableDelaySubscriptionOther observableDelaySubscriptionOther = ObservableDelaySubscriptionOther.this;
            observableDelaySubscriptionOther.a.subscribe(new OnComplete());
        }
