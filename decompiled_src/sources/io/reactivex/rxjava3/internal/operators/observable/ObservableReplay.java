...
public final class ObservableReplay<T> extends ConnectableObservable<T> {
    public static final UnBoundedFactory X = new UnBoundedFactory();
    ...
    public static abstract class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
        ...
        public final void h(Object obj) {
            ...
            if (sizeBoundReplayBuffer.b > sizeBoundReplayBuffer.c) {
            ...
            if (innerDisposable.getAndIncrement() == 0) {
                ...
                do {
                    ...
                    while (!innerDisposable.t) {
                        Node node2 = node.get();
                        if (node2 != null) {
                            if (NotificationLite.b(innerDisposable.b, node2.a)) {
    ...
    public static final class ReplayObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        public static final InnerDisposable[] Z = new InnerDisposable[0];
        ...
        public final void a(InnerDisposable innerDisposable) {
            ...
            while (true) {
                ...
                if (length != 0) {
                    ...
                    while (true) {
                        if (i < length) {
                            if (innerDisposableArr2[i].equals(innerDisposable)) {
                                break;
                            } else {
                                i++;
                            }
        ...
        public final void onComplete() {
            if (!this.b) {
                ...
                replayBuffer.d();
                for (InnerDisposable innerDisposable : (InnerDisposable[]) this.c.getAndSet(Z)) {
                    replayBuffer.o(innerDisposable);
                }
            }
        }
    ...
    public static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            loop2: while (true) {
                ...
                if (innerDisposableArr != ReplayObserver.Z) {
            ...
            if (innerDisposable.t) {
                replayObserver.a(innerDisposable);
            } else {
                replayObserver.a.o(innerDisposable);
            }
        }
    }
        ...
        public final void o(InnerDisposable innerDisposable) {
            ...
            if (innerDisposable.getAndIncrement() == 0) {
                ...
                while (!innerDisposable.t) {
                    ...
                    while (i < i3) {
                        if (!NotificationLite.b(observer, get(i)) && !innerDisposable.t) {
                            i++;
                        } else {
                            return;
                        }
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [io.reactivex.rxjava3.internal.operators.observable.ObservableReplay$BufferSupplier, java.lang.Object] */
    public static ObservableReplay i1(Observable observable) {
        return j1(observable, new Object());
    }

    public static ObservableReplay j1(Observable observable, BufferSupplier bufferSupplier) {
    ...
    public final void c1(Consumer consumer) {
        ...
        AtomicBoolean atomicBoolean = replayObserver.t;
