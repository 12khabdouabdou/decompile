...
public final class ComputationScheduler extends Scheduler implements SchedulerMultiWorkerSupport {
    ...
    public static final PoolWorker Z;
    public static final FixedSchedulerPool t;
    ...
    public static final class EventLoopWorker extends Scheduler.Worker {
        ...
        public final Disposable d(Runnable runnable) {
            ...
            return this.t.j(runnable, 0L, TimeUnit.MILLISECONDS, this.a);
        }
        ...
        public final Disposable e(Runnable runnable, long j, TimeUnit timeUnit) {
            ...
            return this.t.j(runnable, j, timeUnit, this.b);
        }
    }
        ...
        public final void a(int i, SchedulerMultiWorkerSupport.WorkerCallback workerCallback) {
            ...
            if (i2 == 0) {
                for (int i3 = 0; i3 < i; i3++) {
                    workerCallback.a(i3, ComputationScheduler.Z);
                }
                return;
            }
    ...
    static {
        ...
        t = fixedSchedulerPool;
        fixedSchedulerPool.c();
    }

    public ComputationScheduler() {
        AtomicReference atomicReference;
        RxThreadFactory rxThreadFactory = X;
        FixedSchedulerPool fixedSchedulerPool = t;
        this.c = new AtomicReference(fixedSchedulerPool);
        FixedSchedulerPool fixedSchedulerPool2 = new FixedSchedulerPool(Y, rxThreadFactory);
        do {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r3v1, types: [io.reactivex.rxjava3.disposables.Disposable, io.reactivex.rxjava3.internal.schedulers.AbstractDirectTask, java.lang.Runnable] */
    @Override // io.reactivex.rxjava3.core.Scheduler
