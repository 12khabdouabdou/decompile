...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, Disposable {
    ...
    public final void dispose() {
        ...
        while (true) {
            Object obj6 = get(1);
            obj = X;
            if (obj6 == obj || obj6 == (obj4 = c) || obj6 == (obj5 = t)) {
                break;
            }
    ...
    public final void run() {
        ...
        try {
            ...
            if (obj7 != obj5 && compareAndSet(0, obj7, obj6) && obj7 != null) {
                ((DisposableContainer) obj7).e(this);
            }
            do {
                obj2 = get(1);
            ...
            try {
                ...
                if (obj8 != obj5 && compareAndSet(0, obj8, obj6) && obj8 != null) {
                    ((DisposableContainer) obj8).e(this);
                }
                do {
                    obj = get(1);
    ...
    public final String toString() {
        ...
        if (obj == X) {
            ...
            if (obj2 == null) {
                ...
                p = AbstractC31823n9f.p(obj2, "Running on ");
            }
        }
        return EU0.B("ScheduledRunnable[", p, "]");
    }
}
