...
public final class DisposableHelper implements Disposable {
    ...
    public static boolean l(AtomicReference atomicReference, Disposable disposable) {
        while (true) {
            Disposable disposable2 = (Disposable) atomicReference.get();
            if (disposable2 == a) {
                if (disposable != null) {
    ...
    public static boolean m(AtomicReference atomicReference, Disposable disposable) {
    ...
    public static boolean s(Disposable disposable, Disposable disposable2) {
        if (disposable2 == null) {
