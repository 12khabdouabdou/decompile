...
public final class BackpressureStrategy {
    public static final /* synthetic */ BackpressureStrategy[] X;
    ...
    public static final BackpressureStrategy t;
    ...
    static {
        ...
        t = r9;
        X = new BackpressureStrategy[]{r5, r6, r7, r8, r9};
    }
    ...
    public static BackpressureStrategy[] values() {
        return (BackpressureStrategy[]) X.clone();
    }
}
