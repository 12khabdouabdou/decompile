...
import defpackage.AbstractC28427kck;
import defpackage.C34989pX0;
import defpackage.C36326qX0;
...
public class ProxyBillingActivity extends Activity {
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i != 100 && i != 110) {
            ...
            int i6 = Y9k.c(intent, "ProxyBillingActivity").a;
            if (i2 == -1 && i6 == 0) {
                i6 = 0;
            }
            ...
            if (resultReceiver2 != null) {
                ...
                if (intent != null) {
                    if (intent.getExtras() != null) {
                        ...
                        a.putExtra("FAILURE_LOGGING_PAYLOAD", AbstractC28427kck.a(22, 2, a3.b()).b());
                        a.putExtra("INTENT_SOURCE", "LAUNCH_BILLING_FLOW");
                    }
                } else {
                    a = a();
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            Y9k.e("ProxyBillingActivity", "Launching Play Store billing flow");
            ...
            try {
                ...
                try {
                    ...
                    if (resultReceiver != null) {
                        ...
                        ResultReceiver resultReceiver2 = proxyBillingActivity.b;
                        if (resultReceiver2 != null) {
                            resultReceiver2.send(0, null);
                        } else {
                            Intent a = a();
                            if (proxyBillingActivity.t) {
                                a.putExtra("IS_FIRST_PARTY_PURCHASE", true);
                            }
                            a.putExtra("RESPONSE_CODE", 6);
                            a.putExtra("DEBUG_MESSAGE", "An internal error occurred.");
            ...
            Y9k.e("ProxyBillingActivity", "Launching Play Store billing flow from savedInstanceState");
            ...
            this.t = bundle.getBoolean("IS_FLOW_FROM_FIRST_PARTY_CLIENT", false);
        }
    }
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        bundle.putBoolean("IS_FLOW_FROM_FIRST_PARTY_CLIENT", this.t);
    }
}
