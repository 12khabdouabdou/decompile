...
public class MAPCookie implements Token, Serializable {
    ...
    public static List<MAPCookie> getCookiesFromCookieManager(Context context, String str, String str2) throws AuthError {
        ...
        String str6 = LOG_TAG;
        MAPLog.pii(str6, EU0.w("Extracting cookie list for domain=", str), "directedId=" + str2);
        ArrayList arrayList = new ArrayList();
        if (cookiesStringFromCookieManager != null) {
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (stringTokenizer2.hasMoreTokens()) {
                    ...
                    str3 = str;
                    str4 = str2;
                    arrayList.add(new MAPCookie(nextToken, str5, str3, str4, false));
                } else {
                    str3 = str;
                    str4 = str2;
                }
        ...
        MAPLog.i(str6, "No cookies in Cookie manager for " + str);
        return arrayList;
    }
