...
public final class MAPLog {
    ...
    public static int pii(String str, String str2, String str3, Throwable th) {
        ...
        if (IS_FIRST_PARTY_DEBUG_BUILD) {
            ...
            c = 3;
            if (LWAEnvironment.isProd() && Log.isLoggable(LOG_TAG_PII, 3)) {
        ...
        if (th != null) {
            if (c == 4) {
                return Log.i(concat, getUpdatedMessage(str2, str3), th);
            }
            return Log.d(concat, getUpdatedMessage(str2, str3), th);
        }
        if (c == 4) {
            return Log.i(concat, getUpdatedMessage(str2, str3));
        }
        return Log.d(concat, getUpdatedMessage(str2, str3));
    }
