...
public abstract class DataEncryptionUpgradeHelper {
    ...
    public String getStoredVersion(String str) {
        return StoredPreferences.getStoredEncryptionVersion(this.mContext, AbstractC30172lva.x(str, ENCRYPTION_VERSION_NAMESPACE));
    }
    ...
    public void storeEncryptionVersion(String str) {
        StoredPreferences.setEncryptionVersion(this.mContext, AbstractC30172lva.x(str, ENCRYPTION_VERSION_NAMESPACE), this.mVersion);
    }
}
