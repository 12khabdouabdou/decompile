    ...
    public static int[] getVersionInfo(String str) {
        ...
        if (split.length >= 1) {
            ...
            try {
                ...
                throw new InvalidParameterException(EU0.B("getVersionInfo: version (", str, ") must be in format of X[.X.X]... - where X must be an integer"));
            }
        }
        throw new InvalidParameterException(EU0.B("version (", str, ") must be in format of X.X.X"));
    }
}
