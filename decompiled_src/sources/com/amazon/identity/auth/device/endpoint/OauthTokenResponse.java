...
class OauthTokenResponse extends AbstractJSONTokenResponse {
    ...
    public boolean isInvalidGrant(String str, String str2) {
        if (!AUTHZ_INVALID_GRANT.equals(str) && !AUTHZ_UNSUPPORTED_GRANT_TYPE.equals(str)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isInvalidToken(String str, String str2) {
        if (!AUTHZ_INVALID_TOKEN.equals(str)) {
            if (!AUTHZ_INVALID_REQUEST.equals(str) || TextUtils.isEmpty(str2) || !str2.contains("access_token")) {
                return false;
            }
            return true;
        }
