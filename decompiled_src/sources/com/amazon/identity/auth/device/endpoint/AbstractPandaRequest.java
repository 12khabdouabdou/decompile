...
public abstract class AbstractPandaRequest<T extends Response> extends AbstractHTTPSRequest<T> {
    ...
    public String getRequestUrl() throws MalformedURLException {
        return new URL(AbstractC30172lva.x(LWAEnvironment.getEndpointDomainBuilder(this.context, this.appInfo).forService(Service.PANDA).forSandbox(isSandboxEnabled()).getDomain(), getEndPoint())).toString();
    }
