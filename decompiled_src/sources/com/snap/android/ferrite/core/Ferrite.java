...
public final class Ferrite {
    ...
    public static final class ConfigurationBuilder {
        ...
        private String findNativeCodeApk() {
            ...
            throw new RuntimeException(AbstractC30172lva.C(new StringBuilder("Can not find native code APK for split \""), this.splitName, "\""));
        }
        ...
        public Configuration build() {
            ...
            boolean z2 = this.appExtractNativeLibsFlag;
            String str2 = this.appNativeLibsDir;
            String absolutePath = this.tmpDir.getAbsolutePath();
            boolean z3 = this.reportWorldReadable;
            ...
            return new Configuration(findNativeCodeApk, z2, str2, absolutePath, z3, str3, z, this.reportSuffix);
        }
