...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'viewSource':s,'sourceType':s?,'mapSourceType':s?,'mapPlaceComponentType':s?,'placeSessionId':d@?,'mapSessionId':d@?,'pinId':s?,'mapViewportSessionId':d@?", typeReferences = {})
/* loaded from: classes8.dex */
public final class VenueStoryAnalytics extends b {
