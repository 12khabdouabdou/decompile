...
public final class PercentProgressView extends View {
    ...
    public final void draw(Canvas canvas) {
        super.draw(canvas);
        canvas.drawArc(this.b, -90.0f, (360 * this.t) / 100, false, this.a);
    }
    ...
    public PercentProgressView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AbstractC36865qve.c);
        try {
            ...
            valueAnimator.addUpdateListener(new C20258eW(21, this));
