...
public class StatusBarCustomView extends View {
    ...
    public StatusBarCustomView(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet, AbstractC26164ive.d, 0, 0);
            try {
    ...
    public final void onMeasure(int i, int i2) {
        setMeasuredDimension(i, View.MeasureSpec.makeMeasureSpec(AbstractC3839Gwh.a.a() + this.a, 1073741824));
    }
