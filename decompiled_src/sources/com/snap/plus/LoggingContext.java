...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'sourcePageType':s,'sourcePageSessionId':s?,'sourceType':s?,'sourceId':s?,'sourceFeatureType':s?,'funnelSessionId':s?", typeReferences = {})
/* loaded from: classes7.dex */
public final class LoggingContext extends b {
    ...
    public /* synthetic */ LoggingContext(String str, int i) {
        this("MAP", null, "ME_TRAY", str, null, null);
    }
}
