...
public class ManyTargetTracker {
    ...
    public final void c(int i, C36998r1f c36998r1f, View view, int i2) {
        float f = i2;
        setTargetNative(i, c36998r1f.getWidth(), c36998r1f.getHeight(), (int) ((view.getX() + (view.getWidth() / 2)) / f), (int) ((view.getY() + (view.getHeight() / 2)) / f), (int) ((view.getScaleX() * view.getWidth()) / f), (int) ((view.getScaleY() * view.getHeight()) / f));
    }
