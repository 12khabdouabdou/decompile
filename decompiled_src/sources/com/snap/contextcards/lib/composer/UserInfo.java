...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'username':s,'userId':s,'displayName':s?,'bitmojiAvatarId':s?,'bitmojiSelfieId':s?,'isPopular':b@?,'emoji':s?,'hasOfficialBadge':b@?,'snapProInfo':r?:'[0]','isAdded':b@?,'addFriendSource':s?,'mutableUsername':s?", typeReferences = {SnapProInfo.class})
