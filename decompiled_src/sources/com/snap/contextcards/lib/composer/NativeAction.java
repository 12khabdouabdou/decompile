...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'urls':a?<s>,'url':s?,'external':b@?,'openProfileForUser':r?:'[0]','actionMetric':s?,'cardId':s?,'cardType':s?,'protoAction':s?", typeReferences = {UserInfo.class})
/* loaded from: classes4.dex */
public final class NativeAction extends b {
