...
import defpackage.C0972Brd;
import defpackage.C11313Uqd;
...
public final class PlaceContextCardV2Context extends b {
    ...
    public PlaceContextCardV2Context(C45462xM5 c45462xM5) {
        this._config = null;
    ...
    public final void c(LV3 lv3) {
        this._getBlizzardLogger = lv3;
    }
    ...
    public final void e(LV3 lv3) {
        this._getNetworkingClient = lv3;
    }

    public final void f(NV3 nv3) {
        this._getPivotDataObservable = nv3;
    }

    public final void g(NV3 nv3) {
        this._getStoryPreviewObservable = nv3;
    }

    public final void h(LV3 lv3) {
        this._getVenueFavoritesActionHandler = lv3;
    }
