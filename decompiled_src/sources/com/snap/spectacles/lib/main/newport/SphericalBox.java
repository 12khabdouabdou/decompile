...
public final class SphericalBox extends Box {
    ...
    public static final C41842ueh Companion = new Object();
    ...
    public SphericalBox() {
        ...
        while (i < 32) {
            ...
            if (charAt <= 'f' && (b = (bArr = CL8.d)[charAt]) != -1) {
                i += 2;
    ...
    public void doWrite(ByteBuffer byteBuffer) {
        ...
        if (byteBuffer != null) {
            byteBuffer.put(this.xmlString.getBytes(HC2.a));
        }
    }
