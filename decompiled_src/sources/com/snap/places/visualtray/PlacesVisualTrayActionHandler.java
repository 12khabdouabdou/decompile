...
import defpackage.C23470gud;
import defpackage.InterfaceC11469Uy3;
import defpackage.InterfaceC14142Zw3;
import java.util.List;

@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = C23470gud.class, schema = "'handleResultsTrayOpen':f?|m|(r:'[0]', r<e>:'[1]', d@?),'handlePlaceTap':f?|m|(r:'[2]', r?<e>:'[3]'),'handleVisualPlaceTap':f?|m|(r:'[4]', r?<e>:'[3]'),'handleEditSearch':f?|m|(s),'handleCloseTray':f?|m|(),'handleOpenHtmlDebug':f?|m|(),'handlePlacePivotTap':f?|m|(r:'[0]', d@?),'handlePlaceLongPress':f?|m|(r:'[4]', a?<r:'[0]'>, r?:'[0]'),'handleDismissKeyboard':f?|m|(),'handleFriendTap':f?|m|(r:'[5]'),'handleFriendsTap':f?|m|(a<r:'[6]'>),'handleFriendFavoritesPivotTap':f?|m|(a<r:'[6]'>)", typeReferences = {PlacePivot.class, PlaceFilterType.class, PlaceDiscoveryModel.class, PlacesSourceType.class, VisualTrayPlace.class, FriendData.class, MapItemData.class})
...
public interface PlacesVisualTrayActionHandler extends ComposerMarshallable {
    ...
    @InterfaceC11469Uy3
    void handlePlaceLongPress(VisualTrayPlace visualTrayPlace, List<PlacePivot> list, PlacePivot placePivot);
