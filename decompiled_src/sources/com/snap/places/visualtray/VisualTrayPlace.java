...
public final class VisualTrayPlace extends b {
    ...
    public final void c(PlaceFavoritesData placeFavoritesData) {
        this._favoritesData = placeFavoritesData;
    }

    public final void d(PlaceOpeningHours placeOpeningHours) {
        this._openingHours = placeOpeningHours;
    }
    ...
    public VisualTrayPlace(String str, double d, double d2, GeoRect geoRect, String str2, String str3, String str4, ArrayList arrayList, PlaceStoryCarouselData placeStoryCarouselData) {
        this._placeId = str;
        this._lat = d;
        this._lng = d2;
        this._boundingBox = geoRect;
        ...
        this._providerImageUrls = arrayList;
