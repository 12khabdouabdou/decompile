...
public final class PlaceInfoModel extends b {
    ...
    private String _particlesEffectUrl;
    private String _phoneNumber;
    private PlaceFavoritesData _placeFavoritesData;
    private String _placeId;
    private List<C8204Oxj> _placePhotos;
    ...
    public final void i(PlaceMenuInfo placeMenuInfo) {
        this._menuInfo = placeMenuInfo;
    }

    public final void j(PlaceOpeningHours placeOpeningHours) {
        this._openingHours = placeOpeningHours;
    }

    public final void k(PlaceFavoritesData placeFavoritesData) {
    ...
    public final void m(PlaceAddress placeAddress) {
        this._rawAddress = placeAddress;
    }

    public PlaceInfoModel(String str, String str2, String str3, String str4, String str5, List<C40766tqd> list, String str6, PlaceAddress placeAddress, String str7, String str8, String str9, String str10, String str11, boolean z, String str12, PlaceOpeningHours placeOpeningHours, double d, double d2, PlaceMenuInfo placeMenuInfo, List<C5488Jxj> list2, List<C5488Jxj> list3, GeoRect geoRect, VenueProfilePlaceType venueProfilePlaceType, List<C8204Oxj> list4, boolean z2, boolean z3, String str13, String str14, PlaceFavoritesData placeFavoritesData, String str15) {
        this._placeId = str;
        this._name = str2;
        this._pricyness = str3;
        this._category = str4;
        ...
        this._placeFavoritesData = placeFavoritesData;
        this._particlesEffectUrl = str15;
    }
}
