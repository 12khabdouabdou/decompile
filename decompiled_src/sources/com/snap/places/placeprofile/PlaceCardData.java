...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'placeId':s,'name':s,'isFavorite':b,'favoritesData':r?:'[0]','pricyness':s?,'category':s?,'kindName':s?,'orbisStoryUrl':s?,'providerImageUrl':s?,'iconUrl':s?,'numOrbisStories':d@?,'numProviderStories':d@?,'lat':d@?,'lng':d@?,'boundingBox':r?:'[1]','isLocality':b@?,'distanceFromUser':s?,'locality':s?,'openingHours':r?:'[2]','debugInfo':r?:'[3]'", typeReferences = {PlaceFavoritesData.class, GeoRect.class, PlaceOpeningHours.class, BasemapPlaceDebugInfo.class})
/* loaded from: classes7.dex */
public final class PlaceCardData extends b {
    private GeoRect _boundingBox;
    private String _category;
    private BasemapPlaceDebugInfo _debugInfo;
    ...
    public final void h(GeoRect geoRect) {
    ...
    public PlaceCardData(String str, String str2, boolean z, PlaceFavoritesData placeFavoritesData, String str3, String str4, String str5, String str6, String str7, String str8, Double d, Double d2, Double d3, Double d4, GeoRect geoRect, Boolean bool, String str9, String str10, PlaceOpeningHours placeOpeningHours, BasemapPlaceDebugInfo basemapPlaceDebugInfo) {
        this._placeId = str;
        this._name = str2;
        this._isFavorite = z;
        this._favoritesData = placeFavoritesData;
        ...
        this._debugInfo = basemapPlaceDebugInfo;
    }
}
