...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'logoUrl':s,'officialBadgeType':r<e>:'[0]','title':s,'tier':r<e>:'[1]','identifiers':r:'[2]'", typeReferences = {SnapProBadgeType.class, PublicProfileTierType.class, PublicProfileIdentifiers.class})
/* loaded from: classes8.dex */
public final class PublicProfile extends b {
