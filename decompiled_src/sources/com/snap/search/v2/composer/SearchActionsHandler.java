...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'dismiss':f(),'openGroupChat':f(s),'openGroupProfile':f(s),'playGroupStory':f(s, r:'[0]'),'openPublisherProfile':f(m<s,u>),'openShowProfile':f(m<s,u>),'openStore':f(s)", typeReferences = {Ref.class})
/* loaded from: classes7.dex */
public final class SearchActionsHandler extends b {
