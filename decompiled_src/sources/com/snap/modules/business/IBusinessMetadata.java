...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'pageWorkflow':r?:'[0]','pageWorkflowData':s?,'pageDetail':s?,'profileId':s?,'organizationId':s?,'adAccountId':s?,'adId':s?", typeReferences = {BusinessPageWorkflow.class})
/* loaded from: classes6.dex */
public final class IBusinessMetadata extends b {
