...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'onImpression':f?(),'birthday':g<c>:'[0]'<r:'[1]'>,'onTap':f?(r:'[2]')", typeReferences = {BridgeObservable.class, ProfileBirthday.class, Ref.class})
/* loaded from: classes6.dex */
public final class ZodiacPillViewContext extends b {
