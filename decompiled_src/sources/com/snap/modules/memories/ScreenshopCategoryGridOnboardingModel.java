...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'checkShouldShowOnboardingModalNewUser':f(f()),'checkShouldShowOnboardingModalExistingUser':f(f()),'shouldUseGreatButton':b,'screenshopOnboardingEnabled':b", typeReferences = {})
/* loaded from: classes6.dex */
public final class ScreenshopCategoryGridOnboardingModel extends b {
