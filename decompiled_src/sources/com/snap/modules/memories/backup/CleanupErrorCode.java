...
public final class CleanupErrorCode {
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [java.lang.Enum, com.snap.modules.memories.backup.CleanupErrorCode] */
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [java.lang.Enum, com.snap.modules.memories.backup.CleanupErrorCode] */
    ...
    static {
        ...
        ?? r02 = new Enum("DEV_FORCE_FAIL", 15);
        DEV_FORCE_FAIL = r02;
        ?? r16 = new Enum("SNAP_DOC_FAILED_TO_PARSE", 16);
        SNAP_DOC_FAILED_TO_PARSE = r16;
        a = new CleanupErrorCode[]{r1, r2, r0, r15, r14, r13, r12, r11, r10, r9, r8, r7, r6, r5, r4, r02, r16};
    }
