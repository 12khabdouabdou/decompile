...
public final class TranscodeErrorCode {
    ...
    public static final TranscodeErrorCode FAILED_DUE_TO_MISSING_FILE_ERROR;
    public static final TranscodeErrorCode FAILED_DUE_TO_OUT_OF_MEMORY;
    ...
    /* JADX WARN: Type inference failed for: r10v2, types: [java.lang.Enum, com.snap.modules.memories.backup.TranscodeErrorCode] */
    /* JADX WARN: Type inference failed for: r11v2, types: [java.lang.Enum, com.snap.modules.memories.backup.TranscodeErrorCode] */
    /* JADX WARN: Type inference failed for: r13v0, types: [java.lang.Enum, com.snap.modules.memories.backup.TranscodeErrorCode] */
    ...
    /* JADX WARN: Type inference failed for: r8v2, types: [java.lang.Enum, com.snap.modules.memories.backup.TranscodeErrorCode] */
    /* JADX WARN: Type inference failed for: r9v2, types: [java.lang.Enum, com.snap.modules.memories.backup.TranscodeErrorCode] */
    static {
        ?? r13 = new Enum("UNKNOWN", 0);
        UNKNOWN = r13;
        ?? r14 = new Enum("NIL_SELF", 1);
        NIL_SELF = r14;
        ?? r15 = new Enum("FAILED_TO_FETCH_ENTRY", 2);
        FAILED_TO_FETCH_ENTRY = r15;
        ?? r11 = new Enum("FAILED_TO_FETCH_SNAPS", 3);
        FAILED_TO_FETCH_SNAPS = r11;
        ?? r10 = new Enum("TRANSCODER_FATAL_FAILURE", 4);
        TRANSCODER_FATAL_FAILURE = r10;
        ?? r9 = new Enum("DISK_FULL_EXCEPTION", 5);
        DISK_FULL_EXCEPTION = r9;
        ?? r8 = new Enum("DEV_FORCE_FAIL", 6);
        DEV_FORCE_FAIL = r8;
        ?? r7 = new Enum("FAILED_TO_DESERIALIZE_SNAP_DOC", 7);
        FAILED_TO_DESERIALIZE_SNAP_DOC = r7;
        ?? r6 = new Enum("FAILED_TO_TRANSCODE_SNAP_DOC", 8);
        FAILED_TO_TRANSCODE_SNAP_DOC = r6;
        ?? r5 = new Enum("FAILED_TO_CLAIM_TRANSCODED_SNAP_DOC_MEDIA", 9);
        FAILED_TO_CLAIM_TRANSCODED_SNAP_DOC_MEDIA = r5;
        ?? r4 = new Enum("FAILED_TO_SAVE_TRANSOCDED_SNAP_DOC", 10);
        FAILED_TO_SAVE_TRANSOCDED_SNAP_DOC = r4;
        ?? r3 = new Enum("FAILED_DUE_TO_OUT_OF_MEMORY", 11);
        FAILED_DUE_TO_OUT_OF_MEMORY = r3;
        ?? r2 = new Enum("FAILED_DUE_TO_MISSING_FILE_ERROR", 12);
        FAILED_DUE_TO_MISSING_FILE_ERROR = r2;
        a = new TranscodeErrorCode[]{r13, r14, r15, r11, r10, r9, r8, r7, r6, r5, r4, r3, r2};
    }
