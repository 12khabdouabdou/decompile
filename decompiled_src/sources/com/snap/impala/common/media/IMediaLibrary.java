...
import defpackage.C16248bW8;
import defpackage.InterfaceC14142Zw3;
import java.util.List;
import kotlin.jvm.functions.Function2;

@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = C16248bW8.class, schema = "'getAuthorizationHandler':f|m|(): r:'[0]','getImageItems':f|m|(r:'[1]', f?(a<r:'[2]'>, s?)),'getVideoItems':f|m|(r:'[1]', f?(a<r:'[2]'>, s?)),'getThumbnailUrlsForItems':f|m|(a<r:'[3]'>, d, d, f?(a?<s>, s?)),'getImageForItem':f|m|(r:'[3]', f?(r?:'[4]', s?)),'getVideoForItem':f|m|(r:'[3]', f?(r?:'[5]', s?)),'getItemUri':f|m|(r:'[3]', f?(s?, s?))", typeReferences = {IAuthorizationHandler.class, ItemRequestOptions.class, MediaLibraryItem.class, MediaLibraryItemId.class, IImage.class, IVideo.class})
...
public interface IMediaLibrary extends ComposerMarshallable {
    ...
    void getItemUri(MediaLibraryItemId mediaLibraryItemId, Function2 function2);
