...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'snapId':s,'createTime':d,'durationMs':d,'thumbnailUri':s,'viewCount':d,'storyId':s,'dynamicSnapSource':d,'media':r:'[0]'", typeReferences = {PostArchiveSnapMedia.class})
/* loaded from: classes4.dex */
public final class PostArchiveSnap extends b {
