...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'type':r<e>:'[0]','durationMs':d,'delayMs':d,'colorChangeDurationMs':d@?,'colorChangeDelayMs':d@?,'color':s?,'finalStateDurationMs':d@?,'finalStateDelayMs':d@?", typeReferences = {AdCtaAnimationType.class})
/* loaded from: classes2.dex */
public final class AdCtaAnimation extends b {
