...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'firstName':s?,'lastName':s?,'address':s?,'city':s?,'state':s?,'zip':s?,'email':s?,'phone':s?", typeReferences = {})
/* loaded from: classes2.dex */
public final class AutoFillUserInfoPrompt extends b {
