...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'icon':r?<e>:'[0]','text':s?,'width':s?,'onClick':f?(),'noSpinnerOnClick':b@?", typeReferences = {SnapshotsOperaOverlayButtonIcon.class})
/* loaded from: classes8.dex */
public final class SnapshotsOperaOverlayButton extends b {
