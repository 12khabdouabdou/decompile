...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'key':s?,'iv':s?,'url':s?,'cacheKey':s?,'clientId':s?,'contentObjectInfo':r?:'[0]'", typeReferences = {EncryptedThumbnailContentObjectInfo.class})
/* loaded from: classes4.dex */
public final class EncryptedThumbnail extends b {
