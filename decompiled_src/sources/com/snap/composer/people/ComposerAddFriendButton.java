...
import defpackage.AbstractC20764et3;
...
import defpackage.C19427dt3;
import defpackage.C22007foj;
import defpackage.C22101ft3;
...
public final class ComposerAddFriendButton extends LoadingSpinnerButtonView implements InterfaceC17141cB3 {
    public static final C19427dt3 Companion = new Object();
    ...
    private final InterfaceC32875nwf schedulersProvider;
    ...
    private final void observeSubscriptioneStatus() {
        ...
        if (c36850qv != null && c36850qv.e) {
            LZj.p0(new ObservableSubscribeOn(((C46491y7i) this.subscriptionDataSource).e(c36850qv.b), ((C0973Bre) this.scheduler).d()).u0(((C0973Bre) this.scheduler).i()).S(Functions.a), new C8143Ov(this, 1), this.viewDisposables);
        }
    }
    ...
    public final void onTap() {
        ...
        if (z) {
            ...
            int i = AbstractC20764et3.a[ha.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    str = null;
                } else {
            ...
            new CompletableDoFinally(new CompletableObserveOn(new CompletableSubscribeOn(((C46491y7i) this.subscriptionDataSource).f(c12385Wpj), ((C0973Bre) this.scheduler).g()), ((C0973Bre) this.scheduler).i()), new C36590qj3(9, this)).subscribe(new C22101ft3(this, c36850qv), new C8143Ov(this, 2), this.viewDisposables);
            return;
        }
        if (c36850qv.d) {
            this.pageLauncher.b(new C8116Ote(new C22007foj(str2, c36850qv.c, EnumC30823mPf.p0, (C17502cSa) null, 16), null, null, null, null, null, false, null, null, null, 0, 8190));
        } else {
            setButtonState(enumC4334Hua);
            ...
            new CompletableObserveOn(new CompletableSubscribeOn(AbstractC34303p0g.a(this.friendRelationshipChanger, str2, this.addSourceType, JK7.e0, EnumC29394lL7.F0, null, null, null, null, null, null, null, null, 4064), ((C0973Bre) this.scheduler).g()), ((C0973Bre) this.scheduler).i()).subscribe(new C22101ft3(c36850qv, this), new C8143Ov(this, 3), this.viewDisposables);
        }
    }
    ...
    public final void setUserInfo(C36850qv c36850qv) {
        ...
        if (c36850qv == null) {
            setButtonState(EnumC4334Hua.b);
        } else if (c36850qv.d) {
            setButtonState(EnumC4334Hua.c);
        } else {
            setButtonState(EnumC4334Hua.a);
        }
        observeSubscriptioneStatus();
        Object tag = getTag();
        RB3 rb3 = null;
    ...
    public ComposerAddFriendButton(Context context, AttributeSet attributeSet, InterfaceC32875nwf interfaceC32875nwf, InterfaceC25510iR7 interfaceC25510iR7, InterfaceC26433j7i interfaceC26433j7i, J7d j7d, HA ha, AbstractC15274an0 abstractC15274an0, EnumC16222bV3 enumC16222bV3) {
        super(context, attributeSet);
        this.schedulersProvider = interfaceC32875nwf;
        ...
        setOnTouchListener(new ViewOnTouchListenerC33339oI1(new GestureDetector(context, new C39217sh(6, this)), 1));
        if (this.userInfo == null) {
            setButtonState(EnumC4334Hua.b);
        }
        setCheckedText(getContext().getResources().getString(R.string.f15981snap));
