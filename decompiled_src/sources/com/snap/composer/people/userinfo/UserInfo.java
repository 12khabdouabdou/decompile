...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'age':d,'countryCode':s?,'location':r?:'[0]','bitmojiInfo':r?:'[1]','birthdayMs':d@?,'phone':s?,'user':r?:'[2]'", typeReferences = {Location.class, BitmojiInfo.class, User.class})
