...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'user':r:'[0]','analyticsContext':r:'[1]'", typeReferences = {User.class, AnalyticsContext.class})
/* loaded from: classes4.dex */
public final class OpenActionSheetRequest extends b {
