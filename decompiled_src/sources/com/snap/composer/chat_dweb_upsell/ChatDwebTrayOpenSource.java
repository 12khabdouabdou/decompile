...
public final class ChatDwebTrayOpenSource {
    ...
    /* JADX WARN: Type inference failed for: r11v0, types: [com.snap.composer.chat_dweb_upsell.ChatDwebTrayOpenSource, java.lang.Enum] */
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [com.snap.composer.chat_dweb_upsell.ChatDwebTrayOpenSource, java.lang.Enum] */
    /* JADX WARN: Type inference failed for: r7v2, types: [com.snap.composer.chat_dweb_upsell.ChatDwebTrayOpenSource, java.lang.Enum] */
    static {
        ?? r11 = new Enum("STATUS_MESSAGE", 0);
        STATUS_MESSAGE = r11;
        ?? r12 = new Enum("FEED_HEADER", 1);
        FEED_HEADER = r12;
        ?? r13 = new Enum("SNAP_PSA", 2);
        SNAP_PSA = r13;
        ?? r14 = new Enum("POST_MISSED_CALL_1_1", 3);
        POST_MISSED_CALL_1_1 = r14;
        ?? r15 = new Enum("POST_SUCCESS_CALL_1_1", 4);
        POST_SUCCESS_CALL_1_1 = r15;
        ?? r7 = new Enum("POST_MISSED_CALL_GROUP", 5);
        POST_MISSED_CALL_GROUP = r7;
        ?? r6 = new Enum("POST_SUCCESS_CALL_GROUP", 6);
        POST_SUCCESS_CALL_GROUP = r6;
        ?? r5 = new Enum("IN_CALL_1_1", 7);
        IN_CALL_1_1 = r5;
        ?? r4 = new Enum("IN_CALL_GROUP", 8);
        IN_CALL_GROUP = r4;
        ?? r3 = new Enum("PROFILE_ACTIVITY_CARD", 9);
        PROFILE_ACTIVITY_CARD = r3;
        ?? r2 = new Enum("DEEP_LINK", 10);
        DEEP_LINK = r2;
        a = new ChatDwebTrayOpenSource[]{r11, r12, r13, r14, r15, r7, r6, r5, r4, r3, r2};
    }
