...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'lensId':s,'name':s,'deeplinkUrl':s,'iconUrl':s,'thumbnailUrl':s?,'launchData':r?:'[0]'", typeReferences = {LensLaunchData.class})
/* loaded from: classes3.dex */
public final class LensItem extends b {
