...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'templateId':s,'userAvatarId':s,'friendAvatarId':s?,'backgroundColor':s,'bitmojiImageWidth':s,'bitmojiImageHeight':s,'bitmojiImageMarginLeft':s,'bitmojiImageMarginTop':s", typeReferences = {})
/* loaded from: classes3.dex */
public final class BitmojiProductInfo extends b {
