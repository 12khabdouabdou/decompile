...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'thumbnailUri':s?,'contentUri':s?,'mediaId':s?,'isDefault':b@?,'mediaOwner':r?:'[0]','mediaOwnerId':s?,'contentObject':t?,'isSnapPlusExclusive':b@?,'isChatMedia':b@?", typeReferences = {User.class})
/* loaded from: classes3.dex */
public final class MediaItem extends b {
    private byte[] _contentObject;
    private String _contentUri;
    private Boolean _isChatMedia;
    ...
    public MediaItem(String str, String str2, String str3, Boolean bool, User user, String str4, byte[] bArr, Boolean bool2, Boolean bool3) {
        this._thumbnailUri = str;
