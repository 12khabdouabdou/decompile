...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'title':s,'subtitle':s,'leadingAccessory':r?:'[0]','trailingAccessory':r?:'[1]','onTapBackground':f?(f())", typeReferences = {ActionSheetHeaderLeadingAccessory.class, ActionSheetHeaderTrailingAccessory.class})
/* loaded from: classes3.dex */
public final class ActionSheetHeader extends b {
