...
@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = RT8.class, schema = "'observeEnteredBackground':f|m|(f()): r:'[0]','observeEnteredForeground':f|m|(f()): r:'[0]','observeKeyboardHeight':f|m|(f(d@)): r:'[0]','observeScreenCapture':f|m|(f(r<e>:'[1]')): r:'[0]'", typeReferences = {Cancelable.class, ScreenCaptureType.class})
