...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'borderRadius':d@?,'onReady':f?(f(r:'[0]'))", typeReferences = {Asset.class})
/* loaded from: classes3.dex */
public final class ActionSheetHeaderImageConfig extends b {
