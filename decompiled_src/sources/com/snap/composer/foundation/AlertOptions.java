...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'titleText':s?,'descriptionText':s?,'buttonText':s,'cancelButtonText':s?,'swipeToDismissEnabled':b@?,'customId':s?,'aboveTitleImage':r?:'[0]','aboveTitleImageWidth':d@?,'aboveTitleImageHeight':d@?,'textFieldConfig':r?:'[1]'", typeReferences = {Asset.class, AlertTextFieldConfig.class})
/* loaded from: classes3.dex */
public final class AlertOptions extends b {
