...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'viewFactory':r:'[0]','animationStateObservable':g<c>:'[1]'<d@>,'loadAnimation':f(s, s, s),'playWhenReady':f(b@),'onAnimationFinish':f()", typeReferences = {ViewFactory.class, BridgeObservable.class})
/* loaded from: classes3.dex */
public final class DreamsUnpackAnimationViewModel extends b {
