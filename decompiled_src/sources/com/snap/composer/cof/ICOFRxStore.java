...
import defpackage.C34935pU8;
import defpackage.InterfaceC14142Zw3;

@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = C34935pU8.class, schema = "'getInt':f|m|(s, d, r?:'[0]'): g<c>:'[1]'<d@>,'getLong':f|m|(s, d, r?:'[0]'): g<c>:'[1]'<d@>,'getFloat':f|m|(s, d, r?:'[0]'): g<c>:'[1]'<d@>,'getBool':f|m|(s, b, r?:'[0]'): g<c>:'[1]'<b@>,'getString':f|m|(s, s, r?:'[0]'): g<c>:'[1]'<s>,'getProtoBytes':f|m|(s, r?:'[0]'): g<c>:'[1]'<t>", typeReferences = {COFOptions.class, BridgeObservable.class})
