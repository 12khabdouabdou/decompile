...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'lensId':s,'lensName':s,'iconUrl':s,'creatorId':s?,'creatorName':s?,'creatorProId':s?,'isOfficialCreator':b@?,'isBusinessCategoryType':b@?", typeReferences = {})
/* loaded from: classes4.dex */
public final class ComposerTopicPageInfoLens extends b {
