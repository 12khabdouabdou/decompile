...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'displayName':s?,'subtitle':s?,'thumbnailUrl':s?,'badgeType':r<e>:'[0]','headerState':r?<e>:'[1]','storyPosterUserId':s?,'userAvatarInfo':m?<s,u>,'viewCount':s?,'avatarBackgroundColor':s?", typeReferences = {SnapProBadgeType.class, StoryChatShareHeaderState.class})
/* loaded from: classes3.dex */
public final class StoryChatShareHeaderDisplayInfo extends b {
