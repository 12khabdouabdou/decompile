...
@InterfaceC2109Du3(propertyReplacements = "", schema = "'isOnboardingComplete':b,'isCameosEnabled':b,'isExperimentEnabled':b,'businessProfileIds':a<s>,'onboardingImageSrc':s?,'onboardingContentId':s?,'onboardingSourceType':s?", typeReferences = {})
/* loaded from: classes8.dex */
public final class CameosPublisherConfig extends b {
    ...
    public final void c() {
        this._onboardingSourceType = "DISCOVER_PUBLISHER_PAGE";
    }
