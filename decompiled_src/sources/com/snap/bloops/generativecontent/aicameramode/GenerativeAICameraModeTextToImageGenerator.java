...
import defpackage.C48472zc8;
import defpackage.InterfaceC14142Zw3;

@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = C48472zc8.class, schema = "'generateImageFromPrompt':f|m|(s, r?:'[0]'): g<c>:'[1]'<r:'[2]'>", typeReferences = {GenerativeAISnapParameters.class, BridgeObservable.class, GenerativeAICameraModeTextToImageResult.class})
