...
import defpackage.C20267eW8;
import defpackage.InterfaceC14142Zw3;
import kotlin.jvm.functions.Function1;

@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = C20267eW8.class, schema = "'launchInviteFriendsFlow':f|m|(s),'launchFriendProfile':f|m|(r:'[0]', s),'launchFriendActionMenu':f|m|(r:'[0]', s),'addFriend':f|m|(r:'[1]', f(b@)),'unblockUser':f|m|(r:'[0]', f(b@))", typeReferences = {User.class, AddFriendRequest.class})
