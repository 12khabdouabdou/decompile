...
@InterfaceC4889Iv3(propertyReplacements = "", schema = "'RateLimited':0,'Error':1,'SuccessWithVerification':2,'SuccessAlreadyVerified':3,'ErrorDuplicateEmail':4,'UnsupportedCommunity':5,'CommunityFull':6,'SuccessfullyJoinedWaitlist':7,'JoinWaitlistFailed':8,'EmailDomainNotAllowed':9", type = EnumC5431Jv3.a)
/* loaded from: classes7.dex */
public final class JoinCommunityResult {
    public static final JoinCommunityResult CommunityFull;
    public static final JoinCommunityResult EmailDomainNotAllowed;
    ...
    /* JADX WARN: Type inference failed for: r10v0, types: [java.lang.Enum, com.snap.profile.communities.JoinCommunityResult] */
    ...
    /* JADX WARN: Type inference failed for: r4v2, types: [java.lang.Enum, com.snap.profile.communities.JoinCommunityResult] */
    /* JADX WARN: Type inference failed for: r5v2, types: [java.lang.Enum, com.snap.profile.communities.JoinCommunityResult] */
    static {
        ?? r10 = new Enum("RateLimited", 0);
        RateLimited = r10;
        ?? r11 = new Enum("Error", 1);
        Error = r11;
        ?? r12 = new Enum("SuccessWithVerification", 2);
        SuccessWithVerification = r12;
        ?? r13 = new Enum("SuccessAlreadyVerified", 3);
        SuccessAlreadyVerified = r13;
        ?? r14 = new Enum("ErrorDuplicateEmail", 4);
        ErrorDuplicateEmail = r14;
        ?? r15 = new Enum("UnsupportedCommunity", 5);
        UnsupportedCommunity = r15;
        ?? r5 = new Enum("CommunityFull", 6);
        CommunityFull = r5;
        ?? r4 = new Enum("SuccessfullyJoinedWaitlist", 7);
        SuccessfullyJoinedWaitlist = r4;
        ?? r3 = new Enum("JoinWaitlistFailed", 8);
        JoinWaitlistFailed = r3;
        ?? r2 = new Enum("EmailDomainNotAllowed", 9);
        EmailDomainNotAllowed = r2;
        a = new JoinCommunityResult[]{r10, r11, r12, r13, r14, r15, r5, r4, r3, r2};
    }
