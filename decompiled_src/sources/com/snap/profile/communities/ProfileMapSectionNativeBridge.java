...
@InterfaceC14142Zw3(propertyReplacements = "", proxyClass = A7e.class, schema = "'mapUrlGenerator':r?:'[0]','mapPresenter':r:'[1]','getMapPlaceInfo':f|m|(s): g<c>:'[2]'<r:'[3]'>", typeReferences = {StaticMapUrlGenerator.class, MapPresenter.class, BridgeObservable.class, PlaceInfoModel.class})
