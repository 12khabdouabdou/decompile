...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i, U4k u4k) {
        long nativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        u4k.a = nativeGetMetadataEntry;
        if (nativeGetMetadataEntry != 0) {
            u4k.b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, nativeGetMetadataEntry);
            u4k.c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, u4k.a);
            return;
        }
    ...
    public byte getByte(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 0 && u4k.c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
    ...
    public byte[] getByteArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double getDouble(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 4 && u4k.c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public double[] getDoubleArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float getFloat(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 2 && u4k.c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public float[] getFloatArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int getInt(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 1 && u4k.c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public int[] getIntArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long getLong(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 3 && u4k.c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public long[] getLongArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational getRational(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 5 && u4k.c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    public Rational[] getRationalArray(int i) throws MetadataNotFoundException {
        ...
        U4k u4k = this.sketchEntry;
        if (u4k.b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, u4k.a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.a);
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [java.lang.Object, U4k] */
