...
public class StreetscapeGeometry extends TrackableBase {
    ...
    public enum Quality {
        ...
        public static Quality forNumber(int i) {
            ...
            throw new FatalException(T4k.a((byte) 63, i, "Unexpected value for native StreetscapeGeometry.Quality, value="));
        }
    }
    ...
    public enum Type {
        ...
        public static Type forNumber(int i) {
            ...
            throw new FatalException(T4k.a((byte) 60, i, "Unexpected value for native StreetscapeGeometry.Type, value="));
        }
    }
