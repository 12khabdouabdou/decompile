...
public final class JsonObject extends JsonElement {
    ...
    public void addProperty(String str, String str2) {
        add(str, str2 == null ? C35875qB9.a : new JsonPrimitive(str2));
    }
    ...
    public void addProperty(String str, Number number) {
        add(str, number == null ? C35875qB9.a : new JsonPrimitive(number));
    }
    ...
    public void addProperty(String str, Boolean bool) {
        add(str, bool == null ? C35875qB9.a : new JsonPrimitive(bool));
    }

    public void addProperty(String str, Character ch) {
        add(str, ch == null ? C35875qB9.a : new JsonPrimitive(ch));
    }
}
