...
public abstract class ConfigurationMarshaller {
    ...
    public static final class CppProxy extends ConfigurationMarshaller {
        ...
        private native ConfigurationState native_getConfigurationState(long j);
        ...
        public ConfigurationState getConfigurationState() {
            return native_getConfigurationState(this.nativeRef);
        }
    ...
    public abstract ConfigurationState getConfigurationState();
