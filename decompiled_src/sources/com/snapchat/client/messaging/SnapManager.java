...
public abstract class SnapManager {
    ...
    public static final class CppProxy extends SnapManager {
        ...
        private native void native_onSnapInteraction(long j, SnapInteractionType snapInteractionType, UUID uuid, long j2, SnapInteractionCallback snapInteractionCallback);
        ...
        @Override // com.snapchat.client.messaging.SnapManager
        public void onSnapInteraction(SnapInteractionType snapInteractionType, UUID uuid, long j, SnapInteractionCallback snapInteractionCallback) {
            native_onSnapInteraction(this.nativeRef, snapInteractionType, uuid, j, snapInteractionCallback);
        }
    ...
    public abstract void onSnapInteraction(SnapInteractionType snapInteractionType, UUID uuid, long j, SnapInteractionCallback snapInteractionCallback);
