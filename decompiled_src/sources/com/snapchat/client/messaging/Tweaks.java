...
public final class Tweaks {
    ...
    public static final int AUTO_PAGINATE_QUERY_FEED_ENABLED = 146;
    public static final int AUTO_PAGINATE_QUERY_FEED_LITE_ENABLED = 147;
    public static final int CALLBACK_FETCH_ON_FEED_DELEGATE = 142;
    public static final int CALLBACK_ON_FEED_DELEGATE = 136;
    public static final int CALLBACK_QUERY_ON_FEED_DELEGATE = 143;
    public static final int CALLBACK_SYNC_ON_FEED_DELEGATE = 144;
    ...
    public static final int EEL_GROUP_CONFIG_COF_OVERRIDE64 = 158;
    public static final int ENABLE_24HR_SNAPS = 115;
    public static final int ENABLE_AD_SYNC_ON_P2R = 161;
    ...
    public static final int ENABLE_FEED_SYNC_V4_CORRECTION = 157;
    ...
    public static final int ENABLE_LOGIN_PREFETCH = 154;
    public static final int ENABLE_MEDIA_PREFETCH_IGNORE_DOWNLOAD_STATUS = 156;
    ...
    public static final int ENABLE_POST_SYNC_QUERY = 155;
    public static final int ENABLE_PRESENCE_TRANSPORT_KEY = 8;
    public static final int ENABLE_PUBLIC_GROUPS = 160;
    public static final int ENABLE_RETRY_POST_SYNC_PREFETCH = 159;
    ...
    public static final int ENABLE_STREAK_SETTINGS = 162;
    ...
    public static final int EXTENSION_DB_WAL_KILLSWITCH = 148;
    public static final int EXTENSION_FAIL_SYNC_WRITE_KILLSWITCH = 149;
    ...
    public static final int FEED_PAGINATION_V4_ENABLED = 145;
    ...
    public static final int LOGIN_PREFETCH_MAX_ENTRIES = 151;
    public static final int LOGIN_PREFETCH_MIN_ENTRIES = 150;
    public static final int LOGIN_PREFETCH_PAGE_SIZE = 152;
    ...
    public static final int MAX_EXTENDED_HOURS_AFTER_STREAK_EXPIRE_TO_ENABLE_RESTORE = 132;
    ...
    public static final int PASSIVE_ACTIVE_DEMO_ENABLED = 153;
    public static final int POST_SYNC_QUERY_PREFETCH_ADDITIONAL_FILTERING = 153;
    public static final int PREFETCHABLE_SNAPS_ALREADY_DOWNLOADED_LIMIT = 73;
    public static final int RECIPIENTS_PROVIDER_LOG_ALL = 131;
    ...
    public static final int SKIP_GROUP_SNAPCHATTER_INFO_RECIPIENT_PROVIDER = 135;
    public static final int SKIP_ONE_ON_ONE_SNAPCHATTER_INFO_RECIPIENT_PROVIDER = 134;
    public static final int SKIP_SNAPCHATTER_INFO_RECIPIENT_PROVIDER = 133;
    public static final int SNAP_REPLAY_DURATION_MS = 107;
    public static final int SPONSORED_SNAPS_ENABLED = 137;
    public static final int SPONSORED_SNAPS_FEED_INSERT_MODE = 140;
    public static final int SPONSORED_SNAPS_RANDOM_FEED_INSERT_ENABLED = 138;
    public static final int SPONSORED_SNAPS_RANDOM_FEED_INSERT_INDEX_OVERRIDE = 139;
    public static final int SPONSORED_SNAPS_USER_INPUT_MODE = 141;
