...
public abstract class ConversationManager {
    ...
    public static final class CppProxy extends ConversationManager {
        ...
        private native void native_acceptConversationInvitation(long j, UUID uuid, Callback callback);
        ...
        private native void native_declineConversationInvitation(long j, UUID uuid, Callback callback);
        ...
        private native void native_fetchPlayableMediaMessagesAroundMessage(long j, UUID uuid, long j2, FetchMessagesCallback fetchMessagesCallback);
        ...
        private native void native_inviteParticipants(long j, UUID uuid, InviteDestinations inviteDestinations, Callback callback);

        private native void native_joinGroupConversation(long j, UUID uuid, JoinGroupConversationMetadata joinGroupConversationMetadata, Callback callback);
        ...
        private native void native_updateCustomRingtoneSound(long j, UUID uuid, Long l, Callback callback);
        ...
        public void acceptConversationInvitation(UUID uuid, Callback callback) {
            native_acceptConversationInvitation(this.nativeRef, uuid, callback);
        }
        ...
        @Override // com.snapchat.client.messaging.ConversationManager
        public void declineConversationInvitation(UUID uuid, Callback callback) {
            native_declineConversationInvitation(this.nativeRef, uuid, callback);
        }
        ...
        @Override // com.snapchat.client.messaging.ConversationManager
        public void fetchPlayableMediaMessagesAroundMessage(UUID uuid, long j, FetchMessagesCallback fetchMessagesCallback) {
            native_fetchPlayableMediaMessagesAroundMessage(this.nativeRef, uuid, j, fetchMessagesCallback);
        }
        ...
        @Override // com.snapchat.client.messaging.ConversationManager
        public void inviteParticipants(UUID uuid, InviteDestinations inviteDestinations, Callback callback) {
            native_inviteParticipants(this.nativeRef, uuid, inviteDestinations, callback);
        }

        @Override // com.snapchat.client.messaging.ConversationManager
        public void joinGroupConversation(UUID uuid, JoinGroupConversationMetadata joinGroupConversationMetadata, Callback callback) {
            native_joinGroupConversation(this.nativeRef, uuid, joinGroupConversationMetadata, callback);
        }
        ...
        @Override // com.snapchat.client.messaging.ConversationManager
        public void updateCustomRingtoneSound(UUID uuid, Long l, Callback callback) {
            native_updateCustomRingtoneSound(this.nativeRef, uuid, l, callback);
        }
    ...
    public abstract void acceptConversationInvitation(UUID uuid, Callback callback);
    ...
    public abstract void declineConversationInvitation(UUID uuid, Callback callback);
    ...
    public abstract void fetchPlayableMediaMessagesAroundMessage(UUID uuid, long j, FetchMessagesCallback fetchMessagesCallback);
    ...
    public abstract void inviteParticipants(UUID uuid, InviteDestinations inviteDestinations, Callback callback);

    public abstract void joinGroupConversation(UUID uuid, JoinGroupConversationMetadata joinGroupConversationMetadata, Callback callback);
    ...
    public abstract void updateCustomRingtoneSound(UUID uuid, Long l, Callback callback);
