...
public final class PartitionConfiguration {
    ...
    public String toString() {
        ...
        String str2 = this.mOverrideNameForUpload;
        return AbstractC30172lva.C(DM4.v("PartitionConfiguration{mName=", str, ",mOverrideNameForUpload=", str2, ",mMetricNames="), String.valueOf(this.mMetricNames), "}");
    }
}
