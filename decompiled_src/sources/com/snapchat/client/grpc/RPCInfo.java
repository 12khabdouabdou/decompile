...
public final class RPCInfo {
    ...
    public String toString() {
        ...
        StringBuilder v = DM4.v("RPCInfo{mServiceMethodName=", str, ",mHost=", str2, ",mChannelType=");
        AbstractC30628mG8.x(v, valueOf, ",mProtocol=", str3, ",mConnectionReused=");
        v.append(z);
        v.append(",mDnsResolveInMillis=");
        v.append(i);
        v.append(",mConnetionSetupInMillis=");
        AbstractC21001f3j.i(i2, i3, ",mSslSetupInMillis=", ",mReqWireSize=", v);
        AbstractC21001f3j.i(i4, i5, ",mResponseWireSize=", ",mServerIp=", v);
        v.append(str4);
