...
public abstract class SnapDrawingViewLoader {
    ...
    public static final class CppProxy extends SnapDrawingViewLoader {
        ...
        private native boolean native_dispatchTouchEvent(long j, long j2, int i, float f, float f2, float f3, float f4, int i2, int i3, ArrayList<Float> arrayList);
        ...
        @Override // com.snapchat.client.composer_lenscore.SnapDrawingViewLoader
        public boolean dispatchTouchEvent(long j, int i, float f, float f2, float f3, float f4, int i2, int i3, ArrayList<Float> arrayList) {
            return native_dispatchTouchEvent(this.nativeRef, j, i, f, f2, f3, f4, i2, i3, arrayList);
        }
    ...
    public abstract boolean dispatchTouchEvent(long j, int i, float f, float f2, float f3, float f4, int i2, int i3, ArrayList<Float> arrayList);
