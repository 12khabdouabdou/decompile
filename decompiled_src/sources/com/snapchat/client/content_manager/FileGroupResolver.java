...
public abstract class FileGroupResolver {
    ...
    public static final class CppProxy extends FileGroupResolver {
        ...
        private native Future<Outcome<FileGroup, Error>> native_resolveZipArchive(long j, MediaContextType mediaContextType, ContentBundle contentBundle);
        ...
        @Override // com.snapchat.client.content_manager.FileGroupResolver
        public Future<Outcome<FileGroup, Error>> resolveZipArchive(MediaContextType mediaContextType, ContentBundle contentBundle) {
            return native_resolveZipArchive(this.nativeRef, mediaContextType, contentBundle);
        }
    }
    ...
    public abstract Future<Outcome<FileGroup, Error>> resolveZipArchive(MediaContextType mediaContextType, ContentBundle contentBundle);
}
