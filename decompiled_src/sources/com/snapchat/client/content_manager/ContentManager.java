...
public abstract class ContentManager {
    ...
    public static final class CppProxy extends ContentManager {
        ...
        private native void native_logConsumed(long j, ContentKey contentKey, ConsumptionUseCase consumptionUseCase, Range range);
        ...
        private native void native_registerLocalContent(long j, ContentKey contentKey, long j2, ReadStream readStream, boolean z, byte[] bArr, RegisterCallback registerCallback);
        ...
        @Override // com.snapchat.client.content_manager.ContentManager
        public void logConsumed(ContentKey contentKey, ConsumptionUseCase consumptionUseCase, Range range) {
            native_logConsumed(this.nativeRef, contentKey, consumptionUseCase, range);
        }
        ...
        @Override // com.snapchat.client.content_manager.ContentManager
        public void registerLocalContent(ContentKey contentKey, long j, ReadStream readStream, boolean z, byte[] bArr, RegisterCallback registerCallback) {
            native_registerLocalContent(this.nativeRef, contentKey, j, readStream, z, bArr, registerCallback);
        }
    ...
    public abstract void logConsumed(ContentKey contentKey, ConsumptionUseCase consumptionUseCase, Range range);
    ...
    public abstract void registerLocalContent(ContentKey contentKey, long j, ReadStream readStream, boolean z, byte[] bArr, RegisterCallback registerCallback);
