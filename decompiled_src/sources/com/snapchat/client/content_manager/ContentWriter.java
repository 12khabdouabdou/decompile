...
public abstract class ContentWriter {
    ...
    public static final class CppProxy extends ContentWriter {
        ...
        private native void native_markIsEncrypted(long j, boolean z);
        ...
        @Override // com.snapchat.client.content_manager.ContentWriter
        public void markIsEncrypted(boolean z) {
            native_markIsEncrypted(this.nativeRef, z);
        }
    ...
    public abstract void markIsEncrypted(boolean z);
