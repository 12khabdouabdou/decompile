...
public final class NnmInternalErrorCode {
    ...
    public static final int ERROR_INTERNAL_PAUSE = 1200;
    public static final int ERROR_OPEN_FILE_FOR_DOWNLOAD = 1000;
    public static final int ERROR_OUT_OF_MEMORY_ON_REQUEST_FINISHED = 1008;
    public static final int ERROR_RTT_TIMEOUT = 1100;
    public static final int ERROR_SNAP_TOKEN_FETCH_ERROR = 1007;
