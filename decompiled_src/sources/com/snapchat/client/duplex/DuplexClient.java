...
public abstract class DuplexClient {
    ...
    public static final class CppProxy extends DuplexClient {
        ...
        private native void native_appMemoryPressureStateChanged(long j, AppMemoryPressureState appMemoryPressureState);
        ...
        @Override // com.snapchat.client.duplex.DuplexClient
        public void appMemoryPressureStateChanged(AppMemoryPressureState appMemoryPressureState) {
            native_appMemoryPressureStateChanged(this.nativeRef, appMemoryPressureState);
        }
    ...
    public abstract void appMemoryPressureStateChanged(AppMemoryPressureState appMemoryPressureState);
