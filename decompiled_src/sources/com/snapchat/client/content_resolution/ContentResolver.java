...
public abstract class ContentResolver {
    ...
    public static final class CppProxy extends ContentResolver {
        ...
        private native PlatformContentResolveResult native_resolveContentBundleAsPlatformResult(long j, ContentBundle contentBundle);
        ...
        @Override // com.snapchat.client.content_resolution.ContentResolver
        public PlatformContentResolveResult resolveContentBundleAsPlatformResult(ContentBundle contentBundle) {
            return native_resolveContentBundleAsPlatformResult(this.nativeRef, contentBundle);
        }
    ...
    public static native ContentResolver create(BoltNetworkRulesProviderCallback boltNetworkRulesProviderCallback, BoltMediaVariantProviderCallback boltMediaVariantProviderCallback, BlizzardProtoLoggerInterface blizzardProtoLoggerInterface, String str, boolean z);
    ...
    public abstract PlatformContentResolveResult resolveContentBundleAsPlatformResult(ContentBundle contentBundle);
