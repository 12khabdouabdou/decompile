...
import com.snapchat.client.network_types.BandwidthAnalyzer;
import com.snapchat.client.network_types.BandwidthAnalyzerConfig;
...
public abstract class NetworkQualityEstimationService {
    ...
    public static final class CppProxy extends NetworkQualityEstimationService {
        ...
        private native BandwidthAnalyzer native_createBandwidthAnalyzer(long j, BandwidthAnalyzerConfig bandwidthAnalyzerConfig);
        ...
        @Override // com.snapchat.client.network_quality_estimation.NetworkQualityEstimationService
        public BandwidthAnalyzer createBandwidthAnalyzer(BandwidthAnalyzerConfig bandwidthAnalyzerConfig) {
            return native_createBandwidthAnalyzer(this.nativeRef, bandwidthAnalyzerConfig);
        }
    ...
    public abstract BandwidthAnalyzer createBandwidthAnalyzer(BandwidthAnalyzerConfig bandwidthAnalyzerConfig);
