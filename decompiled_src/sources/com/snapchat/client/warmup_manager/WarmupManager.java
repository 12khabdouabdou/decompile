...
public abstract class WarmupManager {
    ...
    public static native WarmupManager createInstance(WarmupManagerSupportInterface warmupManagerSupportInterface, ConnectivityChangeNotifier connectivityChangeNotifier, AppStateChangeNotifier appStateChangeNotifier);
