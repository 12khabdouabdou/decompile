...
public class SCameraBeautyProcessor extends SCameraEffectProcessor {
    ...
    public AbstractSemCameraEffectProcessor getSemCameraBeautyProcessor() {
        if (this.mSemCameraBeautyProcessor == null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_11) >= 0) {
                this.mSemCameraBeautyProcessor = new SemCameraBeautyProcessor10_3();
            } else {
                this.mSemCameraBeautyProcessor = new SemCameraBeautyProcessorDefault();
            }
        }
        ...
        try {
            ...
            if (this.mParameterList == null) {
                ...
                for (AbstractSemCameraEffectProcessor.ProcessorParameter<Boolean> processorParameter : availableParameters) {
                    if (processorParameter == AbstractSemCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY) {
                        this.mParameterList.add(SCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY);
                    } else if (processorParameter == AbstractSemCameraEffectProcessor.PARAMETER_IMAGE_FORMAT) {
    ...
    public boolean isPreviewVDISSupported(Context context, CameraCharacteristics cameraCharacteristics) {
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_400) >= 0 && getSemCameraBeautyProcessor().isPreviewVDISSupported(cameraCharacteristics)) {
                return true;
            }
            return false;
        }
    ...
    public boolean isSuperNightSupported(Context context, CameraCharacteristics cameraCharacteristics) {
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_400) >= 0 && getSemCameraBeautyProcessor().isSuperNightSupported(cameraCharacteristics)) {
                return true;
            }
            return false;
        }
    ...
    public synchronized boolean isZoomControllerAvailable(Context context, CameraCharacteristics cameraCharacteristics) {
        boolean z;
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_310) >= 0 && getSemCameraBeautyProcessor().isZoomControllerAvailable(cameraCharacteristics)) {
                z = true;
            } else {
                z = false;
            }
            ...
            if (processorParameter != null) {
                ...
                if (processorParameter == SCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY) {
                    if (t instanceof Boolean) {
                        getSemCameraBeautyProcessor().setProcessorParameter(AbstractSemCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY, (Boolean) t);
                    } else {
                    ...
                    if (t instanceof Integer) {
                        getSemCameraBeautyProcessor().setProcessorParameter(AbstractSemCameraEffectProcessor.PARAMETER_IMAGE_FORMAT, (Integer) t);
                    } else {
