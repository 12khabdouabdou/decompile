...
public class SCameraBokehProcessor extends SCameraEffectProcessor {
    ...
    public AbstractSemCameraEffectProcessor getSemCameraBokehProcessor() {
        if (this.mSemCameraBokehProcessor == null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_11) >= 0) {
                this.mSemCameraBokehProcessor = new SemCameraBokehProcessor10_3();
            } else {
                this.mSemCameraBokehProcessor = new SemCameraBokehProcessorDefault();
            }
        }
    ...
    public boolean isPreviewVDISSupported(Context context, CameraCharacteristics cameraCharacteristics) {
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_400) >= 0 && getSemCameraBokehProcessor().isPreviewVDISSupported(cameraCharacteristics)) {
                return true;
            }
            return false;
        }
    ...
    public boolean isSuperNightSupported(Context context, CameraCharacteristics cameraCharacteristics) {
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_400) >= 0 && getSemCameraBokehProcessor().isSuperNightSupported(cameraCharacteristics)) {
                return true;
            }
            return false;
        }
    ...
    public synchronized boolean isZoomControllerAvailable(Context context, CameraCharacteristics cameraCharacteristics) {
        boolean z;
        if (context != null) {
            if (SsdkVersionCheck.compareVersion(AbstractSemCamera.getSEPClientVersion(), AbstractSemCameraSdkConstants.SEP_CLIENT_VERSION_310) >= 0 && getSemCameraBokehProcessor().isZoomControllerAvailable(cameraCharacteristics)) {
                z = true;
            } else {
                z = false;
            }
            ...
            if (processorParameter != null) {
                ...
                if (processorParameter == SCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY) {
                    if (t instanceof Boolean) {
                        getSemCameraBokehProcessor().setProcessorParameter(AbstractSemCameraEffectProcessor.PARAMETER_ENABLE_FACE_BEAUTY, (Boolean) t);
                    } else {
                    ...
                    if (t instanceof Integer) {
                        getSemCameraBokehProcessor().setProcessorParameter(AbstractSemCameraEffectProcessor.PARAMETER_IMAGE_FORMAT, (Integer) t);
                    } else {
