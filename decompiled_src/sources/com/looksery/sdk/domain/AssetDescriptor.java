...
public final class AssetDescriptor {
    ...
    public boolean equals(Object obj) {
        ...
        String str3 = this.mLensId;
        if (str3 == null ? assetDescriptor.mLensId != null : !str3.equals(assetDescriptor.mLensId)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        return Arrays.hashCode(this.mChecksum) + AbstractC7238Nde.c(AbstractC7238Nde.c((i7 + i4) * 31, 31, this.mEncryptionKey), 31, this.mEncryptionIv);
    }
    ...
    public String toString() {
        ...
        sb.append("', mUrl='");
        return AbstractC30172lva.C(sb, this.mUrl, "'}");
    }
}
