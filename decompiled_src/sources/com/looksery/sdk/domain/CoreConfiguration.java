...
public class CoreConfiguration {
    ...
    private final TrackingMode mTrackingMode;
    ...
    public static class CoreConfigurationBuilder {
        ...
        private TrackingMode mTrackingMode = TrackingMode.Default;
        ...
        public CoreConfigurationBuilder setAsyncTrackingEnabled(boolean z) {
            TrackingMode trackingMode;
            if (z) {
                trackingMode = TrackingMode.Async;
            } else {
                trackingMode = TrackingMode.Sync;
            }
        ...
        public CoreConfigurationBuilder setTag(String str) {
            if (str == null) {
                str = "";
            }
            this.mTag = str;
    ...
    public CoreConfiguration(CoreConfigurationBuilder coreConfigurationBuilder) {
        this.mTag = coreConfigurationBuilder.getTag();
        ...
        this.mTrackingMode = coreConfigurationBuilder.getTrackingMode();
        EglContextChecker.Factory eglContextCheckerFactory = coreConfigurationBuilder.getEglContextCheckerFactory();
        if (eglContextCheckerFactory == null) {
            this.mEglContextCheckerFactory = EglContextChecker.Factory.NOOP;
        } else {
            this.mEglContextCheckerFactory = eglContextCheckerFactory;
        }
    }
    ...
    public String toString() {
        return "CoreConfiguration{mTag='" + this.mTag + "', mCoreResourcesPath='" + this.mCoreResourcesPath + "', mResourcesPath='" + this.mResourcesPath + "', mDocumentsPath='" + this.mDocumentsPath + "', mCachePath='" + this.mCachePath + "', mUserDataPath='" + this.mUserDataPath + "', mDisableTracking=" + this.mDisableTracking + ", mInstrumentationDelegatesFactory=" + this.mInstrumentationDelegatesFactory + ", mVideoCodecFactory=" + this.mVideoCodecFactory + ", mExperimentProvider=" + this.mExperimentProvider + ", mExternalFaceDetectorFactory=" + this.mExternalFaceDetectorFactory + ", mRenderDriver=" + this.mRenderDriver + ", mInvocationDeviceType=" + this.mInvocationDeviceType + ", mResourcesInitMode=" + this.mResourcesInitMode + ", mTrackingMode=" + this.mTrackingMode + ", eglContextCheckerFactory=" + this.mEglContextCheckerFactory + '}';
    }
}
