...
public final class SpectaclesInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && SpectaclesInfo.class == obj.getClass()) {
            ...
            if (Arrays.equals(this.mLeftExtrinsics, spectaclesInfo.mLeftExtrinsics) && Arrays.equals(this.mRightExtrinsics, spectaclesInfo.mRightExtrinsics) && Arrays.equals(this.mStabilizationData, spectaclesInfo.mStabilizationData) && this.mStereoRenderMode == spectaclesInfo.mStereoRenderMode) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        int d = AbstractC42694vHg.d(AbstractC42694vHg.d((i15 + i5) * 31, 31, this.mLeftAlignmentComp), 31, this.mRightAlignmentComp);
        String str = this.mCalibrationPath;
        if (str != null) {
            i6 = str.hashCode();
        } else {
        ...
        int d2 = AbstractC42694vHg.d(AbstractC42694vHg.d(AbstractC42694vHg.d((((((i17 + i8) * 31) + (this.mSingleFrameMode ? 1 : 0)) * 31) + this.mFrameIndex) * 31, 31, this.mLeftExtrinsics), 31, this.mRightExtrinsics), 31, this.mStabilizationData);
    ...
    public SpectaclesInfo(SpectaclesVersion spectaclesVersion, boolean z, int i, int i2, float f, float f2, int i3, SpectaclesLut spectaclesLut, SpectaclesLut spectaclesLut2, float[] fArr, float[] fArr2, String str, String str2, String str3, boolean z2, StereoRenderMode stereoRenderMode, float[] fArr3, float[] fArr4, float[] fArr5, float f3) {
        ...
        fArr = fArr == null ? IDENTITY_MAT3x3 : fArr;
        this.mLeftAlignmentComp = fArr;
        checkValidArray(fArr, 9, "Left alignment compensation must be a 3x3 matrix stored in column major format");
        fArr2 = fArr2 == null ? IDENTITY_MAT3x3 : fArr2;
        this.mRightAlignmentComp = fArr2;
        checkValidArray(fArr2, 9, "Right alignment compensation must be a 3x3 matrix stored in column major format");
        ...
        float[] fArr6 = fArr3 != null ? fArr3 : IDENTITY_MAT4x4;
        this.mLeftExtrinsics = fArr6;
        checkValidArray(fArr6, 16, "Left extrinsics must be a 4x4 matrix stored in column major format");
        float[] fArr7 = fArr4 != null ? fArr4 : IDENTITY_MAT4x4;
        this.mRightExtrinsics = fArr7;
        checkValidArray(fArr7, 16, "Right extrinsics must be a 4x4 matrix stored in column major format");
        float[] fArr8 = fArr5 != null ? fArr5 : IDENTITY_MAT3x3;
        this.mStabilizationData = fArr8;
        checkValidArray(fArr8, 9, "Stabilization data must be a 3x3 matrix stored in column major format");
