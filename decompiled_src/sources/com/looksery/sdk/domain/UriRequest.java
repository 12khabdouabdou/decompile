...
public class UriRequest {
    ...
    public String toString() {
        ...
        if (bArr.length < REQUEST_DATA_CONTENT_TO_STRING_MAX_SIZE) {
            y = Arrays.toString(bArr);
        } else {
            y = EU0.y(new StringBuilder("{byte["), this.mData.length, "]}");
        }
        ...
        sb.append("', mUri='");
        AbstractC30628mG8.x(sb, this.mUri, "', mData=", y, ", mMethod='");
        ...
        sb.append("', mIsUnary=");
        return AbstractC30628mG8.q(sb, this.mIsUnary, '}');
    }
}
