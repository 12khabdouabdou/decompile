...
final class DefaultDeviceCompassTracker implements DeviceCompassTracker, SensorEventListener {
    ...
    private final FOa mOrientationFilter = new FOa(ORIENTATION_CUTOFF_FREQUENCY);
    ...
    /* JADX WARN: Type inference failed for: r8v2, types: [puj, java.lang.Object] */
    @Override // android.hardware.SensorEventListener
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (SensorManager.getRotationMatrix(this.mMatrixR, null, this.mAccelerometer, this.mMagneticField)) {
            ...
            if (d2 > ACCELERATION_G_THRESHOLD_MPS2) {
                ...
                SensorManager.remapCoordinateSystem(this.mMatrixR, 1, 131, this.mMatrixRout);
            } else {
                double d3 = fArr5[0];
                if (d3 > ACCELERATION_G_THRESHOLD_MPS2) {
                    SensorManager.remapCoordinateSystem(this.mMatrixR, 3, 2, this.mMatrixRout);
                } else if (d3 < -6.0d) {
                    SensorManager.remapCoordinateSystem(this.mMatrixR, 131, 2, this.mMatrixRout);
                } else {
            ...
            FOa fOa = this.mOrientationFilter;
            if (fOa.d > 0) {
                d = fOa.b.a;
            } else {
                d = d4;
            ...
            FOa fOa2 = this.mOrientationFilter;
            ?? obj = new Object();
            obj.f(round, 0.0d, 0.0d);
            fOa2.a(obj, sensorEvent.timestamp, 1.0d);
