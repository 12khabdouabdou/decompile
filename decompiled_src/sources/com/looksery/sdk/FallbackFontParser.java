...
final class FallbackFontParser {
    ...
    static {
        ...
        hashMap.put("emoji", Arrays.asList("NotoColorEmoji.ttf", "NotoColorEmojiFlags.ttf", "NotoColorEmojiLegacy.ttf", "SamsungColorEmoji.ttf", "AndroidEmoji.ttf"));
    ...
    public static File findFontsXmlFile() {
        ...
        if (!file.exists()) {
            return new File(SYSTEM_ETC_FALLBACK_FONTS_XML);
        }
        return file;
    }
    ...
    public String[] getFallbackFontsForLanguage(File file, String str) {
        ...
        try {
            ...
            try {
                ...
                Iterator<String> it = LANG_PRIORITY_ORDER.iterator();
                while (it.hasNext()) {
                ...
                if (this.mTryToResolveFontPaths) {
                    ...
                    while (listIterator.hasNext()) {
                        ...
                        if (!str5.equals(fullPath)) {
                            String fullPath2 = getFullPath(str5);
                            if (fullPath2 != null) {
                ...
                return (String[]) arrayList3.toArray(new String[i]);
            } finally {
            }
