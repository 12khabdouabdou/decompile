...
public final class LSRemoteAssetsWrapper {
    ...
    private native long nativeInit(ConfigurationProvider configurationProvider);
    ...
    public LSRemoteAssetsWrapper(Context context, ConfigurationProvider configurationProvider) {
        LSNativeLibraryLoader.ensureAllAreLoaded();
        LensCoreResources.initializeOnce(context);
        this.mSafeNativeBridge = new SafeNativeBridge(nativeInit(configurationProvider), new Runnable() { // from class: com.looksery.sdk.LSRemoteAssetsWrapper.2
            @Override // java.lang.Runnable
            public void run() {
                LSRemoteAssetsWrapper lSRemoteAssetsWrapper = LSRemoteAssetsWrapper.this;
                lSRemoteAssetsWrapper.nativeRelease(lSRemoteAssetsWrapper.mSafeNativeBridge.getNativeHandle());
