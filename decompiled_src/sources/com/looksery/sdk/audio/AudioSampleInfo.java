...
public final class AudioSampleInfo {
    ...
    public String toString() {
        return "AudioSampleInfo{mResourceUri='" + this.mResourceUri + "', mChannelCount=" + this.mChannelCount + ", mBitDepth=" + this.mBitDepth + ", mSampleRate=" + this.mSampleRate + ", mDurationUs=" + this.mDurationUs + ", mEstimatedInMemorySizeMb=" + this.mEstimatedInMemorySizeMb + '}';
    }
