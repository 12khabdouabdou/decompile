...
import defpackage.AbstractC38034ro0;
...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public void setPreferredInputDevice(AudioDeviceInfo audioDeviceInfo) {
        Logging.d(TAG, "setPreferredInputDevice: ".concat(String.valueOf(audioDeviceInfo)));
        this.audioInput.setPreferredDevice(audioDeviceInfo);
    }

    @Override // org.webrtc.audio.AudioDeviceModule
    public final /* synthetic */ boolean setPreferredMicrophoneFieldDimension(float f) {
        return AbstractC38034ro0.b(this, f);
    }
