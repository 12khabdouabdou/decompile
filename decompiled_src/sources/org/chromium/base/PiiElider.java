                ...
                if (i2 < length) {
                    ...
                    while (true) {
                        if (i3 < length2) {
                            ...
                            try {
                                Class.forName(substring, false, AbstractC2032Dq9.g.getClassLoader());
                                break;
                            } catch (Throwable unused) {
                                int lastIndexOf = substring.lastIndexOf(".");
                                if (lastIndexOf != -1) {
                                    try {
                                        Class.forName(substring.substring(0, lastIndexOf), false, AbstractC2032Dq9.g.getClassLoader());
