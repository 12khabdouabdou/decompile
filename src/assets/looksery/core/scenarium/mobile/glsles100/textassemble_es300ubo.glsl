...
//texture texture2D inputTexture 0:1:0:9
//texture texture2DArray inputTextureArrSC 0:18:0:9
//ubo float UserUniforms 0:17:96 {
//mat3 inputTextureTransform 0
//vec4 inputTextureUvMinMax 48
//vec4 inputTextureBorderColor 64
//vec4 baseColor 80
//}
//ubo float sc_CameraUBO 0:0:1032 {
//vec4 sc_UniformConstants 16
//mat4 sc_ProjectionMatrixArray 288:[2]:64
...
{
vec4 l9_2=position;
l9_2.z=((log2(max(sc_CameraUBO_obj.sc_Camera.clipPlanes.x,1.0+position.w))*(2.0/log2(sc_CameraUBO_obj.sc_Camera.clipPlanes.y+1.0)))-1.0)*position.w;
l9_1=l9_2;
}
else
{
...
{
vec4 l9_5=l9_3;
l9_5.x=l9_3.x+(sc_CameraUBO_obj.sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_4=l9_5;
}
#else
{
