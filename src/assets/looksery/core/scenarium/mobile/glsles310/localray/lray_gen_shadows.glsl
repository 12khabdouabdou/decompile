...
float l9_6=6.2831855*(float(g9_2[(l2.x%11)+(11*(l2.y%11))])/255.0);
float l9_7=l9_2.y;
float l9_8=l9_2.x;
...
float l9_13=(sqrt(float(g9_3[(l2.x%13)+(13*(l2.y%13))])/255.0)*lightRadius)*0.70710671;
...
vec3 l9_14=((vec3(l9_1.xyz)*originScaleInv)+originOffset)+(l9_13*0.0099999998);
uvec3 l9_15=uvec3((l9_14-originOffset)*originScale);
origin_and_mask=uvec4(l9_15.x,l9_15.y,l9_15.z,origin_and_mask.w);
origin_and_mask.w=l9_1.w;
...
direction=vec2(l9_23,l9_24+l9_25);
max_distance=4294967295u;
}
else
{
...
{
vec3 l9_26=posLightWS-l9_14;
bool l9_27=dot(l9_13,l9_26)<(-lightRadius);
bool l9_28;
if (!l9_27)
{
bool l9_29=lightRange>0.0;
bool l9_30;
if (l9_29)
{
l9_30=length(l9_26)>lightRange;
}
else
{
l9_30=l9_29;
...
max_distance=uint((length(l9_26)+lightRadius)*distanceScale);
vec3 l9_31=gen_ray(posLightWS,l9_0,l9_14);
vec3 l9_32=l9_31/vec3(dot(abs(l9_31),vec3(1.0)));
...
direction=vec2(l9_36,l9_37+l9_38);
}
}
}
