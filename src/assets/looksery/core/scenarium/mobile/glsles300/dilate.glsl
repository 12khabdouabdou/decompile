...
vec2 l9_4=l9_0*5.0;
vec2 l9_5=l9_0*6.0;
sc_writeFragData0Internal(max(max(max(max(max(max(max(max(max(max(max(max(sampleInputTexture(varPackedTex.xy),sampleInputTexture(varPackedTex.xy+l9_0)),sampleInputTexture(varPackedTex.xy-l9_0)),sampleInputTexture(varPackedTex.xy+l9_1)),sampleInputTexture(varPackedTex.xy-l9_1)),sampleInputTexture(varPackedTex.xy+l9_2)),sampleInputTexture(varPackedTex.xy-l9_2)),sampleInputTexture(varPackedTex.xy+l9_3)),sampleInputTexture(varPackedTex.xy-l9_3)),sampleInputTexture(varPackedTex.xy+l9_4)),sampleInputTexture(varPackedTex.xy-l9_4)),sampleInputTexture(varPackedTex.xy+l9_5)),sampleInputTexture(varPackedTex.xy-l9_5)),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
