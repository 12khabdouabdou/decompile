...
#if (yTextureLayout==2)
{
l9_0=sc_SampleTextureBias(yTextureLayout,yTextureGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_yTexture)!=0),yTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_yTexture,SC_SOFTWARE_WRAP_MODE_V_yTexture),(int(SC_USE_UV_MIN_MAX_yTexture)!=0),yTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_yTexture)!=0),yTextureBorderColor,0.0,yTextureArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(yTextureLayout,yTextureGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_yTexture)!=0),yTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_yTexture,SC_SOFTWARE_WRAP_MODE_V_yTexture),(int(SC_USE_UV_MIN_MAX_yTexture)!=0),yTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_yTexture)!=0),yTextureBorderColor,0.0,yTexture);
}
#endif
vec4 l9_1;
#if (uvTextureLayout==2)
{
l9_1=sc_SampleTextureBias(uvTextureLayout,uvTextureGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_uvTexture)!=0),uvTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_uvTexture,SC_SOFTWARE_WRAP_MODE_V_uvTexture),(int(SC_USE_UV_MIN_MAX_uvTexture)!=0),uvTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_uvTexture)!=0),uvTextureBorderColor,0.0,uvTextureArrSC);
}
#else
{
