...
{
l9_0=sc_SampleTextureBias(fgTextureLayout,fgTextureGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_fgTexture)!=0),fgTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_fgTexture,SC_SOFTWARE_WRAP_MODE_V_fgTexture),(int(SC_USE_UV_MIN_MAX_fgTexture)!=0),fgTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_fgTexture)!=0),fgTextureBorderColor,0.0,fgTextureArrSC);
}
#else
{
l9_0=sc_SampleTextureBias(fgTextureLayout,fgTextureGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_fgTexture)!=0),fgTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_fgTexture,SC_SOFTWARE_WRAP_MODE_V_fgTexture),(int(SC_USE_UV_MIN_MAX_fgTexture)!=0),fgTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_fgTexture)!=0),fgTextureBorderColor,0.0,fgTexture);
}
#endif
vec3 fg=l9_0.xyz;
float l9_1;
