...
{
l9_0=texture(inputTextureArrSC,sc_SamplingCoordsViewToGlobal(varPackedTex.xy,inputTextureLayout,inputTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_0=sc_SampleView(varPackedTex.xy,inputTextureLayout,inputTextureGetStereoViewIndex(),0.0,inputTexture);
}
#endif
vec4 l9_1;
#if (MASK_CHANNEL==0)
