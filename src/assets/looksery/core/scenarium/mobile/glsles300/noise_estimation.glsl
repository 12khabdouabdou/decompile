...
#endif
vec4 l9_0=sampleInputTexture(varPackedTex.xy,0.0);
vec4 l9_1=sampleInputTexture(varPackedTex.xy,5.0);
vec2 l9_2=fwidth(varPackedTex.xy);
vec2 l9_3=floor(varPackedTex.xy/(l9_2*2.0))*l9_2;
