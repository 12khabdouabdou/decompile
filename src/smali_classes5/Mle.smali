...
.method public constructor <init>(Ljava/lang/String;Lcom/snap/impala/publicprofile/EntryInfo;ZZLjava/lang/String;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, LMle;->_businessProfileId:Ljava/lang/String;

    .line 5
    .line 6
    iput-object p2, p0, LMle;->_entryInfo:Lcom/snap/impala/publicprofile/EntryInfo;

    .line 7
    .line 8
    iput-boolean p3, p0, LMle;->_previewMode:Z

    .line 9
    .line 10
    iput-boolean p4, p0, LMle;->_forceShowDevCommerceStoreButton:Z

    .line 11
    .line 12
    iput-object p5, p0, LMle;->_placementIdPartialOverride:Ljava/lang/String;
