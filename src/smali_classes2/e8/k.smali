...
.method public static c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p0, v0}, Le8/k;->e(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0, v0}, Le8/k;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Le8/k;->a([Ljava/lang/String;I)F

    move-result v0

    const/4 v1, 0x1

    invoke-static {p0, v1}, Le8/k;->a([Ljava/lang/String;I)F

    move-result v1

    const/4 v2, 0x2

    invoke-static {p0, v2}, Le8/k;->a([Ljava/lang/String;I)F

    move-result v2

    const/4 v3, 0x3

    invoke-static {p0, v3}, Le8/k;->a([Ljava/lang/String;I)F
    ...
    invoke-static {p0}, Lj0/e;->d(Ljava/lang/String;)Landroid/graphics/Path;
...
.method public static f(Landroid/content/Context;II)I
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lh8/b;->c(Landroid/content/Context;II)I
...
.method public static g(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p1}, Le8/k;->d(Ljava/lang/String;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-static {p1}, Le8/k;->c(Ljava/lang/String;)Landroid/animation/TimeInterpolator;
...
.method public static h(Landroid/content/Context;II)Li1/m;
    .locals 2
    ...
    sget-object p1, Lp7/m;->MaterialSpring:[I
    ...
    sget-object p2, Lp7/m;->MaterialSpring:[I
    ...
    :try_start_0
    sget p2, Lp7/m;->MaterialSpring_stiffness:I
    ...
    sget v1, Lp7/m;->MaterialSpring_damping:I
    ...
    invoke-virtual {p1, p2}, Li1/m;->h(F)Li1/m;

    invoke-virtual {p1, v1}, Li1/m;->f(F)Li1/m;
    :try_end_0
