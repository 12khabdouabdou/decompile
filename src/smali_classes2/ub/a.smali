...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lub/a;->a:Lvb/c;
...
.method private static c(Leb/b;)Leb/b;
    ...
    invoke-static {v0, p0}, Lub/a;->d([ILeb/b;)F
    ...
    invoke-direct {v1, v8, v3}, Leb/b;-><init>(II)V
    ...
    invoke-virtual {p0, v10, v7}, Leb/b;->f(II)Z

    move-result v10

    if-eqz v10, :cond_6

    invoke-virtual {v1, v9, v5}, Leb/b;->s(II)V
...
.method public static d([ILeb/b;)F
    .locals 8
    ...
    invoke-virtual {p1, v3, v5}, Leb/b;->f(II)Z
...
.method public a(Lza/b;)Lza/h;
    ...
    invoke-virtual {p0, p1, v0}, Lub/a;->b(Lza/b;Ljava/util/Map;)Lza/h;
...
.method public final b(Lza/b;Ljava/util/Map;)Lza/h;
    .locals 5
    ...
    invoke-static {p1}, Lub/a;->c(Leb/b;)Leb/b;

    move-result-object p1

    iget-object v0, p0, Lub/a;->a:Lvb/c;

    invoke-virtual {v0, p1, p2}, Lvb/c;->c(Leb/b;Ljava/util/Map;)Leb/d;

    move-result-object p1

    sget-object p2, Lub/a;->b:[Lza/i;
    ...
    invoke-direct {v0, p1}, Lwb/c;-><init>(Leb/b;)V

    invoke-virtual {v0, p2}, Lwb/c;->e(Ljava/util/Map;)Leb/f;
    ...
    invoke-virtual {v0, v1, p2}, Lvb/c;->c(Leb/b;Ljava/util/Map;)Leb/d;
    ...
    :goto_0
    invoke-virtual {p1}, Leb/d;->f()Ljava/lang/Object;

    move-result-object v0

    instance-of v0, v0, Lvb/e;
    ...
    invoke-virtual {v0, p2}, Lvb/e;->a([Lza/i;)V
    ...
    sget-object p2, Lcom/google/zxing/ResultMetadataType;->B:Lcom/google/zxing/ResultMetadataType;

    invoke-virtual {p1}, Leb/d;->h()I
