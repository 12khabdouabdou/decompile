...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->p:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->r:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public static final synthetic b(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->l(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method public final h(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Z
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-virtual {p1, p0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->l(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method public final i(Lyg/w;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .locals 8
    ...
    :goto_2
    sget-object v4, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->p:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_0
    sget-object v1, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_4
    instance-of v6, v5, Lyg/w;

    if-eqz v6, :cond_5

    check-cast v5, Lyg/w;

    invoke-virtual {v5, v2}, Lyg/w;->a(Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_5
    instance-of v6, v5, Lyg/x;
    ...
    iget-object v5, v5, Lyg/x;->a:Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    :cond_7
    sget-object v4, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-static {v5, v3}, Ljg/i;->c(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final j(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    .locals 1
...
.method public final l(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    .locals 3
    ...
    :cond_1
    sget-object v2, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->q:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-virtual {p1, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->i(Lyg/w;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final n()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-static {v0}, Lyg/p;->b(Ljava/lang/Object;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final o()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-virtual {p0, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->i(Lyg/w;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-virtual {p0, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->j(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
...
.method public final r()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-virtual {v1}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->s()Lyg/x;

    move-result-object v2

    sget-object v3, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->p:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-virtual {v1, v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->i(Lyg/w;)Lkotlinx/coroutines/internal/LockFreeLinkedListNode;

    return-object v0
.end method

.method public final s()Lyg/x;
    .locals 2

    .line 1
    sget-object v0, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->r:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-direct {v1, p0}, Lyg/x;-><init>(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
...
.method public final t(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode;Lkotlinx/coroutines/internal/LockFreeLinkedListNode$a;)I
    ...
    :cond_0
    invoke-virtual {p3, p0}, Lyg/b;->a(Ljava/lang/Object;)Ljava/lang/Object;
