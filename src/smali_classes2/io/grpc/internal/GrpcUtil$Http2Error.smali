...
.field public static final F:[Lio/grpc/internal/GrpcUtil$Http2Error;

.field public static final synthetic G:[Lio/grpc/internal/GrpcUtil$Http2Error;

.field public static final enum r:Lio/grpc/internal/GrpcUtil$Http2Error;

.field public static final enum s:Lio/grpc/internal/GrpcUtil$Http2Error;

.field public static final enum t:Lio/grpc/internal/GrpcUtil$Http2Error;

.field public static final enum u:Lio/grpc/internal/GrpcUtil$Http2Error;
...
.field public final q:Lio/grpc/Status;
...
.method static constructor <clinit>()V
    ...
    sget-object v4, Lio/grpc/Status;->s:Lio/grpc/Status;
    ...
    sput-object v2, Lio/grpc/internal/GrpcUtil$Http2Error;->s:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v5, Lio/grpc/internal/GrpcUtil$Http2Error;->t:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v7, Lio/grpc/internal/GrpcUtil$Http2Error;->u:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v9, Lio/grpc/internal/GrpcUtil$Http2Error;->v:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v11, Lio/grpc/internal/GrpcUtil$Http2Error;->w:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v13, Lio/grpc/internal/GrpcUtil$Http2Error;->x:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v15, Lio/grpc/internal/GrpcUtil$Http2Error;->y:Lio/grpc/internal/GrpcUtil$Http2Error;

    new-instance v1, Lio/grpc/internal/GrpcUtil$Http2Error;

    sget-object v14, Lio/grpc/Status;->f:Lio/grpc/Status;
    ...
    sput-object v1, Lio/grpc/internal/GrpcUtil$Http2Error;->z:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v12, Lio/grpc/internal/GrpcUtil$Http2Error;->A:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v14, Lio/grpc/internal/GrpcUtil$Http2Error;->B:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v4, Lio/grpc/internal/GrpcUtil$Http2Error;->C:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v8, Lio/grpc/internal/GrpcUtil$Http2Error;->D:Lio/grpc/internal/GrpcUtil$Http2Error;

    new-instance v6, Lio/grpc/internal/GrpcUtil$Http2Error;

    sget-object v10, Lio/grpc/Status;->g:Lio/grpc/Status;
    ...
    sput-object v6, Lio/grpc/internal/GrpcUtil$Http2Error;->E:Lio/grpc/internal/GrpcUtil$Http2Error;
    ...
    sput-object v3, Lio/grpc/internal/GrpcUtil$Http2Error;->G:[Lio/grpc/internal/GrpcUtil$Http2Error;

    invoke-static {}, Lio/grpc/internal/GrpcUtil$Http2Error;->e()[Lio/grpc/internal/GrpcUtil$Http2Error;
...
.method public constructor <init>(Ljava/lang/String;IILio/grpc/Status;)V
    ...
    iput p3, p0, Lio/grpc/internal/GrpcUtil$Http2Error;->p:I
    ...
    iput-object p1, p0, Lio/grpc/internal/GrpcUtil$Http2Error;->q:Lio/grpc/Status;

    return-void
.end method

.method public static e()[Lio/grpc/internal/GrpcUtil$Http2Error;
    .locals 7
    ...
    invoke-virtual {v1}, Lio/grpc/internal/GrpcUtil$Http2Error;->j()J
    ...
    invoke-virtual {v4}, Lio/grpc/internal/GrpcUtil$Http2Error;->j()J
...
.method public static k(J)Lio/grpc/internal/GrpcUtil$Http2Error;
    .locals 4
...
.method public static m(J)Lio/grpc/Status;
    .locals 3

    .line 1
    invoke-static {p0, p1}, Lio/grpc/internal/GrpcUtil$Http2Error;->k(J)Lio/grpc/internal/GrpcUtil$Http2Error;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v0, Lio/grpc/internal/GrpcUtil$Http2Error;->t:Lio/grpc/internal/GrpcUtil$Http2Error;

    invoke-virtual {v0}, Lio/grpc/internal/GrpcUtil$Http2Error;->l()Lio/grpc/Status;
    ...
    invoke-virtual {v0}, Lio/grpc/Status$Code;->k()I
...
.method public j()J
    ...
    .line 1
    iget v0, p0, Lio/grpc/internal/GrpcUtil$Http2Error;->p:I
...
.method public l()Lio/grpc/Status;
    .locals 1

    .line 1
    iget-object v0, p0, Lio/grpc/internal/GrpcUtil$Http2Error;->q:Lio/grpc/Status;
