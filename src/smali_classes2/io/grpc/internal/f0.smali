...
.method public static A(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Lio/grpc/internal/f0;->z(Ljava/util/Map;)Lio/grpc/internal/f0$a;
...
.method public static b(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkf/x;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
...
.method public static c(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0, v0}, Lkf/x;->l(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Long;
...
.method public static f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 1
    invoke-static {p0, p1}, Lkf/x;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {p0}, Lio/grpc/internal/f0;->u(Ljava/util/List;)Ljava/util/Set;
...
.method public static g(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lkf/x;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lkf/x;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method public static h(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {p0, v0}, Lkf/x;->i(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Integer;
...
.method public static m(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lkf/x;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
...
.method public static n(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lkf/x;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method public static p(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/f0;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_0
    sget-object v1, Lio/grpc/Status$Code;->r:Lio/grpc/Status$Code;
    ...
    invoke-static {v1, v2, v0}, Lcom/google/common/base/u;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method public static s(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {v2, v3, v0}, Lcom/google/common/base/u;->a(ZLjava/lang/String;Ljava/lang/Object;)V

    sget-object v2, Lio/grpc/Status$Code;->r:Lio/grpc/Status$Code;
...
.method public static u(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {v4, v5, v1}, Lcom/google/common/base/u;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lio/grpc/Status$Code;->k()I
    ...
    invoke-static {v8, v2, v1}, Lcom/google/common/base/u;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method public static v(Ljava/util/Map;)Lio/grpc/internal/d0$d0;
    .locals 6
    ...
    invoke-static {p0, v1}, Lkf/x;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkf/x;->h(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Double;
    ...
    new-instance v1, Lio/grpc/internal/d0$d0;

    invoke-direct {v1, v0, p0}, Lio/grpc/internal/d0$d0;-><init>(FF)V
...
.method public static x(Ljava/util/Map;)Ljava/lang/Boolean;
    ...
    invoke-static {p0, v0}, Lkf/x;->d(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Boolean;
...
.method public static y(Ljava/util/List;Lio/grpc/m0;)Lio/grpc/NameResolver$b;
    .locals 4
    ...
    check-cast v1, Lio/grpc/internal/f0$a;

    invoke-virtual {v1}, Lio/grpc/internal/f0$a;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1, v2}, Lio/grpc/m0;->d(Ljava/lang/String;)Lio/grpc/l0;
    ...
    const-class p0, Lio/grpc/internal/f0;
    ...
    :cond_1
    invoke-virtual {v1}, Lio/grpc/internal/f0$a;->b()Ljava/util/Map;

    move-result-object p0

    invoke-virtual {v3, p0}, Lio/grpc/l0;->e(Ljava/util/Map;)Lio/grpc/NameResolver$b;

    move-result-object p0

    invoke-virtual {p0}, Lio/grpc/NameResolver$b;->d()Lio/grpc/Status;
    ...
    invoke-virtual {p0}, Lio/grpc/NameResolver$b;->c()Ljava/lang/Object;

    move-result-object p0

    invoke-direct {p1, v3, p0}, Lio/grpc/internal/f0$b;-><init>(Lio/grpc/l0;Ljava/lang/Object;)V
...
.method public static z(Ljava/util/Map;)Lio/grpc/internal/f0$a;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lio/grpc/internal/f0$a;-><init>(Ljava/lang/String;Ljava/util/Map;)V
