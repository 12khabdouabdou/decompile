...
# instance fields
.field public final synthetic p:Lio/grpc/internal/KeepAliveManager;
...
.method public constructor <init>(Lio/grpc/internal/KeepAliveManager;)V
    ...
    iput-object p1, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;
...
.method public run()V
    ...
    iget-object v0, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;
    ...
    sget-object v2, Lio/grpc/internal/KeepAliveManager$State;->q:Lio/grpc/internal/KeepAliveManager$State;
    ...
    iget-object v3, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v3}, Lio/grpc/internal/KeepAliveManager;->f(Lio/grpc/internal/KeepAliveManager;)Ljava/lang/Runnable;

    move-result-object v3

    iget-object v4, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;
    ...
    sget-object v3, Lio/grpc/internal/KeepAliveManager$State;->r:Lio/grpc/internal/KeepAliveManager$State;
    ...
    iget-object v5, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v5}, Lio/grpc/internal/KeepAliveManager;->j(Lio/grpc/internal/KeepAliveManager;)J

    move-result-wide v5

    iget-object v7, p0, Lio/grpc/internal/KeepAliveManager$b;->p:Lio/grpc/internal/KeepAliveManager;

    invoke-static {v7}, Lio/grpc/internal/KeepAliveManager;->k(Lio/grpc/internal/KeepAliveManager;)Lcom/google/common/base/o;

    move-result-object v7

    sget-object v8, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v7, v8}, Lcom/google/common/base/o;->d(Ljava/util/concurrent/TimeUnit;)J
