...
.method public static b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p0, v1}, Lio/grpc/x0;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static e(Ljava/lang/Class;Ljava/lang/Iterable;Ljava/lang/ClassLoader;Lio/grpc/x0$b;)Ljava/util/List;
    .locals 1

    .line 1
    invoke-static {p2}, Lio/grpc/x0;->d(Ljava/lang/ClassLoader;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, Lio/grpc/x0;->b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    :cond_0
    invoke-static {p0, p2}, Lio/grpc/x0;->c(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/lang/Iterable;
    ...
    invoke-interface {p3, p2}, Lio/grpc/x0$b;->a(Ljava/lang/Object;)Z
    ...
    :cond_2
    new-instance p0, Lio/grpc/x0$a;

    invoke-direct {p0, p3}, Lio/grpc/x0$a;-><init>(Lio/grpc/x0$b;)V
