...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;LBAi;Ljava/lang/Iterable;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    .line 5
    invoke-direct {v5, p3}, Lio/requery/android/database/sqlite/RequerySQLiteOpenHelperFactory$CallbackDatabaseErrorHandler;-><init>(LBAi;)V
    ...
    .line 14
    .line 15
    iput-object p3, v0, Lio/requery/android/database/sqlite/RequerySQLiteOpenHelperFactory$CallbackSQLiteOpenHelper;->callback:LBAi;
...
.method public createConfiguration(Ljava/lang/String;I)Lio/requery/android/database/sqlite/SQLiteDatabaseConfiguration;
    ...
    .line 18
    :cond_0
    invoke-static {p2}, LBv7;->i(Ljava/util/Iterator;)Ljava/lang/ClassCastException;
...
.method public onConfigure(Lio/requery/android/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    iget-object v0, p0, Lio/requery/android/database/sqlite/RequerySQLiteOpenHelperFactory$CallbackSQLiteOpenHelper;->callback:LBAi;

    .line 2
    .line 3
    invoke-virtual {v0, p1}, LBAi;->b(LAAi;)V
