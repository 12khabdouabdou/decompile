...
# instance fields
.field public A:Landroid/view/inputmethod/BaseInputConnection;
...
.method public constructor <init>(Lio/flutter/embedding/engine/systemchannels/TextInputChannel$d;Landroid/view/View;)V
    .locals 2
    .param p1    # Lio/flutter/embedding/engine/systemchannels/TextInputChannel$d;
    ...
    iput v0, p0, Lio/flutter/plugin/editing/i;->p:I

    iput v0, p0, Lio/flutter/plugin/editing/i;->q:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/i;->r:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/i;->s:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/i;->t:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/i;->A:Landroid/view/inputmethod/BaseInputConnection;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/editing/i;->n(Lio/flutter/embedding/engine/systemchannels/TextInputChannel$d;)V
...
.method public a(Lio/flutter/plugin/editing/i$b;)V
    ...
    .line 1
    iget v0, p0, Lio/flutter/plugin/editing/i;->q:I
    ...
    :cond_0
    iget v0, p0, Lio/flutter/plugin/editing/i;->p:I
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/i;->s:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p0, Lio/flutter/plugin/editing/i;->r:Ljava/util/ArrayList;
...
.method public b()V
    ...
    invoke-static {v0, v2}, Lre/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/i;->v:Ljava/lang/String;

    invoke-virtual {p0}, Lio/flutter/plugin/editing/i;->i()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/i;->w:I

    invoke-virtual {p0}, Lio/flutter/plugin/editing/i;->h()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/i;->x:I

    invoke-virtual {p0}, Lio/flutter/plugin/editing/i;->g()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/i;->y:I

    invoke-virtual {p0}, Lio/flutter/plugin/editing/i;->f()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/i;->z:I
...
.method public c()V
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugin/editing/i;->t:Ljava/util/ArrayList;
...
.method public d()V
    ...
    iget-object v3, p0, Lio/flutter/plugin/editing/i;->r:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/i;->v:Ljava/lang/String;
    ...
    iget v1, p0, Lio/flutter/plugin/editing/i;->w:I
    ...
    iget v1, p0, Lio/flutter/plugin/editing/i;->x:I
    ...
    :goto_2
    iget v3, p0, Lio/flutter/plugin/editing/i;->y:I
    ...
    iget v3, p0, Lio/flutter/plugin/editing/i;->z:I
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/i;->s:Ljava/util/ArrayList;
...
.method public e()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/i;->t:Ljava/util/ArrayList;
...
.method public final j(Lio/flutter/plugin/editing/i$b;ZZZ)V
    ...
    invoke-interface {p1, p2, p3, p4}, Lio/flutter/plugin/editing/i$b;->a(ZZZ)V

    iget p1, p0, Lio/flutter/plugin/editing/i;->q:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, Lio/flutter/plugin/editing/i;->q:I
...
.method public m(II)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/editing/i;->A:Landroid/view/inputmethod/BaseInputConnection;
...
.method public n(Lio/flutter/embedding/engine/systemchannels/TextInputChannel$d;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$d;->c()Z
...
.method public replace(IILjava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/i;->q:I
    ...
    invoke-static {v1, v2}, Lre/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    invoke-virtual/range {p0 .. p0}, Lio/flutter/plugin/editing/i;->toString()Ljava/lang/String;
    ...
    iput-object v1, v0, Lio/flutter/plugin/editing/i;->u:Ljava/lang/String;

    :cond_4
    invoke-virtual/range {p0 .. p0}, Lio/flutter/plugin/editing/i;->i()I

    move-result v13

    invoke-virtual/range {p0 .. p0}, Lio/flutter/plugin/editing/i;->h()I

    move-result v14

    invoke-virtual/range {p0 .. p0}, Lio/flutter/plugin/editing/i;->g()I

    move-result v15

    invoke-virtual/range {p0 .. p0}, Lio/flutter/plugin/editing/i;->f()I
    ...
    iget-object v8, v0, Lio/flutter/plugin/editing/i;->t:Ljava/util/ArrayList;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/i;->p:I
    ...
    :goto_6
    invoke-virtual {v0, v12, v1, v10}, Lio/flutter/plugin/editing/i;->k(ZZZ)V
...
.method public setSpan(Ljava/lang/Object;III)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/i;->t:Ljava/util/ArrayList;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/i;->u:Ljava/lang/String;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/i;->u:Ljava/lang/String;
