...
# instance fields
.field public final a:[Lio/flutter/embedding/android/c0$d;

.field public final b:Ljava/util/HashSet;

.field public final c:Lio/flutter/embedding/android/c0$e;
...
.method public constructor <init>(Lio/flutter/embedding/android/c0$e;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/c0$e;->getBinaryMessenger()Lbf/c;

    move-result-object v2

    invoke-direct {v1, v2}, Lio/flutter/embedding/android/b0;-><init>(Lbf/c;)V
    ...
    invoke-direct {v2, v3}, Laf/i;-><init>(Lbf/c;)V

    invoke-direct {v1, v2}, Lio/flutter/embedding/android/x;-><init>(Laf/i;)V
    ...
    invoke-direct {v0, p1}, Laf/j;-><init>(Lbf/c;)V

    invoke-virtual {v0, p0}, Laf/j;->setKeyboardMethodHandler(Laf/j$b;)V

    return-void
.end method

.method public static synthetic c(Lio/flutter/embedding/android/c0;Landroid/view/KeyEvent;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lio/flutter/embedding/android/c0;->e(Landroid/view/KeyEvent;)V
...
.method public final e(Landroid/view/KeyEvent;)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/embedding/android/c0$e;->b(Landroid/view/KeyEvent;)V
    ...
    invoke-static {p1, v0}, Lre/b;->f(Ljava/lang/String;Ljava/lang/String;)V
