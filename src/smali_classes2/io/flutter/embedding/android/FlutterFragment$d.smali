...
.field public i:Lio/flutter/embedding/android/RenderMode;

.field public j:Lio/flutter/embedding/android/TransparencyMode;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterFragment$d;->h:Lse/e;

    sget-object v0, Lio/flutter/embedding/android/RenderMode;->p:Lio/flutter/embedding/android/RenderMode;

    iput-object v0, p0, Lio/flutter/embedding/android/FlutterFragment$d;->i:Lio/flutter/embedding/android/RenderMode;

    sget-object v0, Lio/flutter/embedding/android/TransparencyMode;->q:Lio/flutter/embedding/android/TransparencyMode;

    iput-object v0, p0, Lio/flutter/embedding/android/FlutterFragment$d;->j:Lio/flutter/embedding/android/TransparencyMode;
...
.method public b()Lio/flutter/embedding/android/FlutterFragment;
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/FlutterFragment$d;->a:Ljava/lang/Class;
...
.method public c()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->e:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "handle_deeplinking"

    iget-boolean v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->f:Z

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "app_bundle_path"

    iget-object v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->g:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "dart_entrypoint"

    iget-object v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->b:Ljava/lang/String;

    invoke-virtual {v0, v1, v2}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "dart_entrypoint_uri"

    iget-object v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->c:Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->h:Lse/e;

    if-eqz v1, :cond_1

    const-string v2, "initialization_args"

    invoke-virtual {v1}, Lse/e;->b()[Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->i:Lio/flutter/embedding/android/RenderMode;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->j:Lio/flutter/embedding/android/TransparencyMode;
    ...
    iget-boolean v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->k:Z
    ...
    iget-boolean v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->l:Z

    invoke-virtual {v0, v1, v2}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "should_delay_first_android_view_draw"

    iget-boolean v2, p0, Lio/flutter/embedding/android/FlutterFragment$d;->m:Z
...
.method public g(Lse/e;)Lio/flutter/embedding/android/FlutterFragment$d;
    .locals 0

    .line 1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->h:Lse/e;
...
.method public j(Lio/flutter/embedding/android/RenderMode;)Lio/flutter/embedding/android/FlutterFragment$d;
    .locals 0

    .line 1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->i:Lio/flutter/embedding/android/RenderMode;
...
.method public l(Z)Lio/flutter/embedding/android/FlutterFragment$d;
    ...
    .line 1
    iput-boolean p1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->l:Z

    return-object p0
.end method

.method public m(Z)Lio/flutter/embedding/android/FlutterFragment$d;
    .locals 0
...
.method public n(Lio/flutter/embedding/android/TransparencyMode;)Lio/flutter/embedding/android/FlutterFragment$d;
    .locals 0

    .line 1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterFragment$d;->j:Lio/flutter/embedding/android/TransparencyMode;
