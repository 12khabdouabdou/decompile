...
.field public q:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v1, Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;->p:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;
...
.method public constructor <init>(Landroid/content/Context;IILio/flutter/embedding/android/FlutterImageView$SurfaceKind;)V
    ...
    .line 2
    invoke-static {p2, p3}, Lio/flutter/embedding/android/FlutterImageView;->g(II)Landroid/media/ImageReader;
...
.method public constructor <init>(Landroid/content/Context;Landroid/media/ImageReader;Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;)V
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/FlutterImageView;->r:Z

    iput-object p2, p0, Lio/flutter/embedding/android/FlutterImageView;->p:Landroid/media/ImageReader;

    iput-object p3, p0, Lio/flutter/embedding/android/FlutterImageView;->q:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;

    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterImageView;->h()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;->p:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;
...
.method public static g(II)Landroid/media/ImageReader;
    ...
    invoke-static {p0, v2}, Lio/flutter/embedding/android/FlutterImageView;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p0}, Lio/flutter/embedding/android/FlutterImageView;->i(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static varargs i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p0}, Lre/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public b(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterImageView;->q:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterImageView;->p:Landroid/media/ImageReader;
    ...
    iput-boolean v1, p0, Lio/flutter/embedding/android/FlutterImageView;->r:Z
...
.method public c()V
    ...
    .line 1
    iget-boolean v0, p0, Lio/flutter/embedding/android/FlutterImageView;->r:Z
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterImageView;->d()Z
    ...
    iput-boolean v0, p0, Lio/flutter/embedding/android/FlutterImageView;->r:Z
...
.method public j(II)V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterImageView;->f()V

    invoke-static {p1, p2}, Lio/flutter/embedding/android/FlutterImageView;->g(II)Landroid/media/ImageReader;

    move-result-object p1

    iput-object p1, p0, Lio/flutter/embedding/android/FlutterImageView;->p:Landroid/media/ImageReader;
...
.method public final k()V
    ...
    invoke-static {v1}, Lh5/d;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterImageView;->k()V
...
.method public onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lio/flutter/embedding/android/FlutterImageView;->p:Landroid/media/ImageReader;
    ...
    :cond_0
    iget-object p3, p0, Lio/flutter/embedding/android/FlutterImageView;->q:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;

    sget-object p4, Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;->p:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;

    if-ne p3, p4, :cond_1

    iget-boolean p3, p0, Lio/flutter/embedding/android/FlutterImageView;->r:Z

    if-eqz p3, :cond_1

    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/android/FlutterImageView;->j(II)V
    ...
    iget-object p2, p0, Lio/flutter/embedding/android/FlutterImageView;->p:Landroid/media/ImageReader;
