...
.field public final autofill:Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b$a;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public final fields:[Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(ZZZZZLio/flutter/embedding/engine/systemchannels/TextInputChannel$TextCapitalization;Lio/flutter/embedding/engine/systemchannels/TextInputChannel$c;Ljava/lang/Integer;Ljava/lang/String;Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b$a;[Ljava/lang/String;[Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;)V
    ...
    .param p6    # Lio/flutter/embedding/engine/systemchannels/TextInputChannel$TextCapitalization;
        ...
        .end annotation
    .end param
    .param p7    # Lio/flutter/embedding/engine/systemchannels/TextInputChannel$c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    .param p9    # Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p10    # Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b$a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .param p11    # [Ljava/lang/String;
        ...
        .end annotation
    .end param
    .param p12    # [Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    iput-object p8, p0, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->inputAction:Ljava/lang/Integer;

    iput-object p9, p0, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->actionLabel:Ljava/lang/String;

    iput-object p10, p0, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->autofill:Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b$a;

    iput-object p11, p0, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->contentCommitMimeTypes:[Ljava/lang/String;

    iput-object p12, p0, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->fields:[Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
...
.method public static a(Lorg/json/JSONObject;)Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
    ...
    invoke-static {v8}, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;->a(Lorg/json/JSONObject;)Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
    ...
    :cond_3
    new-instance v2, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$b;
    ...
    invoke-static {v3}, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$TextCapitalization;->j(Ljava/lang/String;)Lio/flutter/embedding/engine/systemchannels/TextInputChannel$TextCapitalization;
    ...
    invoke-static {v3}, Lio/flutter/embedding/engine/systemchannels/TextInputChannel$c;->a(Lorg/json/JSONObject;)Lio/flutter/embedding/engine/systemchannels/TextInputChannel$c;
