...
.field public p:Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;
...
.field public final v:Lio/flutter/embedding/android/AndroidTouchProcessor;
...
.method public constructor <init>(Landroid/content/Context;FLio/flutter/embedding/android/AndroidTouchProcessor;)V
    ...
    iput p2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->q:F

    iput-object p3, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->v:Lio/flutter/embedding/android/AndroidTouchProcessor;
...
.method private getPlatformViewMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->p:Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;
    ...
    iget v1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->q:F
    ...
    iget v2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->s:I
...
.method public a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
    ...
    .line 1
    iput-object p1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->p:Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;

    iput p2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->r:I

    iput p3, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->s:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->p:Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;
    ...
    iget v3, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->s:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->v:Lio/flutter/embedding/android/AndroidTouchProcessor;
    ...
    :cond_1
    iget v1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->t:I

    int-to-float v1, v1

    iget v2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->u:I
    ...
    iput v1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->u:I
    ...
    iput v2, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->u:I
    ...
    :goto_1
    iget-object v1, p0, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->v:Lio/flutter/embedding/android/AndroidTouchProcessor;
...
.method public setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->b()V
