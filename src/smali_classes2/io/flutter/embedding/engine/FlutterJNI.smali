...
.field private platformMessageHandler:Lte/f;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Li5/j;->a(Ljava/nio/ByteBuffer;)Landroid/graphics/ImageDecoder$Source;
    ...
    invoke-direct {v0, p1, p2}, Lse/d;-><init>(J)V

    invoke-static {p0, v0}, Li5/e;->a(Landroid/graphics/ImageDecoder$Source;Landroid/graphics/ImageDecoder$OnHeaderDecodedListener;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lre/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lte/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lte/f;->handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lh5/d;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object p4

    invoke-static {p2, p4}, Lh5/e;->a(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V

    const/4 p4, 0x1

    invoke-static {p2, p4}, Lh5/a;->a(Landroid/graphics/ImageDecoder;I)V

    invoke-static {p3}, Lh5/h;->a(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
...
.method public addIsDisplayingFlutterUiListener(Lio/flutter/embedding/engine/renderer/m;)V
    .locals 1
    .param p1    # Lio/flutter/embedding/engine/renderer/m;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lcf/d;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lcf/d;

    invoke-virtual {p1, v0}, Lcf/d;->resolveNativeLocale(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/x;->H()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public destroyOverlaySurfaces()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/x;->K()V
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lre/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/AccessibilityBridge$Action;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lbf/n;->encodeMessage(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/AccessibilityBridge$Action;->p:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lio/flutter/embedding/engine/systemchannels/SettingsChannel;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lte/f;->handleMessageFromDart(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public loadLibrary(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Ly5/b;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/x;->e0()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/x;->g0(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/x;->h0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public setDeferredComponentManager(Lue/a;)V
    ...
    invoke-interface {p1, p0}, Lue/a;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lcf/d;)V
    .locals 0
    .param p1    # Lcf/d;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lcf/d;

    return-void
.end method

.method public setPlatformMessageHandler(Lte/f;)V
    .locals 0
    .param p1    # Lte/f;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lte/f;
...
.method public setPlatformViewsController(Lio/flutter/plugin/platform/x;)V
    .locals 0
    .param p1    # Lio/flutter/plugin/platform/x;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lif/d;->checkState(ZLjava/lang/Object;)V
