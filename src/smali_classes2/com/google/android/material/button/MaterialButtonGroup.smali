...
.field private groupStateListShapeAppearance:Lcom/google/android/material/shape/x;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field innerCornerSize:Lcom/google/android/material/shape/w;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field public final r:Lcom/google/android/material/button/MaterialButtonGroup$b;
...
.method static constructor <clinit>()V
    ...
    sget v0, Lp7/l;->Widget_Material3_MaterialButtonGroup:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Lp7/c;->materialButtonGroupStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->p:Ljava/util/List;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->q:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->r:Lcom/google/android/material/button/MaterialButtonGroup$b;
    ...
    iput-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->s:Ljava/util/Comparator;
    ...
    sget-object v2, Lp7/m;->MaterialButtonGroup:[I
    ...
    sget p3, Lp7/m;->MaterialButtonGroup_buttonSizeChange:I
    ...
    invoke-static {v6, p2, p3}, Lcom/google/android/material/shape/StateListSizeChange;->create(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lcom/google/android/material/shape/StateListSizeChange;
    ...
    :cond_0
    sget p3, Lp7/m;->MaterialButtonGroup_shapeAppearance:I
    ...
    invoke-static {v6, p2, p3}, Lcom/google/android/material/shape/x;->create(Landroid/content/Context;Landroid/content/res/TypedArray;I)Lcom/google/android/material/shape/x;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/x;
    ...
    sget v1, Lp7/m;->MaterialButtonGroup_shapeAppearanceOverlay:I

    invoke-virtual {p2, v1, v7}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    invoke-static {v6, p3, v1}, Lcom/google/android/material/shape/n;->b(Landroid/content/Context;II)Lcom/google/android/material/shape/n$b;
    ...
    invoke-direct {v0, p3}, Lcom/google/android/material/shape/x$b;-><init>(Lcom/google/android/material/shape/n;)V

    invoke-virtual {v0}, Lcom/google/android/material/shape/x$b;->build()Lcom/google/android/material/shape/x;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/x;

    :cond_1
    sget p3, Lp7/m;->MaterialButtonGroup_innerCornerSize:I
    ...
    invoke-static {v6, p2, p3, v0}, Lcom/google/android/material/shape/w;->b(Landroid/content/Context;Landroid/content/res/TypedArray;ILcom/google/android/material/shape/d;)Lcom/google/android/material/shape/w;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/material/button/MaterialButtonGroup;->innerCornerSize:Lcom/google/android/material/shape/w;

    :cond_2
    sget p3, Lp7/m;->MaterialButtonGroup_android_spacing:I

    invoke-virtual {p2, p3, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p3

    iput p3, p0, Lcom/google/android/material/button/MaterialButtonGroup;->u:I

    invoke-virtual {p0, p1}, Landroid/view/ViewGroup;->setChildrenDrawingOrderEnabled(Z)V

    sget p3, Lp7/m;->MaterialButtonGroup_android_enabled:I
...
.method public static synthetic a(Lcom/google/android/material/button/MaterialButtonGroup;Lcom/google/android/material/button/MaterialButton;Lcom/google/android/material/button/MaterialButton;)I
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/button/MaterialButtonGroup;->i(Lcom/google/android/material/button/MaterialButton;Lcom/google/android/material/button/MaterialButton;)I
...
.method private getFirstVisibleChildIndex()I
    ...
    invoke-direct {p0, v1}, Lcom/google/android/material/button/MaterialButtonGroup;->h(I)Z
...
.method private getLastVisibleChildIndex()I
    ...
    invoke-direct {p0, v0}, Lcom/google/android/material/button/MaterialButtonGroup;->h(I)Z
...
.method private getNextVisibleChildButton(I)Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/material/button/MaterialButtonGroup;->h(I)Z
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object p2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->r:Lcom/google/android/material/button/MaterialButtonGroup$b;
    ...
    iget-object p2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->p:Ljava/util/List;

    invoke-virtual {p1}, Lcom/google/android/material/button/MaterialButton;->getShapeAppearanceModel()Lcom/google/android/material/shape/n;

    move-result-object p3

    invoke-interface {p2, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p2, p0, Lcom/google/android/material/button/MaterialButtonGroup;->q:Ljava/util/List;

    invoke-virtual {p1}, Lcom/google/android/material/button/MaterialButton;->getStateListShapeAppearanceModel()Lcom/google/android/material/shape/x;
...
.method public final b()V
    ...
    iget v4, p0, Lcom/google/android/material/button/MaterialButtonGroup;->u:I
    ...
    iget v6, p0, Lcom/google/android/material/button/MaterialButtonGroup;->u:I
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lcom/google/android/material/button/MaterialButtonGroup;->l(I)V
...
.method public final c()V
    ...
    invoke-direct {p0, v3}, Lcom/google/android/material/button/MaterialButtonGroup;->h(I)Z
...
.method public dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/button/MaterialButtonGroup;->m()V
...
.method public final e(I)I
    ...
    invoke-virtual {v2, v0}, Lcom/google/android/material/shape/StateListSizeChange;->b(I)I
...
.method public final g(ZZI)Lcom/google/android/material/shape/x$b;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/x;
    ...
    :cond_0
    iget-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->q:Ljava/util/List;
    ...
    check-cast p2, Lcom/google/android/material/shape/n;

    invoke-direct {p1, p2}, Lcom/google/android/material/shape/x$b;-><init>(Lcom/google/android/material/shape/n;)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0}, Lcom/google/android/material/shape/x;->g()Lcom/google/android/material/shape/x$b;
...
.method public getChildDrawingOrder(II)I
    ...
    iget-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->t:[Ljava/lang/Integer;
...
.method public getInnerCornerSize()Lcom/google/android/material/shape/d;
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->innerCornerSize:Lcom/google/android/material/shape/w;
...
.method public getInnerCornerSizeStateList()Lcom/google/android/material/shape/w;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public getShapeAppearance()Lcom/google/android/material/shape/n;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/material/shape/x;->b(Z)Lcom/google/android/material/shape/n;
...
.method public getSpacing()I
    ...
    iget v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->u:I

    return v0
.end method

.method public getStateListShapeAppearance()Lcom/google/android/material/shape/x;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public final synthetic i(Lcom/google/android/material/button/MaterialButton;Lcom/google/android/material/button/MaterialButton;)I
    .locals 2
...
.method public j(Lcom/google/android/material/button/MaterialButton;I)V
    .locals 2
...
.method public final m()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->s:Ljava/util/Comparator;
    ...
    iput-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->t:[Ljava/lang/Integer;
...
.method public n()V
    ...
    :goto_2
    invoke-virtual {p0, v7, v8, v4}, Lcom/google/android/material/button/MaterialButtonGroup;->g(ZZI)Lcom/google/android/material/shape/x$b;
    ...
    invoke-static {v7}, Lcom/google/android/material/shape/x;->f(I)I
    ...
    iget-object v8, p0, Lcom/google/android/material/button/MaterialButtonGroup;->innerCornerSize:Lcom/google/android/material/shape/w;

    invoke-virtual {v9, v8, v7}, Lcom/google/android/material/shape/x$b;->m(Lcom/google/android/material/shape/w;I)Lcom/google/android/material/shape/x$b;

    move-result-object v7

    invoke-virtual {v7}, Lcom/google/android/material/shape/x$b;->build()Lcom/google/android/material/shape/x;

    move-result-object v7

    invoke-virtual {v7}, Lcom/google/android/material/shape/x;->e()Z

    move-result v8

    if-eqz v8, :cond_c

    invoke-virtual {v5, v7}, Lcom/google/android/material/button/MaterialButton;->setStateListShapeAppearanceModel(Lcom/google/android/material/shape/x;)V

    goto :goto_7

    :cond_c
    invoke-virtual {v7, v6}, Lcom/google/android/material/shape/x;->b(Z)Lcom/google/android/material/shape/n;

    move-result-object v6

    invoke-virtual {v5, v6}, Lcom/google/android/material/button/MaterialButton;->setShapeAppearanceModel(Lcom/google/android/material/shape/n;)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->p:Ljava/util/List;

    invoke-interface {v0, p1}, Ljava/util/List;->remove(I)Ljava/lang/Object;

    iget-object v0, p0, Lcom/google/android/material/button/MaterialButtonGroup;->q:Ljava/util/List;
...
.method public setInnerCornerSizeStateList(Lcom/google/android/material/shape/w;)V
    .locals 0
    .param p1    # Lcom/google/android/material/shape/w;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/RestrictTo;
...
.method public setShapeAppearance(Lcom/google/android/material/shape/n;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lcom/google/android/material/shape/x$b;-><init>(Lcom/google/android/material/shape/n;)V

    invoke-virtual {v0}, Lcom/google/android/material/shape/x$b;->build()Lcom/google/android/material/shape/x;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->groupStateListShapeAppearance:Lcom/google/android/material/shape/x;
...
.method public setSpacing(I)V
    ...
    iput p1, p0, Lcom/google/android/material/button/MaterialButtonGroup;->u:I
...
.method public setStateListShapeAppearance(Lcom/google/android/material/shape/x;)V
    .locals 0
