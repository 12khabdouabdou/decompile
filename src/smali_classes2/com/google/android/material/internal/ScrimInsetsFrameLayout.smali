...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->r:Z

    iput-boolean v0, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->s:Z

    iput-boolean v0, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->t:Z

    iput-boolean v0, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->u:Z

    sget-object v3, Lp7/m;->ScrimInsetsFrameLayout:[I

    sget v5, Lp7/l;->Widget_Design_ScrimInsetsFrameLayout:I
    ...
    sget p2, Lp7/m;->ScrimInsetsFrameLayout_insetForeground:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->p:Landroid/graphics/Rect;
    ...
    iget-boolean v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->r:Z

    const/4 v4, 0x0

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;

    iget-object v5, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->p:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-boolean v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->s:Z
    ...
    :cond_1
    iget-boolean v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->t:Z
    ...
    iget-object v4, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-boolean v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->u:Z

    if-eqz v3, :cond_3

    iget-object v3, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;

    iget-object v4, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->p:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->q:Landroid/graphics/Rect;
...
.method public setDrawBottomInsetForeground(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->s:Z
...
.method public setDrawLeftInsetForeground(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->t:Z
...
.method public setDrawRightInsetForeground(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->u:Z
...
.method public setDrawTopInsetForeground(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/android/material/internal/ScrimInsetsFrameLayout;->r:Z
