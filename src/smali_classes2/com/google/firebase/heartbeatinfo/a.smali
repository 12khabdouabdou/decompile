...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lia/b;Ljava/util/concurrent/Executor;)V
    .locals 6

    .line 1
    new-instance v1, Lga/e;

    invoke-direct {v1, p1, p2}, Lga/e;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/firebase/heartbeatinfo/a;-><init>(Lia/b;Ljava/util/Set;Ljava/util/concurrent/Executor;Lia/b;Landroid/content/Context;)V

    return-void
.end method

.method public constructor <init>(Lia/b;Ljava/util/Set;Ljava/util/concurrent/Executor;Lia/b;Landroid/content/Context;)V
    .locals 0

    .line 2
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/firebase/heartbeatinfo/a;->a:Lia/b;
    ...
    iput-object p4, p0, Lcom/google/firebase/heartbeatinfo/a;->c:Lia/b;
...
.method public static synthetic e(Landroid/content/Context;Ljava/lang/String;)Lga/o;
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/google/firebase/heartbeatinfo/a;->j(Landroid/content/Context;Ljava/lang/String;)Lga/o;
...
.method public static g()Lcom/google/firebase/components/c;
    ...
    invoke-static {v2}, Lcom/google/firebase/components/r;->n(Ljava/lang/Class;)Lcom/google/firebase/components/r;
    ...
    invoke-direct {v2, v0}, Lga/b;-><init>(Lcom/google/firebase/components/Qualified;)V
...
.method public static synthetic h(Lcom/google/firebase/components/Qualified;Lcom/google/firebase/components/e;)Lcom/google/firebase/heartbeatinfo/a;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/firebase/heartbeatinfo/a;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lia/b;Ljava/util/concurrent/Executor;)V

    return-object v6
.end method

.method public static synthetic j(Landroid/content/Context;Ljava/lang/String;)Lga/o;
    .locals 1

    .line 1
    new-instance v0, Lga/o;

    invoke-direct {v0, p0, p1}, Lga/o;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method public a()Lo7/j;
    ...
    invoke-direct {v1, p0}, Lga/c;-><init>(Lcom/google/firebase/heartbeatinfo/a;)V
...
.method public declared-synchronized b(Ljava/lang/String;)Lcom/google/firebase/heartbeatinfo/HeartBeatInfo$HeartBeat;
    ...
    iget-object p1, p0, Lcom/google/firebase/heartbeatinfo/a;->a:Lia/b;
    ...
    invoke-virtual {p1, v0, v1}, Lga/o;->i(J)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lga/o;->g()V
...
.method public final synthetic i()Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/heartbeatinfo/a;->a:Lia/b;
    ...
    invoke-virtual {v0}, Lga/o;->c()Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0}, Lga/o;->b()V
    ...
    invoke-virtual {v3}, Lga/p;->c()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lga/p;->b()Ljava/util/List;
...
.method public final synthetic k()Ljava/lang/Void;
    ...
    iget-object v3, p0, Lcom/google/firebase/heartbeatinfo/a;->c:Lia/b;

    invoke-interface {v3}, Lia/b;->get()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lra/i;

    invoke-interface {v3}, Lra/i;->a()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v1, v2, v3}, Lga/o;->k(JLjava/lang/String;)V
...
.method public l()Lo7/j;
    ...
    invoke-static {v1}, Lo7/m;->e(Ljava/lang/Object;)Lo7/j;
    ...
    invoke-direct {v1, p0}, Lga/d;-><init>(Lcom/google/firebase/heartbeatinfo/a;)V
