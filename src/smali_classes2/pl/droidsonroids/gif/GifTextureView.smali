...
.field public r:Lpl/droidsonroids/gif/d;

.field public s:Lpl/droidsonroids/gif/GifTextureView$c;

.field public t:F

.field public u:Lpl/droidsonroids/gif/c$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpl/droidsonroids/gif/GifTextureView;->v:[Landroid/widget/ImageView$ScaleType;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->p:Landroid/widget/ImageView$ScaleType;

    new-instance p1, Landroid/graphics/Matrix;

    invoke-direct {p1}, Landroid/graphics/Matrix;-><init>()V

    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->q:Landroid/graphics/Matrix;

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, Lpl/droidsonroids/gif/GifTextureView;->t:F

    const/4 p1, 0x0

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0, v0}, Lpl/droidsonroids/gif/GifTextureView;->h(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p2, p1, p1}, Lpl/droidsonroids/gif/GifTextureView;->h(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p2, p3, p1}, Lpl/droidsonroids/gif/GifTextureView;->h(Landroid/util/AttributeSet;II)V
...
.method public static synthetic a(Lpl/droidsonroids/gif/GifTextureView;)Lpl/droidsonroids/gif/d;
    ...
    .line 1
    iget-object p0, p0, Lpl/droidsonroids/gif/GifTextureView;->r:Lpl/droidsonroids/gif/d;
...
.method public static synthetic b(Lpl/droidsonroids/gif/GifTextureView;)Lpl/droidsonroids/gif/c$b;
    ...
    .line 1
    iget-object p0, p0, Lpl/droidsonroids/gif/GifTextureView;->u:Lpl/droidsonroids/gif/c$b;
...
.method public static synthetic d(Lpl/droidsonroids/gif/GifTextureView;Lpl/droidsonroids/gif/GifInfoHandle;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lpl/droidsonroids/gif/GifTextureView;->i(Lpl/droidsonroids/gif/GifInfoHandle;)V
...
.method public static synthetic e(Lpl/droidsonroids/gif/GifTextureView;)F
    ...
    .line 1
    iget p0, p0, Lpl/droidsonroids/gif/GifTextureView;->t:F

    return p0
.end method

.method public static g(Landroid/content/res/TypedArray;)Lpl/droidsonroids/gif/d;
    .locals 3
    ...
    sget v1, Ljh/f;->GifTextureView_gifSource:I
...
.method public getIOException()Ljava/io/IOException;
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;
...
.method public getScaleType()Landroid/widget/ImageView$ScaleType;
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifTextureView;->p:Landroid/widget/ImageView$ScaleType;
...
.method public getTransform(Landroid/graphics/Matrix;)Landroid/graphics/Matrix;
    ...
    :cond_0
    iget-object v0, p0, Lpl/droidsonroids/gif/GifTextureView;->q:Landroid/graphics/Matrix;
...
.method public final h(Landroid/util/AttributeSet;II)V
    ...
    sget-object v2, Lpl/droidsonroids/gif/GifTextureView;->v:[Landroid/widget/ImageView$ScaleType;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/GifTextureView;->p:Landroid/widget/ImageView$ScaleType;
    ...
    sget-object v2, Ljh/f;->GifTextureView:[I
    ...
    iput-object v2, p0, Lpl/droidsonroids/gif/GifTextureView;->r:Lpl/droidsonroids/gif/d;

    sget v2, Ljh/f;->GifTextureView_isOpaque:I
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/GifTextureView;->u:Lpl/droidsonroids/gif/c$b;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->u:Lpl/droidsonroids/gif/c$b;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;

    iget-object p2, p0, Lpl/droidsonroids/gif/GifTextureView;->r:Lpl/droidsonroids/gif/d;
...
.method public final i(Lpl/droidsonroids/gif/GifInfoHandle;)V
    .locals 10
    ...
    iget-object v8, p0, Lpl/droidsonroids/gif/GifTextureView;->p:Landroid/widget/ImageView$ScaleType;
    ...
    :pswitch_0
    iget-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->q:Landroid/graphics/Matrix;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0, p0, v1}, Lpl/droidsonroids/gif/GifTextureView$c;->dispose(Lpl/droidsonroids/gif/GifTextureView;Lpl/droidsonroids/gif/GifTextureView$b;)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object p1, p1, Lpl/droidsonroids/gif/b;->p:[[J

    const/4 v1, 0x0

    aget-object p1, p1, v1

    iput-object p1, v0, Lpl/droidsonroids/gif/GifTextureView$c;->s:[J
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v1}, Lpl/droidsonroids/gif/GifInfoHandle;->l()[J

    move-result-object v1

    iput-object v1, v0, Lpl/droidsonroids/gif/GifTextureView$c;->s:[J
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/GifTextureView;->u:Lpl/droidsonroids/gif/c$b;

    iget-boolean v2, v2, Lpl/droidsonroids/gif/c$b;->a:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;

    iget-object v2, v2, Lpl/droidsonroids/gif/GifTextureView$c;->s:[J
...
.method public setFreezesAnimation(Z)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/GifTextureView;->u:Lpl/droidsonroids/gif/c$b;

    iput-boolean p1, v0, Lpl/droidsonroids/gif/c$b;->a:Z
...
.method public declared-synchronized setInputSource(Lpl/droidsonroids/gif/d;)V
    .locals 1
    ...
    :try_start_0
    invoke-virtual {p0, p1, v0}, Lpl/droidsonroids/gif/GifTextureView;->setInputSource(Lpl/droidsonroids/gif/d;Lpl/droidsonroids/gif/GifTextureView$b;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setInputSource(Lpl/droidsonroids/gif/d;Lpl/droidsonroids/gif/GifTextureView$b;)V
    .locals 1
    .param p1    # Lpl/droidsonroids/gif/d;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {v0, p0, p2}, Lpl/droidsonroids/gif/GifTextureView$c;->dispose(Lpl/droidsonroids/gif/GifTextureView;Lpl/droidsonroids/gif/GifTextureView$b;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object p2, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;
    ...
    :goto_0
    iput-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->r:Lpl/droidsonroids/gif/d;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;
    ...
    :cond_0
    invoke-virtual {p0}, Lpl/droidsonroids/gif/GifTextureView;->f()V
    :try_end_2
...
.method public setOpaque(Z)V
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->r:Lpl/droidsonroids/gif/d;

    invoke-virtual {p0, p1}, Lpl/droidsonroids/gif/GifTextureView;->setInputSource(Lpl/droidsonroids/gif/d;)V
...
.method public setScaleType(Landroid/widget/ImageView$ScaleType;)V
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/GifTextureView;->s:Lpl/droidsonroids/gif/GifTextureView$c;
...
.method public setSpeed(F)V
    ...
    invoke-virtual {v0, p1}, Lpl/droidsonroids/gif/GifInfoHandle;->B(F)V
