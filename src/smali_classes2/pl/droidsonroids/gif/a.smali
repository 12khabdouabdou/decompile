...
.method public constructor <init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 1
    invoke-static {p1, p2}, Lpl/droidsonroids/gif/GifInfoHandle;->q(Landroid/content/ContentResolver;Landroid/net/Uri;)Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public constructor <init>(Landroid/content/res/Resources;I)V
    ...
    iget-object p2, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/a;->G:I

    iget-object p2, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;

    invoke-virtual {p2}, Lpl/droidsonroids/gif/GifInfoHandle;->m()I
    ...
    iput p1, p0, Lpl/droidsonroids/gif/a;->F:I
...
.method public constructor <init>(Lpl/droidsonroids/gif/GifInfoHandle;Lpl/droidsonroids/gif/a;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Z)V
    ...
    iput-boolean v0, p0, Lpl/droidsonroids/gif/a;->q:Z

    const-wide/high16 v1, -0x8000000000000000L

    iput-wide v1, p0, Lpl/droidsonroids/gif/a;->r:J

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lpl/droidsonroids/gif/a;->s:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/a;->t:Landroid/graphics/Paint;

    new-instance v1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object v1, p0, Lpl/droidsonroids/gif/a;->w:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v1, Lpl/droidsonroids/gif/f;

    invoke-direct {v1, p0}, Lpl/droidsonroids/gif/f;-><init>(Lpl/droidsonroids/gif/a;)V

    iput-object v1, p0, Lpl/droidsonroids/gif/a;->C:Lpl/droidsonroids/gif/f;

    iput-boolean p4, p0, Lpl/droidsonroids/gif/a;->A:Z
    ...
    :goto_0
    iput-object p3, p0, Lpl/droidsonroids/gif/a;->p:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    iput-object p1, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object v2, p2, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;

    monitor-enter v2

    :try_start_0
    iget-object v3, p2, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;

    invoke-virtual {v3}, Lpl/droidsonroids/gif/GifInfoHandle;->o()Z
    ...
    invoke-virtual {v3}, Lpl/droidsonroids/gif/GifInfoHandle;->m()I
    ...
    iget-object p4, p2, Lpl/droidsonroids/gif/a;->u:Landroid/graphics/Bitmap;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/a;->u:Landroid/graphics/Bitmap;

    goto :goto_4

    :cond_3
    iput-object p4, p0, Lpl/droidsonroids/gif/a;->u:Landroid/graphics/Bitmap;

    :goto_4
    iget-object p2, p0, Lpl/droidsonroids/gif/a;->u:Landroid/graphics/Bitmap;

    invoke-virtual {p1}, Lpl/droidsonroids/gif/GifInfoHandle;->n()Z
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/a;->D:Landroid/graphics/Rect;

    new-instance p2, Ljh/d;

    invoke-direct {p2, p0}, Ljh/d;-><init>(Lpl/droidsonroids/gif/a;)V

    iput-object p2, p0, Lpl/droidsonroids/gif/a;->B:Ljh/d;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/a;->F:I

    invoke-virtual {p1}, Lpl/droidsonroids/gif/GifInfoHandle;->g()I

    move-result p1

    iput p1, p0, Lpl/droidsonroids/gif/a;->G:I

    return-void
.end method

.method public constructor <init>(Lpl/droidsonroids/gif/d;Lpl/droidsonroids/gif/a;Ljava/util/concurrent/ScheduledThreadPoolExecutor;ZLjh/b;)V
    .locals 0
    .param p1    # Lpl/droidsonroids/gif/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lpl/droidsonroids/gif/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 5
    invoke-virtual {p1, p5}, Lpl/droidsonroids/gif/d;->a(Ljh/b;)Lpl/droidsonroids/gif/GifInfoHandle;

    move-result-object p1

    invoke-direct {p0, p1, p2, p3, p4}, Lpl/droidsonroids/gif/a;-><init>(Lpl/droidsonroids/gif/GifInfoHandle;Lpl/droidsonroids/gif/a;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Z)V

    return-void
.end method

.method public static createFromResource(Landroid/content/res/Resources;I)Lpl/droidsonroids/gif/a;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lpl/droidsonroids/gif/a;-><init>(Landroid/content/res/Resources;I)V
    :try_end_0
...
.method public final a()V
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->E:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_0
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->B:Ljh/d;
...
.method public b()I
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public c()I
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->y:Landroid/graphics/PorterDuffColorFilter;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/a;->t:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/a;->y:Landroid/graphics/PorterDuffColorFilter;
    ...
    :goto_0
    iget-object v1, p0, Lpl/droidsonroids/gif/a;->u:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lpl/droidsonroids/gif/a;->D:Landroid/graphics/Rect;

    iget-object v3, p0, Lpl/droidsonroids/gif/a;->s:Landroid/graphics/Rect;

    iget-object v4, p0, Lpl/droidsonroids/gif/a;->t:Landroid/graphics/Paint;

    invoke-virtual {p1, v1, v2, v3, v4}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V

    if-eqz v0, :cond_1

    iget-object p1, p0, Lpl/droidsonroids/gif/a;->t:Landroid/graphics/Paint;
...
.method public f()V
    ...
    .line 1
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->p:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final g()V
    ...
    iget-boolean v0, p0, Lpl/droidsonroids/gif/a;->q:Z

    if-eqz v0, :cond_0

    iget-wide v0, p0, Lpl/droidsonroids/gif/a;->r:J
    ...
    iput-wide v2, p0, Lpl/droidsonroids/gif/a;->r:J

    iget-object v2, p0, Lpl/droidsonroids/gif/a;->p:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    iget-object v3, p0, Lpl/droidsonroids/gif/a;->C:Lpl/droidsonroids/gif/f;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/a;->E:Ljava/util/concurrent/ScheduledFuture;
...
.method public getIntrinsicHeight()I
    ...
    iget v0, p0, Lpl/droidsonroids/gif/a;->G:I
...
.method public getIntrinsicWidth()I
    ...
    iget v0, p0, Lpl/droidsonroids/gif/a;->F:I
...
.method public getTransform()Lkh/a;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public isStateful()Z
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->x:Landroid/content/res/ColorStateList;
...
.method public j(J)V
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/a;->B:Ljh/d;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/a;->E:Ljava/util/concurrent/ScheduledFuture;
...
.method public onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/a;->s:Landroid/graphics/Rect;
...
.method public onStateChange([I)Z
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/a;->x:Landroid/content/res/ColorStateList;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/a;->z:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/a;->y:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/a;->x:Landroid/content/res/ColorStateList;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/a;->z:Landroid/graphics/PorterDuff$Mode;
...
.method public setTransform(Lkh/a;)V
    .locals 0
    .param p1    # Lkh/a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public setVisible(ZZ)Z
    ...
    iget-boolean v1, p0, Lpl/droidsonroids/gif/a;->A:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/a;->v:Lpl/droidsonroids/gif/GifInfoHandle;
