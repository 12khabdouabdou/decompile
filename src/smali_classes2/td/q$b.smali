...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ltd/q;->W1(Ljava/util/List;ZLandroid/widget/TextView;Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;)V
.end annotation
...
.field public final synthetic d:Ltd/v;
...
# direct methods
.method public constructor <init>(Ltd/q;ZLcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;Ljava/util/List;Ltd/v;Landroid/widget/TextView;)V
    .locals 0

    .line 1
    iput-object p1, p0, Ltd/q$b;->f:Ltd/q;

    iput-boolean p2, p0, Ltd/q$b;->a:Z

    iput-object p3, p0, Ltd/q$b;->b:Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;

    iput-object p4, p0, Ltd/q$b;->c:Ljava/util/List;

    iput-object p5, p0, Ltd/q$b;->d:Ltd/v;

    iput-object p6, p0, Ltd/q$b;->e:Landroid/widget/TextView;
...
.method public static synthetic e(Ltd/q$b;Lcom/video_cloud/record/entity/LiveHistory;Ljava/util/List;ILtd/v;Landroid/widget/TextView;Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;)V
    .locals 0

    .line 1
    invoke-virtual/range {p0 .. p6}, Ltd/q$b;->f(Lcom/video_cloud/record/entity/LiveHistory;Ljava/util/List;ILtd/v;Landroid/widget/TextView;Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;)V
...
.method public a(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Ltd/q$b;->c:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/video_cloud/record/entity/LiveHistory;->getId()Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {p1, v0}, Lgd/p0;->w(Ljava/lang/Integer;)V

    iget-object p1, p0, Ltd/q$b;->c:Ljava/util/List;

    invoke-interface {p1, p2}, Ljava/util/List;->remove(I)Ljava/lang/Object;

    iget-object p1, p0, Ltd/q$b;->d:Ltd/v;
    ...
    iget-object p1, p0, Ltd/q$b;->e:Landroid/widget/TextView;

    const/16 p2, 0x8

    invoke-virtual {p1, p2}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Ltd/q$b;->b:Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;
...
.method public b(Landroid/view/View;I)V
    ...
    .line 1
    iget-object p2, p0, Ltd/q$b;->f:Ltd/q;
...
.method public c(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Ltd/q$b;->f:Ltd/q;
    ...
    iget-object v3, p0, Ltd/q$b;->c:Ljava/util/List;

    iget-object v5, p0, Ltd/q$b;->d:Ltd/v;

    iget-object v6, p0, Ltd/q$b;->e:Landroid/widget/TextView;

    iget-object v7, p0, Ltd/q$b;->b:Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;

    new-instance v9, Ltd/r;
    ...
    invoke-direct/range {v0 .. v7}, Ltd/r;-><init>(Ltd/q$b;Lcom/video_cloud/record/entity/LiveHistory;Ljava/util/List;ILtd/v;Landroid/widget/TextView;Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;)V
...
.method public d(Landroid/view/View;ILandroid/view/KeyEvent;I)Z
    ...
    .line 1
    iget-boolean v0, p0, Ltd/q$b;->a:Z
...
.method public final synthetic f(Lcom/video_cloud/record/entity/LiveHistory;Ljava/util/List;ILtd/v;Landroid/widget/TextView;Lcom/video_cloud/library_view/tvrecyclerview/TvRecyclerView;)V
    .locals 1
