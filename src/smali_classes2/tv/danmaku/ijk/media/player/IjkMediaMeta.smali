...
.field public static final IJKM_KEY_DISPOSITION:Ljava/lang/String; = "disposition"
...
.field public static final IJKM_KEY_HANDLER_NAME:Ljava/lang/String; = "handler_name"
...
.field public static final IJKM_KEY_TITLE:Ljava/lang/String; = "title"
...
.method private static convertLang(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method public static parse(Landroid/os/Bundle;)Ltv/danmaku/ijk/media/player/IjkMediaMeta;
    ...
    invoke-virtual {v0, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {v5, v3}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V
    ...
    iput-object v6, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTitle:Ljava/lang/String;

    const-string v6, "disposition"

    invoke-virtual {v5, v6, v2}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;I)I

    move-result v7

    iput v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mDisposition:I

    const-string v7, "language"

    invoke-virtual {v5, v7}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    invoke-static {v7}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->convertLang(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    iget-object v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    invoke-virtual {v5, p0}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    int-to-long v7, v7

    iput-wide v7, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J

    invoke-virtual {v5, v6, v2}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;I)I

    move-result v6

    iput v6, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mDisposition:I

    invoke-virtual {v5, v4}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTitle:Ljava/lang/String;
    ...
    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHandlerName:Ljava/lang/String;
