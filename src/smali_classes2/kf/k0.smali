...
.field public static final e:Lkf/k0$c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkf/k0;->d:Ljava/util/logging/Logger;

    new-instance v0, Lkf/k0$a;

    invoke-direct {v0}, Lkf/k0$a;-><init>()V

    sput-object v0, Lkf/k0;->e:Lkf/k0$c;

    new-instance v0, Lkf/k0$b;

    invoke-direct {v0}, Lkf/k0$b;-><init>()V

    sput-object v0, Lkf/k0;->f:Lcom/google/common/base/q;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lkf/k0;->f:Lcom/google/common/base/q;

    sget-object v1, Lkf/k0;->e:Lkf/k0$c;
    ...
    invoke-direct {p0, v0, v1, v2}, Lkf/k0;-><init>(Lcom/google/common/base/q;Lkf/k0$c;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Lcom/google/common/base/q;Lkf/k0$c;Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p1, p0, Lkf/k0;->a:Lcom/google/common/base/q;

    invoke-static {p2}, Lcom/google/common/base/l;->o(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lkf/k0$c;

    iput-object p1, p0, Lkf/k0;->b:Lkf/k0$c;

    if-eqz p3, :cond_0

    invoke-static {p3}, Lkf/k0;->d(Ljava/lang/String;)Ljava/net/InetSocketAddress;

    move-result-object p1

    :goto_0
    iput-object p1, p0, Lkf/k0;->c:Ljava/net/InetSocketAddress;
...
.method public static synthetic b()Ljava/util/logging/Logger;
    ...
    .line 1
    sget-object v0, Lkf/k0;->d:Ljava/util/logging/Logger;
...
.method public static d(Ljava/lang/String;)Ljava/net/InetSocketAddress;
    ...
    :goto_0
    sget-object v1, Lkf/k0;->d:Ljava/util/logging/Logger;
...
.method public a(Ljava/net/SocketAddress;)Lio/grpc/ProxiedSocketAddress;
    ...
    :cond_0
    iget-object v0, p0, Lkf/k0;->c:Ljava/net/InetSocketAddress;
    ...
    iget-object v1, p0, Lkf/k0;->c:Ljava/net/InetSocketAddress;
    ...
    invoke-virtual {p0, p1}, Lkf/k0;->c(Ljava/net/InetSocketAddress;)Lio/grpc/ProxiedSocketAddress;
...
.method public final c(Ljava/net/InetSocketAddress;)Lio/grpc/ProxiedSocketAddress;
    ...
    iget-object v1, p0, Lkf/k0;->a:Lcom/google/common/base/q;
    ...
    sget-object p1, Lkf/k0;->d:Ljava/util/logging/Logger;
    ...
    sget-object v2, Lkf/k0;->d:Ljava/util/logging/Logger;
    ...
    iget-object v2, p0, Lkf/k0;->b:Lkf/k0$c;
    ...
    invoke-interface/range {v2 .. v8}, Lkf/k0$c;->a(Ljava/lang/String;Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/PasswordAuthentication;
