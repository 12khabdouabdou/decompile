...
.method public final varargs of([Lokio/ByteString;)Lokio/Options;
    ...
    invoke-direct {v0, v1, v3, v2}, Lokio/Options;-><init>([Lokio/ByteString;[ILjg/f;)V

    return-object v0

    :cond_0
    invoke-static/range {p1 .. p1}, Luf/i;->N([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    invoke-static {v1}, Luf/o;->v(Ljava/util/List;)V
    ...
    invoke-static {v3}, Luf/o;->p([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static/range {v5 .. v10}, Luf/o;->j(Ljava/util/List;Ljava/lang/Comparable;IIILjava/lang/Object;)I
    ...
    invoke-direct {v3, v0, v5, v2}, Lokio/Options;-><init>([Lokio/ByteString;[ILjg/f;)V
