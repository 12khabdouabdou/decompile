...
.method public constructor <init>(Llc/g;)V
    ...
    .line 1
    iput-object p1, p0, Llc/g$c;->a:Llc/g;
...
.method public bridge synthetic a(Lt3/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Llc/g$c;->d(Lt3/e;Lcom/video_cloud/download/DownloadFile;)V
...
.method public b()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR REPLACE `download_file` SET `id` = ?,`video_id` = ?,`episode_id` = ?,`download_id` = ?,`download_url` = ?,`file_path` = ?,`file_name` = ?,`status` = ?,`source_type` = ?,`progress` = ?,`total_bytes` = ?,`current_bytes` = ?,`backdrop_path` = ?,`episode_pic` = ?,`episode_runtime` = ?,`title` = ?,`duration` = ?,`role_id` = ?,`created_at` = ? WHERE `id` = ?"
