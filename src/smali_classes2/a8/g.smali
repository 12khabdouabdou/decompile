...
.method public static compositeTwoLayeredDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0, v0}, La8/g;->compositeTwoLayeredDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static compositeTwoLayeredDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {p0 .. p1}, La8/g;->c(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static/range {p0 .. p1}, La8/g;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {v3, v5, v1, v2}, La8/d;->a(Landroid/graphics/drawable/LayerDrawable;III)V

    const/16 v0, 0x11

    invoke-static {v3, v5, v0}, La8/e;->a(Landroid/graphics/drawable/LayerDrawable;II)V
    ...
    invoke-direct {v3, v0, v1, v2}, La8/i;-><init>(Landroid/graphics/drawable/Drawable;II)V
...
.method public static createTintableDrawableIfNeeded(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, La8/g;->createTintableMutatedDrawableIfNeeded(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method private static createTintableMutatedDrawableIfNeeded(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, Lk0/a;->n(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public static f(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    invoke-static {p0, p1}, La8/g$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, La8/g$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
...
.method public static getColorStateListOrNull(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, La8/a;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, La8/b;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, La8/c;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static setRippleDrawableRadius(Landroid/graphics/drawable/RippleDrawable;I)V
    ...
    invoke-static {p0, p1}, La8/f;->a(Landroid/graphics/drawable/RippleDrawable;I)V
