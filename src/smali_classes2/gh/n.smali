...
.field public static final e:[Lgh/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgh/n;->d:Ljava/util/Map;

    const/4 v0, 0x4

    new-array v0, v0, [Lgh/n$a;

    sput-object v0, Lgh/n;->e:[Lgh/n$a;
...
.method public constructor <init>(Ljava/util/List;ZZ)V
    ...
    iput-boolean p2, p0, Lgh/n;->b:Z

    iput-boolean p3, p0, Lgh/n;->c:Z
...
.method public a(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 1
    sget-object v0, Lgh/n;->d:Ljava/util/Map;
    ...
    :cond_0
    iget-boolean v1, p0, Lgh/n;->c:Z

    if-eqz v1, :cond_1

    invoke-virtual {p0, p1}, Lgh/n;->c(Ljava/lang/Class;)Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lgh/n;->b(Ljava/lang/Class;)Ljava/util/List;
...
.method public final b(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 1
    invoke-virtual {p0}, Lgh/n;->g()Lgh/n$a;

    move-result-object v0

    invoke-virtual {v0, p1}, Lgh/n$a;->c(Ljava/lang/Class;)V

    :goto_0
    iget-object p1, v0, Lgh/n$a;->f:Ljava/lang/Class;

    if-eqz p1, :cond_0

    invoke-virtual {p0, v0}, Lgh/n;->f(Lgh/n$a;)Lih/a;

    invoke-virtual {p0, v0}, Lgh/n;->d(Lgh/n$a;)V

    invoke-virtual {v0}, Lgh/n$a;->d()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v0}, Lgh/n;->e(Lgh/n$a;)Ljava/util/List;
...
.method public final d(Lgh/n$a;)V
    .locals 14
    ...
    :try_start_0
    iget-object v1, p1, Lgh/n$a;->f:Ljava/lang/Class;
    ...
    iput-boolean v0, p1, Lgh/n$a;->g:Z
    ...
    invoke-virtual {p1, v6, v8}, Lgh/n$a;->a(Ljava/lang/reflect/Method;Ljava/lang/Class;)Z
    ...
    iget-object v11, p1, Lgh/n$a;->a:Ljava/util/List;

    new-instance v12, Lgh/m;
    ...
    invoke-direct/range {v5 .. v10}, Lgh/m;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;Lorg/greenrobot/eventbus/ThreadMode;IZ)V
    ...
    iget-object p1, p1, Lgh/n$a;->f:Ljava/lang/Class;
...
.method public final e(Lgh/n$a;)Ljava/util/List;
    .locals 5

    .line 1
    new-instance v0, Ljava/util/ArrayList;

    iget-object v1, p1, Lgh/n$a;->a:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    invoke-virtual {p1}, Lgh/n$a;->e()V

    sget-object v1, Lgh/n;->e:[Lgh/n$a;
    ...
    :try_start_0
    sget-object v3, Lgh/n;->e:[Lgh/n$a;
...
.method public final f(Lgh/n$a;)Lih/a;
    .locals 2

    .line 1
    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p1, p0, Lgh/n;->a:Ljava/util/List;
...
.method public final g()Lgh/n$a;
    .locals 5

    .line 1
    sget-object v0, Lgh/n;->e:[Lgh/n$a;
    ...
    :try_start_0
    sget-object v2, Lgh/n;->e:[Lgh/n$a;
