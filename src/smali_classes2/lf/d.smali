...
.method static constructor <clinit>()V
    ...
    sput-object v1, Llf/d;->b:Ljava/util/logging/Logger;

    invoke-static {}, Lio/grpc/okhttp/internal/Platform;->e()Lio/grpc/okhttp/internal/Platform;

    move-result-object v1

    sput-object v1, Llf/d;->c:Lio/grpc/okhttp/internal/Platform;

    invoke-virtual {v0}, Ljava/lang/Class;->getClassLoader()Ljava/lang/ClassLoader;

    move-result-object v0

    invoke-static {v0}, Llf/d;->d(Ljava/lang/ClassLoader;)Llf/d;

    move-result-object v0

    sput-object v0, Llf/d;->d:Llf/d;
...
.method public constructor <init>(Lio/grpc/okhttp/internal/Platform;)V
    ...
    iput-object p1, p0, Llf/d;->a:Lio/grpc/okhttp/internal/Platform;
...
.method public static synthetic a()Ljava/util/logging/Logger;
    ...
    .line 1
    sget-object v0, Llf/d;->b:Ljava/util/logging/Logger;
...
.method public static synthetic b(Ljava/util/List;)[Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Llf/d;->i(Ljava/util/List;)[Ljava/lang/String;
...
.method public static d(Ljava/lang/ClassLoader;)Llf/d;
    .locals 4
    ...
    sget-object v1, Llf/d;->b:Ljava/util/logging/Logger;
    ...
    sget-object v0, Llf/d;->c:Lio/grpc/okhttp/internal/Platform;

    invoke-direct {p0, v0}, Llf/d$a;-><init>(Lio/grpc/okhttp/internal/Platform;)V
    ...
    invoke-direct {p0, v0}, Llf/d;-><init>(Lio/grpc/okhttp/internal/Platform;)V

    :goto_1
    return-object p0
.end method

.method public static e()Llf/d;
    .locals 1

    .line 1
    sget-object v0, Llf/d;->d:Llf/d;
...
.method public h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, p3}, Llf/d;->c(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V

    :cond_0
    :try_start_0
    invoke-virtual {p1}, Ljavax/net/ssl/SSLSocket;->startHandshake()V

    invoke-virtual {p0, p1}, Llf/d;->f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
