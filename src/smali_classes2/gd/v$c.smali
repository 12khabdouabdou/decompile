...
.method public constructor <init>(Lgd/v;)V
    ...
    .line 1
    iput-object p1, p0, Lgd/v$c;->a:Lgd/v;
...
.method public bridge synthetic a(Lt3/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lgd/v$c;->d(Lt3/e;Lcom/video_cloud/record/entity/RecordEntity;)V
...
.method public b()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR REPLACE `play_record` SET `id` = ?,`video_id` = ?,`series_id` = ?,`title` = ?,`play_time` = ?,`source_type` = ?,`update_date` = ?,`total_time` = ?,`season_number` = ?,`episode_number` = ?,`video_pic` = ?,`role_id` = ?,`imdb_id` = ?,`subtitle_delay` = ?,`hardware_decode` = ? WHERE `id` = ?"
