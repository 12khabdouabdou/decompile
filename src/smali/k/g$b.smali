...
.method public f(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Le/j;->MenuGroup:[I

    invoke-virtual {v0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v0, Le/j;->MenuGroup_android_id:I
    ...
    sget v0, Le/j;->MenuGroup_android_menuCategory:I
    ...
    sget v0, Le/j;->MenuGroup_android_orderInCategory:I
    ...
    sget v0, Le/j;->MenuGroup_android_checkableBehavior:I
    ...
    sget v0, Le/j;->MenuGroup_android_visible:I
    ...
    sget v0, Le/j;->MenuGroup_android_enabled:I
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Le/j;->MenuItem:[I

    invoke-static {v0, p1, v1}, Lm/q0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lm/q0;

    move-result-object p1

    sget v0, Le/j;->MenuItem_android_id:I
    ...
    sget v0, Le/j;->MenuItem_android_menuCategory:I

    iget v2, p0, Lk/g$b;->c:I

    invoke-virtual {p1, v0, v2}, Lm/q0;->j(II)I

    move-result v0

    sget v2, Le/j;->MenuItem_android_orderInCategory:I

    iget v3, p0, Lk/g$b;->d:I

    invoke-virtual {p1, v2, v3}, Lm/q0;->j(II)I
    ...
    sget v0, Le/j;->MenuItem_android_title:I
    ...
    sget v0, Le/j;->MenuItem_android_titleCondensed:I
    ...
    sget v0, Le/j;->MenuItem_android_icon:I
    ...
    sget v0, Le/j;->MenuItem_android_alphabeticShortcut:I

    invoke-virtual {p1, v0}, Lm/q0;->n(I)Ljava/lang/String;
    ...
    sget v0, Le/j;->MenuItem_alphabeticModifiers:I
    ...
    sget v0, Le/j;->MenuItem_android_numericShortcut:I
    ...
    sget v0, Le/j;->MenuItem_numericModifiers:I
    ...
    sget v0, Le/j;->MenuItem_android_checkable:I
    ...
    :goto_1
    sget v0, Le/j;->MenuItem_android_checked:I
    ...
    sget v0, Le/j;->MenuItem_android_visible:I

    iget-boolean v2, p0, Lk/g$b;->f:Z

    invoke-virtual {p1, v0, v2}, Lm/q0;->a(IZ)Z

    move-result v0

    iput-boolean v0, p0, Lk/g$b;->t:Z

    sget v0, Le/j;->MenuItem_android_enabled:I
    ...
    sget v0, Le/j;->MenuItem_showAsAction:I
    ...
    sget v0, Le/j;->MenuItem_android_onClick:I
    ...
    sget v0, Le/j;->MenuItem_actionLayout:I
    ...
    sget v0, Le/j;->MenuItem_actionViewClass:I
    ...
    sget v0, Le/j;->MenuItem_actionProviderClass:I
    ...
    :goto_3
    sget v0, Le/j;->MenuItem_contentDescription:I
    ...
    sget v0, Le/j;->MenuItem_tooltipText:I
    ...
    sget v0, Le/j;->MenuItem_iconTintMode:I
    ...
    :goto_4
    sget v0, Le/j;->MenuItem_iconTint:I
...
.method public final i(Landroid/view/MenuItem;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/view/menu/f;->r(Z)V
    ...
    invoke-virtual {v0, v3}, Ll/c;->f(Z)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/z;->setActionProvider(Landroid/view/MenuItem;Landroidx/core/view/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Lk/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroidx/core/view/z;->setContentDescription(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lk/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Landroidx/core/view/z;->setTooltipText(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lk/g$b;->n:C

    iget v1, p0, Lk/g$b;->o:I

    invoke-static {p1, v0, v1}, Landroidx/core/view/z;->a(Landroid/view/MenuItem;CI)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/z;->setIconTintMode(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/z;->setIconTintList(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
