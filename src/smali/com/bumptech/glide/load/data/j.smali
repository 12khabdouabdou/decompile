...
# static fields
.field public static final v:Lcom/bumptech/glide/load/data/j$b;


# instance fields
.field public final p:Lf5/g;

.field public final q:I

.field public final r:Lcom/bumptech/glide/load/data/j$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/data/j;->v:Lcom/bumptech/glide/load/data/j$b;
...
.method public constructor <init>(Lf5/g;I)V
    ...
    .line 1
    sget-object v0, Lcom/bumptech/glide/load/data/j;->v:Lcom/bumptech/glide/load/data/j$b;

    invoke-direct {p0, p1, p2, v0}, Lcom/bumptech/glide/load/data/j;-><init>(Lf5/g;ILcom/bumptech/glide/load/data/j$b;)V

    return-void
.end method

.method public constructor <init>(Lf5/g;ILcom/bumptech/glide/load/data/j$b;)V
    .locals 0

    .line 2
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/bumptech/glide/load/data/j;->p:Lf5/g;

    iput p2, p0, Lcom/bumptech/glide/load/data/j;->q:I

    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->r:Lcom/bumptech/glide/load/data/j$b;
...
.method public b()V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/data/j;->t:Ljava/io/InputStream;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;
...
.method public final c(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/bumptech/glide/load/data/j;->r:Lcom/bumptech/glide/load/data/j$b;
    ...
    :cond_0
    iget p2, p0, Lcom/bumptech/glide/load/data/j;->q:I
...
.method public cancel()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/data/j;->u:Z
...
.method public e(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/d$a;)V
    ...
    :try_start_0
    iget-object v4, p0, Lcom/bumptech/glide/load/data/j;->p:Lf5/g;

    invoke-virtual {v4}, Lf5/g;->i()Ljava/net/URL;

    move-result-object v4

    iget-object v5, p0, Lcom/bumptech/glide/load/data/j;->p:Lf5/g;

    invoke-virtual {v5}, Lf5/g;->e()Ljava/util/Map;
...
.method public final g(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {v1, v2, v3}, Lu5/c;->d(Ljava/io/InputStream;J)Ljava/io/InputStream;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Lcom/bumptech/glide/load/data/j;->t:Ljava/io/InputStream;
    ...
    :goto_1
    iget-object p1, p0, Lcom/bumptech/glide/load/data/j;->t:Ljava/io/InputStream;
...
.method public final j(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;

    :try_start_1
    invoke-virtual {p3}, Ljava/net/URLConnection;->connect()V

    iget-object p3, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;

    invoke-virtual {p3}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p3

    iput-object p3, p0, Lcom/bumptech/glide/load/data/j;->t:Ljava/io/InputStream;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_3

    iget-boolean p3, p0, Lcom/bumptech/glide/load/data/j;->u:Z
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/data/j;->s:Ljava/net/HttpURLConnection;
