...
.method public static a(Lcom/google/android/gms/common/internal/f;Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v2, v1}, Lu6/b;->i(Landroid/os/Parcel;II)V

    const/4 v1, 0x2

    iget v2, p0, Lcom/google/android/gms/common/internal/f;->q:I

    invoke-static {p1, v1, v2}, Lu6/b;->i(Landroid/os/Parcel;II)V

    const/4 v1, 0x3

    iget v2, p0, Lcom/google/android/gms/common/internal/f;->r:I

    invoke-static {p1, v1, v2}, Lu6/b;->i(Landroid/os/Parcel;II)V

    iget-object v1, p0, Lcom/google/android/gms/common/internal/f;->s:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->zzg:Landroid/os/IBinder;

    invoke-static {p1, v1, v2, v3}, Lu6/b;->h(Landroid/os/Parcel;ILandroid/os/IBinder;Z)V

    const/4 v1, 0x6

    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->t:[Lcom/google/android/gms/common/api/Scope;

    invoke-static {p1, v1, v2, p2, v3}, Lu6/b;->p(Landroid/os/Parcel;I[Landroid/os/Parcelable;IZ)V

    const/4 v1, 0x7

    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->u:Landroid/os/Bundle;

    invoke-static {p1, v1, v2, v3}, Lu6/b;->e(Landroid/os/Parcel;ILandroid/os/Bundle;Z)V

    const/16 v1, 0x8

    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->zzj:Landroid/accounts/Account;

    invoke-static {p1, v1, v2, p2, v3}, Lu6/b;->m(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V

    const/16 v1, 0xa

    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->v:[Ls6/c;

    invoke-static {p1, v1, v2, p2, v3}, Lu6/b;->p(Landroid/os/Parcel;I[Landroid/os/Parcelable;IZ)V

    const/16 v1, 0xb

    iget-object v2, p0, Lcom/google/android/gms/common/internal/f;->w:[Ls6/c;

    invoke-static {p1, v1, v2, p2, v3}, Lu6/b;->p(Landroid/os/Parcel;I[Landroid/os/Parcelable;IZ)V

    const/16 p2, 0xc

    iget-boolean v1, p0, Lcom/google/android/gms/common/internal/f;->x:Z

    invoke-static {p1, p2, v1}, Lu6/b;->c(Landroid/os/Parcel;IZ)V

    const/16 p2, 0xd

    iget v1, p0, Lcom/google/android/gms/common/internal/f;->y:I

    invoke-static {p1, p2, v1}, Lu6/b;->i(Landroid/os/Parcel;II)V

    const/16 p2, 0xe

    iget-boolean v1, p0, Lcom/google/android/gms/common/internal/f;->z:Z
    ...
    invoke-static {p1, p2, p0, v3}, Lu6/b;->n(Landroid/os/Parcel;ILjava/lang/String;Z)V
...
.method public final bridge synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    sget-object v2, Lcom/google/android/gms/common/internal/f;->A:[Lcom/google/android/gms/common/api/Scope;

    new-instance v3, Landroid/os/Bundle;

    invoke-direct {v3}, Landroid/os/Bundle;-><init>()V

    sget-object v4, Lcom/google/android/gms/common/internal/f;->B:[Ls6/c;
    ...
    :pswitch_5
    sget-object v3, Ls6/c;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v7 .. v21}, Lcom/google/android/gms/common/internal/f;-><init>(IIILjava/lang/String;Landroid/os/IBinder;[Lcom/google/android/gms/common/api/Scope;Landroid/os/Bundle;Landroid/accounts/Account;[Ls6/c;[Ls6/c;ZIZLjava/lang/String;)V
