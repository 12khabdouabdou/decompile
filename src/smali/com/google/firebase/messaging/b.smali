...
.method public static a()Z
    ...
    invoke-virtual {v2}, Lj9/e;->j()Landroid/content/Context;
...
.method public static b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->j(Landroid/os/Bundle;)I
    ...
    invoke-static {}, Lcom/google/firebase/messaging/b;->h()Ljava/lang/String;
    ...
    sget-object v0, Lcom/google/firebase/messaging/reporting/MessagingClientEvent$SDKPlatform;->r:Lcom/google/firebase/messaging/reporting/MessagingClientEvent$SDKPlatform;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->f(Landroid/os/Bundle;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->e(Landroid/os/Bundle;)I
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getMessageId(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getTopic(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getCollapseKey(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getMessageLabel(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getComposerLabel(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getProjectNumber(Landroid/os/Bundle;)J
...
.method public static c(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/firebase/installations/a;->p(Lj9/e;)Lcom/google/firebase/installations/a;

    move-result-object p0

    invoke-virtual {p0}, Lcom/google/firebase/installations/a;->getId()Lo7/g;

    move-result-object p0

    invoke-static {p0}, Lo7/j;->a(Lo7/g;)Ljava/lang/Object;
...
.method public static e(Landroid/os/Bundle;)I
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/b;->i(Landroid/os/Bundle;)I
...
.method public static f(Landroid/os/Bundle;)Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
    .locals 0

    .line 1
    if-eqz p0, :cond_0

    invoke-static {p0}, Lcom/google/firebase/messaging/c;->j(Landroid/os/Bundle;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget-object p0, Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;->t:Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;

    goto :goto_0

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;->r:Lcom/google/firebase/messaging/reporting/MessagingClientEvent$MessageType;
...
.method public static getProjectNumber(Landroid/os/Bundle;)J
    ...
    invoke-virtual {p0}, Lj9/e;->m()Lj9/k;

    move-result-object v0

    invoke-virtual {v0}, Lj9/k;->getGcmSenderId()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lj9/k;->b()Ljava/lang/String;
...
.method public static h()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lj9/e;->j()Landroid/content/Context;
...
.method public static i(Landroid/os/Bundle;)I
    ...
    :cond_1
    invoke-static {v0}, Lcom/google/firebase/messaging/b;->d(Ljava/lang/String;)I
...
.method public static l(Landroid/content/Intent;)V
    ...
    invoke-static {v0, p0}, Lcom/google/firebase/messaging/b;->p(Ljava/lang/String;Landroid/os/Bundle;)V

    return-void
.end method

.method private static logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lb6/h;)V
    .locals 5
    .param p2    # Lb6/h;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-static {p1}, Lb6/e;->withProductId(Ljava/lang/Integer;)Lb6/e;
    ...
    invoke-static {v3}, Lb6/c;->b(Ljava/lang/String;)Lb6/c;

    move-result-object v3

    new-instance v4, Lca/f0;

    invoke-direct {v4}, Lca/f0;-><init>()V

    invoke-interface {p2, v1, v2, v3, v4}, Lb6/h;->a(Ljava/lang/String;Ljava/lang/Class;Lb6/c;Lb6/f;)Lb6/g;

    move-result-object p2

    invoke-static {}, Lda/a;->b()Lda/a$a;

    move-result-object v1

    invoke-virtual {v1, p0}, Lda/a$a;->b(Lcom/google/firebase/messaging/reporting/MessagingClientEvent;)Lda/a$a;
    ...
    invoke-static {p0, p1}, Lb6/d;->ofData(Ljava/lang/Object;Lb6/e;)Lb6/d;

    move-result-object p0

    invoke-interface {p2, p0}, Lb6/g;->a(Lb6/d;)V
    :try_end_0
...
.method public static n(Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/b;->q(Landroid/os/Bundle;)V
...
.method public static o(Landroid/content/Intent;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/b;->s(Landroid/content/Intent;)Z
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/messaging/b;->p(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    sget-object v0, Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;->r:Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()Lb6/h;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/b;->logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lb6/h;)V
...
.method public static p(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getComposerId(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getMessageChannel(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getMessageTime(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    :cond_6
    :goto_0
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->getUseDeviceTime(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v2}, Lj9/e;->i(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p0, v1}, Ll9/a;->logEvent(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static q(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, Lj9/e;->i(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v2, v1, p0}, Ll9/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v2, p0, v1}, Ll9/a;->logEvent(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static r(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/b;->k(Landroid/content/Intent;)Z
...
.method public static s(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lcom/google/firebase/messaging/b;->t(Landroid/os/Bundle;)Z
