...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/messaging/FirebaseMessagingService;->v:Ljava/util/Queue;
...
.method public e(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 1
    invoke-static {}, Lca/q0;->b()Lca/q0;

    move-result-object p1

    invoke-virtual {p1}, Lca/q0;->c()Landroid/content/Intent;
...
.method public final l(Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v0, Lcom/google/firebase/messaging/FirebaseMessagingService;->v:Ljava/util/Queue;
...
.method public final m(Landroid/content/Intent;)V
    ...
    invoke-static {}, Lca/m;->e()Ljava/util/concurrent/ExecutorService;

    move-result-object v2

    new-instance v3, Lca/e;

    invoke-direct {v3, p0, v1, v2}, Lca/e;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v3}, Lca/e;->a()Z
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/firebase/messaging/b;->s(Landroid/content/Intent;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-static {p1}, Lcom/google/firebase/messaging/b;->m(Landroid/content/Intent;)V
...
.method public final o(Landroid/content/Context;)Ls6/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->u:Ls6/a;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->u:Ls6/a;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->u:Ls6/a;
...
.method public final p(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-virtual {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->o(Landroid/content/Context;)Ls6/a;
    ...
    invoke-virtual {v0, v1}, Ls6/a;->b(Lcom/google/android/gms/cloudmessaging/CloudMessage;)Lo7/g;
