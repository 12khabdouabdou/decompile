...
.method public constructor <init>(LUgf;)V
    ...
    iget-boolean v7, p1, LhLg;->h:Z

    iget-object v8, p1, LhLg;->i:Ljava/lang/Integer;

    iget-object v3, p1, LhLg;->d:Ljava/util/Map;

    iget-object v4, p1, LhLg;->e:Ljava/lang/Object;

    iget-object v5, p1, LhLg;->f:Ljava/util/Map;

    iget-boolean v6, p1, LhLg;->g:Z
...
.method public constructor <init>(Ljava/lang/String;ILjava/util/Map;Ljava/lang/Object;Ljava/util/Map;ZZLjava/lang/Integer;)V
    ...
    iput-object p2, p0, LgLg;->c:Ljava/util/HashMap;

    .line 9
    iput-object p4, p0, LgLg;->e:Ljava/lang/Object;
    ...
    :goto_0
    iput-object p2, p0, LgLg;->d:Ljava/util/HashMap;
    ...
    .line 12
    iput-boolean p6, p0, LgLg;->f:Z

    .line 13
    iput-boolean p7, p0, LgLg;->g:Z

    .line 14
    iput-object p8, p0, LgLg;->h:Ljava/lang/Integer;
...
# virtual methods
.method public bridge a()LUgf;
    .locals 1

    .line 1
    invoke-virtual {p0}, LgLg;->b()LhLg;
...
.method public b()LhLg;
    ...
    .line 12
    .line 13
    iget-boolean v6, p0, LgLg;->f:Z

    .line 14
    .line 15
    iget-boolean v7, p0, LgLg;->g:Z

    .line 16
    .line 17
    iget-object v8, p0, LgLg;->h:Ljava/lang/Integer;
...
.method public c(Ljava/util/Map;)LgLg;
    .locals 1
    ...
    .line 5
    .line 6
    iput-object v0, p0, LgLg;->c:Ljava/util/HashMap;
...
.method public d(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, LgLg;->d:Ljava/util/HashMap;
...
.method public e(Ljava/util/Map;)LgLg;
    .locals 1
    ...
    .line 15
    :goto_0
    iput-object p1, p0, LgLg;->d:Ljava/util/HashMap;
...
.method public g(Ljava/lang/Integer;)LgLg;
    .locals 0
...
.method public h(Ljava/lang/String;)LgLg;
    .locals 0
