...
.method public static applyStylesToSpan(Landroid/text/Spannable;IILandroidx/media3/extractor/text/ttml/TtmlStyle;Ly2/b;Ljava/util/Map;I)V
    .locals 8
    .param p4    # Ly2/b;
    ...
    .line 1
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->h()I
    ...
    :cond_0
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->l()Z
    ...
    :cond_1
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->m()Z
    ...
    :cond_2
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->k()Z
    ...
    :cond_3
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->j()Z
    ...
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->a()I
    ...
    :cond_c
    invoke-static {p4, p5}, Ly2/e;->findRubyContainerNode(Ly2/b;Ljava/util/Map;)Ly2/b;
    ...
    :cond_d
    invoke-static {p4, p5}, Ly2/e;->findRubyTextNode(Ly2/b;Ljava/util/Map;)Ly2/b;
    ...
    invoke-virtual {p6, v0}, Ly2/b;->e(I)Ly2/b;

    move-result-object v6

    iget-object v6, v6, Ly2/b;->text:Ljava/lang/String;
    ...
    iget-object v0, v0, Ly2/b;->text:Ljava/lang/String;
    ...
    iget-object v6, p6, Ly2/b;->style:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p6}, Ly2/b;->getStyleIds()[Ljava/lang/String;

    move-result-object p6

    invoke-static {v6, p6, p5}, Ly2/e;->resolveStyle(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    move-result-object p6

    if-eqz p6, :cond_f

    invoke-virtual {p6}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->e()I
    ...
    iget-object v2, p4, Ly2/b;->style:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p4}, Ly2/b;->getStyleIds()[Ljava/lang/String;

    move-result-object p4

    invoke-static {v2, p4, p5}, Ly2/e;->resolveStyle(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    move-result-object p4

    if-eqz p4, :cond_10

    invoke-virtual {p4}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->e()I
    ...
    :goto_5
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->i()Z
    ...
    :cond_12
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->d()I
    ...
    :cond_13
    invoke-virtual {p3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->c()F
...
.method private static findRubyContainerNode(Ly2/b;Ljava/util/Map;)Ly2/b;
    .locals 2
    .param p0    # Ly2/b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0}, Ly2/b;->getStyleIds()[Ljava/lang/String;
    ...
    invoke-virtual {v0}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->f()I
    ...
    :cond_0
    iget-object p0, p0, Ly2/b;->parent:Ly2/b;
...
.method private static findRubyTextNode(Ly2/b;Ljava/util/Map;)Ly2/b;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    iget-object v1, p0, Ly2/b;->style:Landroidx/media3/extractor/text/ttml/TtmlStyle;

    invoke-virtual {p0}, Ly2/b;->getStyleIds()[Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2, p1}, Ly2/e;->resolveStyle(Landroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/util/Map;)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->f()I
    ...
    invoke-virtual {p0, v1}, Ly2/b;->e(I)Ly2/b;
