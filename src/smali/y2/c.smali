...
.field public static final i:Ly2/c$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ly2/c;->b:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->c:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->g:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Ly2/c;->h:Ljava/util/regex/Pattern;
    ...
    invoke-direct {v0, v1, v2, v2}, Ly2/c$a;-><init>(FII)V

    sput-object v0, Ly2/c;->i:Ly2/c$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ly2/c;->a:Lorg/xmlpull/v1/XmlPullParserFactory;
...
.method public static e(Lorg/xmlpull/v1/XmlPullParser;I)I
    .locals 7
    ...
    :cond_0
    sget-object v0, Ly2/c;->h:Ljava/util/regex/Pattern;
...
.method public static f(Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;)V
    ...
    sget-object v0, Ly2/c;->d:Ljava/util/regex/Pattern;
    ...
    sget-object v1, Ly2/c;->d:Ljava/util/regex/Pattern;
    ...
    :pswitch_0
    invoke-virtual {p1, v3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->r(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    goto :goto_2

    :pswitch_1
    invoke-virtual {p1, v2}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->r(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    goto :goto_2

    :pswitch_2
    invoke-virtual {p1, p0}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->r(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, p0}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->q(F)Landroidx/media3/extractor/text/ttml/TtmlStyle;
...
.method public static g(Lorg/xmlpull/v1/XmlPullParser;)Ly2/c$a;
    .locals 7
    ...
    :goto_2
    sget-object v2, Ly2/c;->i:Ly2/c$a;

    iget v4, v2, Ly2/c$a;->b:I
    ...
    invoke-direct {p0, v0, v4, v2}, Ly2/c$a;-><init>(FII)V

    return-object p0
.end method

.method public static h(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;)V
    .locals 2
...
.method public static i(Ljava/lang/String;)F
    ...
    .line 1
    sget-object v0, Ly2/c;->e:Ljava/util/regex/Pattern;
...
.method public static j(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlStyle;)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    :pswitch_0
    invoke-static {p1}, Ly2/c;->createIfNull(Landroidx/media3/extractor/text/ttml/TtmlStyle;)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    move-result-object p1

    invoke-static {v3}, Ly2/c;->parseAlignment(Ljava/lang/String;)Landroid/text/Layout$Alignment;
    ...
    invoke-virtual {p1, v4}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->n(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    :try_end_0
    ...
    invoke-virtual {p1, v11}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->u(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-static {v3, p1}, Ly2/c;->f(Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlStyle;)V
    :try_end_1
    ...
    invoke-virtual {p1, v1}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->x(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v11}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->x(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-static {v3}, Ly2/c;->i(Ljava/lang/String;)F

    move-result v3

    invoke-virtual {p1, v3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->w(F)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v4}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->p(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    :try_end_2
    ...
    invoke-virtual {p1, v9}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->v(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v7}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->v(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v11}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->v(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v10}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->v(I)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->o(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v11}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->t(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v1}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->t(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v11}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->y(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v1}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->y(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    invoke-virtual {p1, v3}, Landroidx/media3/extractor/text/ttml/TtmlStyle;->s(Z)Landroidx/media3/extractor/text/ttml/TtmlStyle;
...
.method public static l(Ljava/lang/String;Ly2/c$a;)J
    .locals 13

    .line 1
    sget-object v0, Ly2/c;->b:Ljava/util/regex/Pattern;
    ...
    iget p0, p1, Ly2/c$a;->b:I

    int-to-double v4, p0

    div-double/2addr v0, v4

    iget p0, p1, Ly2/c$a;->a:F
    ...
    :cond_3
    sget-object v0, Ly2/c;->c:Ljava/util/regex/Pattern;
...
.method private static parseHeader(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;ILy2/c$b;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    .locals 5
    .param p3    # Ly2/c$b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-static {p0, v1}, Ly2/c;->j(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlStyle;)Landroidx/media3/extractor/text/ttml/TtmlStyle;

    move-result-object v1

    if-eqz v0, :cond_1

    invoke-static {v0}, Ly2/c;->k(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p0, p2, p3, p1}, Ly2/c;->parseRegionAttributes(Lorg/xmlpull/v1/XmlPullParser;ILy2/c$b;Ljava/util/Map;)Ly2/d;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v1, v0, Ly2/d;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p5}, Ly2/c;->h(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;)V
...
.method private static parseNode(Lorg/xmlpull/v1/XmlPullParser;Ly2/b;Ljava/util/Map;Ly2/c$a;)Ly2/b;
    .locals 20
    .param p1    # Ly2/b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-static {v0, v3}, Ly2/c;->j(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlStyle;)Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    :pswitch_1
    invoke-static {v8}, Ly2/c;->k(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :pswitch_2
    invoke-static {v8, v1}, Ly2/c;->l(Ljava/lang/String;Ly2/c$a;)J
    ...
    invoke-static/range {v0 .. v9}, Ly2/b;->buildNode(Ljava/lang/String;JJLandroidx/media3/extractor/text/ttml/TtmlStyle;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ly2/b;)Ly2/b;
...
.method private static parseRegionAttributes(Lorg/xmlpull/v1/XmlPullParser;ILy2/c$b;Ljava/util/Map;)Ly2/d;
    .locals 17
    .param p2    # Ly2/c$b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct/range {v4 .. v14}, Ly2/d;-><init>(Ljava/lang/String;FFIIFFIFI)V
...
.method private static parseTtsExtent(Lorg/xmlpull/v1/XmlPullParser;)Ly2/c$b;
    .locals 5
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :cond_0
    sget-object v1, Ly2/c;->g:Ljava/util/regex/Pattern;
    ...
    invoke-direct {v4, v2, v1}, Ly2/c$b;-><init>(II)V
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a([BII)Ls2/j;
    ...
    :try_start_0
    iget-object v2, v1, Ly2/c;->a:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    invoke-direct {v3, v0}, Ly2/d;-><init>(Ljava/lang/String;)V
    ...
    sget-object v4, Ly2/c;->i:Ly2/c$a;
    ...
    invoke-static {v2}, Ly2/c;->g(Lorg/xmlpull/v1/XmlPullParser;)Ly2/c$a;

    move-result-object v4

    const/16 v13, 0xf

    invoke-static {v2, v13}, Ly2/c;->e(Lorg/xmlpull/v1/XmlPullParser;I)I

    move-result v5

    invoke-static {v2}, Ly2/c;->parseTtsExtent(Lorg/xmlpull/v1/XmlPullParser;)Ly2/c$b;
    ...
    :goto_2
    invoke-static {v7}, Ly2/c;->d(Ljava/lang/String;)Z
    ...
    invoke-static/range {v3 .. v8}, Ly2/c;->parseHeader(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;ILy2/c$b;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    :try_end_2
    ...
    :try_start_3
    invoke-static {v2, v6, v10, v13}, Ly2/c;->parseNode(Lorg/xmlpull/v1/XmlPullParser;Ly2/b;Ljava/util/Map;Ly2/c$a;)Ly2/b;
    ...
    invoke-virtual {v6, v0}, Ly2/b;->a(Ly2/b;)V
    :try_end_3
    ...
    invoke-static {v6}, Ly2/b;->c(Ljava/lang/String;)Ly2/b;

    move-result-object v6

    invoke-virtual {v0, v6}, Ly2/b;->a(Ly2/b;)V
    ...
    invoke-direct {v14, v0, v9, v10, v11}, Ly2/f;-><init>(Ly2/b;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
...
.method public c([BIILs2/r$b;Landroidx/media3/common/util/Consumer;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Ly2/c;->a([BII)Ls2/j;
