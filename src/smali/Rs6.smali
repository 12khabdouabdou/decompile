...
# direct methods
.method public constructor <init>(ZLjava/util/UUID;Lgoc;Lltc;)V
    .locals 0
    ...
    .line 3
    .line 4
    iput-boolean p1, p0, LRs6;->a:Z

    .line 5
    .line 6
    iput-object p2, p0, LRs6;->b:Ljava/util/UUID;

    .line 7
    .line 8
    iput-object p3, p0, LRs6;->c:Lgoc;

    .line 9
    .line 10
    iput-object p4, p0, LRs6;->d:Lltc;
...
.method public final a(Lcom/snapchat/client/network_types/RequestResponseInfo;)V
    ...
    .line 64
    :goto_3
    iput-wide v10, v0, LRs6;->f:J

    .line 65
    .line 66
    iput-wide v14, v0, LRs6;->g:J

    .line 67
    .line 68
    iget-object v6, v0, LRs6;->c:Lgoc;

    .line 69
    .line 70
    iget-object v7, v0, LRs6;->b:Ljava/util/UUID;

    .line 71
    .line 72
    iget-wide v12, v0, LRs6;->e:J

    .line 73
    .line 74
    invoke-virtual/range {v6 .. v15}, Lgoc;->a(Ljava/util/UUID;JJJJ)V
...
.method public final b(Lcom/snapchat/client/network_types/RequestResponseInfo;Z)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1}, LRs6;->a(Lcom/snapchat/client/network_types/RequestResponseInfo;)V
    ...
    .line 14
    invoke-direct {v3, p2}, LAZe;-><init>(I)V
    ...
    .line 29
    iget-object v0, p0, LRs6;->c:Lgoc;

    .line 30
    .line 31
    iget-object v1, p0, LRs6;->b:Ljava/util/UUID;
...
.method public final c(Lcom/snapchat/client/network_types/RequestResponseInfo;Lcom/snapchat/client/network_types/Error;ZZ)V
    ...
    .line 21
    invoke-interface {v0, v1, p4}, Lltc;->b(ILjava/lang/Integer;)I
    ...
    .line 26
    .line 27
    invoke-static {p2}, Lpl4;->g(Lcom/snapchat/client/network_types/Error;)LVmc;
    ...
    .line 47
    invoke-direct {v0, p4, p2}, LAZe;-><init>(II)V
    ...
    .line 52
    :cond_3
    invoke-direct {v0, p4}, LAZe;-><init>(I)V
    ...
    .line 68
    iget-object v1, p0, LRs6;->c:Lgoc;

    .line 69
    .line 70
    iget-object v2, p0, LRs6;->b:Ljava/util/UUID;
    ...
    .line 73
    invoke-virtual/range {v1 .. v7}, Lgoc;->d(Ljava/util/UUID;LVmc;LAZe;LE46;Lcom/snapchat/client/network_types/DebugInfo;Z)V
