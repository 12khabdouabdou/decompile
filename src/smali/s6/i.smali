...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ls6/i;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ls6/i;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Ls6/g;->e(Landroid/content/Context;I)I
    ...
    invoke-virtual {v1, p0, p1, v0}, Ls6/g;->getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static c(I)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Ls6/b;->r(I)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ls6/j;->a(Landroid/content/Context;)Ls6/j;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Ls6/j;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Ls6/j;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ls6/i;->c:Z
    ...
    :cond_0
    sput-boolean v1, Ls6/i;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, Ls6/i;->d:Z
    ...
    :cond_1
    :goto_3
    sget-boolean p0, Ls6/i;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lx6/h;->b()Z
...
.method public static e(Landroid/content/Context;I)I
    ...
    sget v2, Ls6/k;->common_google_play_services_unknown_issue:I
    ...
    sget-object v1, Ls6/i;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lx6/h;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Ls6/j;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Ls6/j;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lx6/q;->a(I)I

    move-result p0

    invoke-static {p1}, Lx6/q;->a(I)I
...
.method public static f(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ls6/i;->j(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Ls6/g;->getErrorResolutionPendingIntent(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public static getGooglePlayServicesAvailabilityRecoveryIntent(I)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v1, p0, v1}, Ls6/g;->getErrorResolutionIntent(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static i(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lx6/o;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method public static j(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ls6/i;->g(Landroid/content/Context;)Z
