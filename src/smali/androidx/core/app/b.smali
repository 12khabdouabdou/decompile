...
.method public static getPermissionCompatDelegate()Landroidx/core/app/b$i;
    .locals 1
...
.method public static j(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    instance-of v0, p0, Landroidx/core/app/b$j;

    if-eqz v0, :cond_7

    move-object v0, p0

    check-cast v0, Landroidx/core/app/b$j;

    invoke-interface {v0, p2}, Landroidx/core/app/b$j;->e(I)V
    ...
    :cond_8
    instance-of p1, p0, Landroidx/core/app/b$h;
...
.method public static k(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Landroidx/core/app/b$g;->a(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1}, Landroidx/core/app/b$f;->b(Landroid/app/Activity;Ljava/lang/String;)Z
...
.method public static requestDragAndDropPermissions(Landroid/app/Activity;Landroid/view/DragEvent;)Landroidx/core/view/t;
    .locals 0
    .param p0    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1}, Landroidx/core/view/t;->request(Landroid/app/Activity;Landroid/view/DragEvent;)Landroidx/core/view/t;
...
.method public static setEnterSharedElementCallback(Landroid/app/Activity;Landroidx/core/app/e0;)V
    .locals 0
    .param p0    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static setExitSharedElementCallback(Landroid/app/Activity;Landroidx/core/app/e0;)V
    .locals 0
    .param p0    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static setLocusContext(Landroid/app/Activity;Lg0/b;Landroid/os/Bundle;)V
    .locals 2
    .param p0    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/app/b$e;->setLocusContext(Landroid/app/Activity;Lg0/b;Landroid/os/Bundle;)V

    :cond_0
    return-void
.end method

.method public static setPermissionCompatDelegate(Landroidx/core/app/b$i;)V
    .locals 0
    .param p0    # Landroidx/core/app/b$i;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
