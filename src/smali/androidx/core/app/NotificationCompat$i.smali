...
.method private static asIconCompat(Landroid/os/Parcelable;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {p0}, Landroidx/core/app/q;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroidx/core/app/r;->a(Ljava/lang/Object;)Landroid/graphics/drawable/Icon;
...
.method public static getPictureIcon(Landroid/os/Bundle;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v0}, Landroidx/core/app/NotificationCompat$i;->asIconCompat(Landroid/os/Parcelable;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {p0}, Landroidx/core/app/NotificationCompat$i;->asIconCompat(Landroid/os/Parcelable;)Landroidx/core/graphics/drawable/IconCompat;
...
.method public apply(Landroidx/core/app/m;)V
    ...
    instance-of v1, p1, Landroidx/core/app/x;
    ...
    invoke-virtual {v1}, Landroidx/core/app/x;->e()Landroid/content/Context;
    ...
    invoke-virtual {p1}, Landroidx/core/app/x;->e()Landroid/content/Context;
    ...
    :cond_7
    :goto_2
    iget-boolean p1, p0, Landroidx/core/app/NotificationCompat$p;->mSummaryTextSet:Z

    if-eqz p1, :cond_8

    iget-object p1, p0, Landroidx/core/app/NotificationCompat$p;->mSummaryText:Ljava/lang/CharSequence;
...
.method public bigLargeIcon(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
...
.method public bigLargeIcon(Landroid/graphics/drawable/Icon;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
...
.method public bigPicture(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
    .param p1    # Landroid/graphics/Bitmap;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public bigPicture(Landroid/graphics/drawable/Icon;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
    .param p1    # Landroid/graphics/drawable/Icon;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public restoreFromCompatExtras(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-static {p1}, Landroidx/core/app/NotificationCompat$i;->getPictureIcon(Landroid/os/Bundle;)Landroidx/core/graphics/drawable/IconCompat;
...
.method public setBigContentTitle(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
...
.method public setContentDescription(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
    .param p1    # Ljava/lang/CharSequence;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
...
.method public setSummaryText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$i;
    .locals 0
    .param p1    # Ljava/lang/CharSequence;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p1, p0, Landroidx/core/app/NotificationCompat$p;->mSummaryText:Ljava/lang/CharSequence;

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroidx/core/app/NotificationCompat$p;->mSummaryTextSet:Z
