...
.method public static e(Landroid/widget/TextView;)Lp0/m$b;
    .locals 4
    ...
    invoke-direct {v0, p0}, Lp0/m$b;-><init>(Landroid/text/PrecomputedText$Params;)V

    return-object v0

    :cond_0
    new-instance v1, Lp0/m$b$a;
    ...
    invoke-direct {v1, v2}, Lp0/m$b$a;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v1, v0}, Lp0/m$b$a;->b(I)Lp0/m$b$a;

    invoke-static {p0}, Landroidx/core/widget/TextViewCompat$a;->d(Landroid/widget/TextView;)I

    move-result v0

    invoke-virtual {v1, v0}, Lp0/m$b$a;->c(I)Lp0/m$b$a;
    ...
    invoke-virtual {v1, p0}, Lp0/m$b$a;->d(Landroid/text/TextDirectionHeuristic;)Lp0/m$b$a;

    invoke-virtual {v1}, Lp0/m$b$a;->a()Lp0/m$b;
...
.method public static getCompoundDrawableTintList(Landroid/widget/TextView;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {p0}, Lv0/o;->getSupportCompoundDrawablesTintList()Landroid/content/res/ColorStateList;
...
.method public static getCompoundDrawableTintMode(Landroid/widget/TextView;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface {p0}, Lv0/o;->getSupportCompoundDrawablesTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public static j(Landroid/widget/TextView;Lp0/m;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lp0/m;->getPrecomputedText()Landroid/text/PrecomputedText;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/core/widget/TextViewCompat;->e(Landroid/widget/TextView;)Lp0/m$b;

    move-result-object v0

    invoke-virtual {p1}, Lp0/m;->b()Lp0/m$b;

    move-result-object v1

    invoke-virtual {v0, v1}, Lp0/m$b;->a(Lp0/m$b;)Z
...
.method public static k(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, Lv0/j;->a(Landroid/widget/TextView;I)V
...
.method public static l(Landroid/widget/TextView;Lp0/m$b;)V
    .locals 2
...
.method public static setCompoundDrawableTintList(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {p0, p1}, Lv0/o;->setSupportCompoundDrawablesTintList(Landroid/content/res/ColorStateList;)V
...
.method public static setCompoundDrawableTintMode(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, Lv0/o;->setSupportCompoundDrawablesTintMode(Landroid/graphics/PorterDuff$Mode;)V
