...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar$f;->r:Landroidx/appcompat/widget/Toolbar;
...
.method public c(Z)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$f;->q:Landroidx/appcompat/view/menu/f;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$f;->p:Landroidx/appcompat/view/menu/d;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar$f;->p:Landroidx/appcompat/view/menu/d;

    invoke-virtual {v1, v0}, Landroidx/appcompat/view/menu/d;->getItem(I)Landroid/view/MenuItem;

    move-result-object v1

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$f;->q:Landroidx/appcompat/view/menu/f;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$f;->q:Landroidx/appcompat/view/menu/f;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$f;->collapseItemActionView(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/view/menu/f;)Z
...
.method public collapseItemActionView(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/view/menu/f;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$f;->r:Landroidx/appcompat/widget/Toolbar;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$f;->q:Landroidx/appcompat/view/menu/f;
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/view/menu/f;->p(Z)V
...
.method public expandItemActionView(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/view/menu/f;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$f;->r:Landroidx/appcompat/widget/Toolbar;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$f;->q:Landroidx/appcompat/view/menu/f;
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/Toolbar$f;->r:Landroidx/appcompat/widget/Toolbar;
    ...
    invoke-virtual {p2}, Landroidx/appcompat/widget/Toolbar;->N()V
...
.method public initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/d;)V
    ...
    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$f;->p:Landroidx/appcompat/view/menu/d;
