...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    .line 1
    sget v0, Le/h;->abc_action_bar_up_description:I

    sget v1, Le/e;->abc_ic_ab_back_material:I
...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;ZII)V
    ...
    sget-object v0, Le/j;->ActionBar:[I

    sget v1, Le/a;->actionBarStyle:I

    const/4 v2, 0x0

    invoke-static {p1, v2, v0, v1, p4}, Lm/q0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lm/q0;

    move-result-object p1

    sget v0, Le/j;->ActionBar_homeAsUpIndicator:I
    ...
    sget p2, Le/j;->ActionBar_title:I

    invoke-virtual {p1, p2}, Lm/q0;->o(I)Ljava/lang/CharSequence;
    ...
    :cond_1
    sget p2, Le/j;->ActionBar_subtitle:I
    ...
    :cond_2
    sget p2, Le/j;->ActionBar_logo:I

    invoke-virtual {p1, p2}, Lm/q0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    if-eqz p2, :cond_3

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/c;->B(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    sget p2, Le/j;->ActionBar_icon:I
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/c;->w(Landroid/graphics/drawable/Drawable;)V

    :cond_5
    sget p2, Le/j;->ActionBar_displayOptions:I

    invoke-virtual {p1, p2, p4}, Lm/q0;->j(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/c;->i(I)V

    sget p2, Le/j;->ActionBar_customNavigationLayout:I

    invoke-virtual {p1, p2, p4}, Lm/q0;->m(II)I
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/c;->z(Landroid/view/View;)V
    ...
    :cond_6
    sget p2, Le/j;->ActionBar_height:I

    invoke-virtual {p1, p2, p4}, Lm/q0;->l(II)I
    ...
    :cond_7
    sget p2, Le/j;->ActionBar_contentInsetStart:I

    const/4 v0, -0x1

    invoke-virtual {p1, p2, v0}, Lm/q0;->e(II)I

    move-result p2

    sget v1, Le/j;->ActionBar_contentInsetEnd:I

    invoke-virtual {p1, v1, v0}, Lm/q0;->e(II)I
    ...
    :cond_9
    sget p2, Le/j;->ActionBar_titleTextStyle:I
    ...
    :cond_a
    sget p2, Le/j;->ActionBar_subtitleTextStyle:I
    ...
    :cond_b
    sget p2, Le/j;->ActionBar_popupTheme:I
    ...
    :cond_c
    invoke-virtual {p0}, Landroidx/appcompat/widget/c;->y()I
    ...
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/c;->A(I)V
...
.method public A(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/c;->C(I)V
...
.method public C(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/c;->j(Ljava/lang/CharSequence;)V
...
.method public l(I)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/c;->B(Landroid/graphics/drawable/Drawable;)V
...
.method public n(IJ)Landroidx/core/view/l1;
    .locals 2
    ...
    invoke-virtual {v0, p2, p3}, Landroidx/core/view/l1;->f(J)Landroidx/core/view/l1;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/view/l1;->setListener(Landroidx/core/view/m1;)Landroidx/core/view/l1;
...
.method public o(Landroidx/appcompat/view/menu/h$a;Landroidx/appcompat/view/menu/d$a;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/c;->a:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/Toolbar;->setMenuCallbacks(Landroidx/appcompat/view/menu/h$a;Landroidx/appcompat/view/menu/d$a;)V
...
.method public setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/h$a;)V
    ...
    sget v1, Le/f;->action_menu_presenter:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/a;->m(I)V

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/c;->n:Landroidx/appcompat/widget/a;

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/a;->setCallback(Landroidx/appcompat/view/menu/h$a;)V
    ...
    invoke-virtual {p2, p1, v0}, Landroidx/appcompat/widget/Toolbar;->setMenu(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/widget/a;)V
