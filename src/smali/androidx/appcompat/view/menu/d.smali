...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->g0(Z)V
...
.method public L(Landroidx/appcompat/view/menu/f;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->N(Z)V
...
.method public O(Landroid/view/MenuItem;I)Z
    ...
    invoke-virtual {p0, p1, v0, p2}, Landroidx/appcompat/view/menu/d;->P(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/h;I)Z
...
.method public P(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/h;I)Z
    .locals 6
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/f;->getSupportActionProvider()Landroidx/core/view/b;
    ...
    invoke-virtual {p1, p3}, Landroidx/appcompat/view/menu/f;->v(Landroidx/appcompat/view/menu/k;)V
...
.method public R(Landroidx/appcompat/view/menu/h;)V
    .locals 3
...
.method public U(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/appcompat/view/menu/d;->U(Landroid/os/Bundle;)V
...
.method public W(Landroidx/appcompat/view/menu/d$a;)V
    .locals 0
...
.method public X(I)Landroidx/appcompat/view/menu/d;
    .locals 0
...
.method public Y(Landroid/view/MenuItem;)V
    ...
    :goto_1
    invoke-virtual {v4, v5}, Landroidx/appcompat/view/menu/f;->q(Z)V
...
.method public Z(I)Landroidx/appcompat/view/menu/d;
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/appcompat/view/menu/d;->b0(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
...
.method public a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/view/menu/f;->t(Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/d;->N(Z)V

    return-object p1
.end method

.method public a0(Landroid/graphics/drawable/Drawable;)Landroidx/appcompat/view/menu/d;
    .locals 6
...
.method public c(Landroidx/appcompat/view/menu/h;Landroid/content/Context;)V
    ...
    invoke-interface {p1, p2, p0}, Landroidx/appcompat/view/menu/h;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/d;)V
...
.method public c0(I)Landroidx/appcompat/view/menu/d;
    .locals 6
...
.method public clear()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/d;->N(Z)V
...
.method public d0(Ljava/lang/CharSequence;)Landroidx/appcompat/view/menu/d;
    .locals 6
...
.method public final e(Z)V
    ...
    :cond_1
    invoke-interface {v2, p0, p1}, Landroidx/appcompat/view/menu/h;->onCloseMenu(Landroidx/appcompat/view/menu/d;Z)V
...
.method public e0(Landroid/view/View;)Landroidx/appcompat/view/menu/d;
    .locals 6
...
.method public f(Landroidx/appcompat/view/menu/f;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/h;->collapseItemActionView(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/view/menu/f;)Z
...
.method public final g0(Z)V
    ...
    invoke-static {p1, v1}, Landroidx/core/view/h1;->l(Landroid/view/ViewConfiguration;Landroid/content/Context;)Z
...
.method public final i(Z)V
    ...
    :cond_1
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/h;->c(Z)V
...
.method public final j(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v2}, Landroidx/appcompat/view/menu/h;->getId()I
    ...
    invoke-interface {v2, v1}, Landroidx/appcompat/view/menu/h;->e(Landroid/os/Parcelable;)V
...
.method public final k(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v3}, Landroidx/appcompat/view/menu/h;->getId()I

    move-result v2

    if-lez v2, :cond_1

    invoke-interface {v3}, Landroidx/appcompat/view/menu/h;->f()Landroid/os/Parcelable;
...
.method public final l(Landroidx/appcompat/view/menu/k;Landroidx/appcompat/view/menu/h;)Z
    ...
    invoke-interface {p2, p1}, Landroidx/appcompat/view/menu/h;->onSubMenuSelected(Landroidx/appcompat/view/menu/k;)Z
    ...
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/h;->onSubMenuSelected(Landroidx/appcompat/view/menu/k;)Z
...
.method public m(Landroidx/appcompat/view/menu/f;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/h;->expandItemActionView(Landroidx/appcompat/view/menu/d;Landroidx/appcompat/view/menu/f;)Z
...
.method public performIdentifierAction(II)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/view/menu/d;->O(Landroid/view/MenuItem;I)Z
...
.method public performShortcut(ILandroid/view/KeyEvent;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Landroidx/appcompat/view/menu/d;->O(Landroid/view/MenuItem;I)Z
...
.method public r(ILandroid/view/KeyEvent;)Landroidx/appcompat/view/menu/f;
    ...
    :cond_1
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->J()Z
...
.method public removeGroup(I)V
    ...
    invoke-virtual {p0, v0, v2}, Landroidx/appcompat/view/menu/d;->Q(IZ)V
...
.method public removeItem(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/view/menu/d;->Q(IZ)V
...
.method public setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v2, p3}, Landroidx/appcompat/view/menu/f;->r(Z)V
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {v4, p2}, Landroidx/appcompat/view/menu/f;->w(Z)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/appcompat/view/menu/d;->N(Z)V
...
.method public t()V
    ...
    :cond_1
    invoke-interface {v5}, Landroidx/appcompat/view/menu/h;->d()Z
    ...
    invoke-virtual {v4}, Landroidx/appcompat/view/menu/f;->j()Z
