...
.method public final a()Ll/d;
    ...
    sget v2, Le/d;->abc_cascading_menus_min_smallest_width:I
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/g;->j:Ll/d;
...
.method public c()Ll/d;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/g;->a()Ll/d;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/g;->j:Ll/d;
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Ll/d;->m(Z)V
...
.method public final j(IIZZ)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/g;->c()Ll/d;

    move-result-object v0

    invoke-virtual {v0, p4}, Ll/d;->q(Z)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Ll/d;->o(I)V

    invoke-virtual {v0, p2}, Ll/d;->r(I)V
    ...
    invoke-virtual {v0, p4}, Ll/d;->l(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Ll/f;->b()V
...
.method public k()Z
    ...
    :cond_1
    invoke-virtual {p0, v2, v2, v2, v2}, Landroidx/appcompat/view/menu/g;->j(IIZZ)V
...
.method public l(II)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, v1, v1}, Landroidx/appcompat/view/menu/g;->j(IIZZ)V
...
.method public setPresenterCallback(Landroidx/appcompat/view/menu/h$a;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/h;->setCallback(Landroidx/appcompat/view/menu/h$a;)V
