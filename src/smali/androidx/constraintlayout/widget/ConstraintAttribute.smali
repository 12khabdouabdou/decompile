...
.method public static i(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashMap;)V
    ...
    sget-object v0, Lb0/d;->CustomAttribute:[I
    ...
    sget v8, Lb0/d;->CustomAttribute_attributeName:I
    ...
    :cond_0
    sget v8, Lb0/d;->CustomAttribute_methodName:I
    ...
    :cond_1
    sget v8, Lb0/d;->CustomAttribute_customBoolean:I
    ...
    sget-object v4, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->u:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;

    goto/16 :goto_5

    :cond_2
    sget v8, Lb0/d;->CustomAttribute_customColorValue:I

    if-ne v7, v8, :cond_4

    sget-object v3, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->r:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;
    ...
    :cond_4
    sget v8, Lb0/d;->CustomAttribute_customColorDrawableValue:I
    ...
    :cond_5
    sget v8, Lb0/d;->CustomAttribute_customPixelDimension:I

    const/4 v10, 0x0

    if-ne v7, v8, :cond_6

    sget-object v3, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->v:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;
    ...
    :cond_6
    sget v8, Lb0/d;->CustomAttribute_customDimension:I
    ...
    :cond_7
    sget v8, Lb0/d;->CustomAttribute_customFloatValue:I

    if-ne v7, v8, :cond_8

    sget-object v3, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->q:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;
    ...
    :cond_8
    sget v8, Lb0/d;->CustomAttribute_customIntegerValue:I
    ...
    :cond_9
    sget v8, Lb0/d;->CustomAttribute_customStringValue:I

    if-ne v7, v8, :cond_a

    sget-object v3, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->t:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;
    ...
    :cond_a
    sget v8, Lb0/d;->CustomAttribute_customReference:I

    if-ne v7, v8, :cond_b

    sget-object v3, Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;->w:Landroidx/constraintlayout/widget/ConstraintAttribute$AttributeType;
