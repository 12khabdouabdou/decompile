...
.method public constructor <init>(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)V
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Landroidx/browser/customtabs/g;->mCallbackBinder:Landroid/support/customtabs/ICustomTabsCallback;

    iput-object p2, p0, Landroidx/browser/customtabs/g;->mSessionId:Landroid/app/PendingIntent;
    ...
    :cond_2
    new-instance p1, Landroidx/browser/customtabs/g$a;

    invoke-direct {p1, p0}, Landroidx/browser/customtabs/g$a;-><init>(Landroidx/browser/customtabs/g;)V

    :goto_1
    iput-object p1, p0, Landroidx/browser/customtabs/g;->mCallback:Landroidx/browser/customtabs/CustomTabsCallback;

    return-void
.end method

.method public static getSessionTokenFromIntent(Landroid/content/Intent;)Landroidx/browser/customtabs/g;
    .locals 3
    ...
    invoke-direct {v0, v1, p0}, Landroidx/browser/customtabs/g;-><init>(Landroid/support/customtabs/ICustomTabsCallback;Landroid/app/PendingIntent;)V
...
.method public final a()Landroid/os/IBinder;
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/g;->mCallbackBinder:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Landroidx/browser/customtabs/g;->getId()Landroid/app/PendingIntent;

    move-result-object v0

    iget-object v2, p0, Landroidx/browser/customtabs/g;->mSessionId:Landroid/app/PendingIntent;
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/browser/customtabs/g;->a()Landroid/os/IBinder;
...
.method public getCallback()Landroidx/browser/customtabs/CustomTabsCallback;
    ...
    iget-object v0, p0, Landroidx/browser/customtabs/g;->mCallback:Landroidx/browser/customtabs/CustomTabsCallback;
...
.method public getId()Landroid/app/PendingIntent;
    ...
    iget-object v0, p0, Landroidx/browser/customtabs/g;->mSessionId:Landroid/app/PendingIntent;
