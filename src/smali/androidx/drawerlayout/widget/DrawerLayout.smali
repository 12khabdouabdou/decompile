...
.field public final p:Landroidx/drawerlayout/widget/DrawerLayout$d;
...
.field public final v:Lz0/c;

.field public final w:Lz0/c;

.field public final x:Landroidx/drawerlayout/widget/DrawerLayout$i;

.field public final y:Landroidx/drawerlayout/widget/DrawerLayout$i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Lg1/a;->drawerLayoutStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->b0:Lr0/p0;
    ...
    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->x:Landroidx/drawerlayout/widget/DrawerLayout$i;
    ...
    iput-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->y:Landroidx/drawerlayout/widget/DrawerLayout$i;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-static {p0, v4, v3}, Lz0/c;->n(Landroid/view/ViewGroup;FLz0/c$c;)Lz0/c;

    move-result-object v5

    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {v5, v0}, Lz0/c;->J(I)V

    invoke-virtual {v5, v2}, Lz0/c;->K(F)V

    invoke-virtual {v3, v5}, Landroidx/drawerlayout/widget/DrawerLayout$i;->q(Lz0/c;)V

    invoke-static {p0, v4, v1}, Lz0/c;->n(Landroid/view/ViewGroup;FLz0/c$c;)Lz0/c;

    move-result-object v3

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, Lz0/c;->J(I)V

    invoke-virtual {v3, v2}, Lz0/c;->K(F)V

    invoke-virtual {v1, v3}, Landroidx/drawerlayout/widget/DrawerLayout$i;->q(Lz0/c;)V
    ...
    :cond_0
    :goto_0
    sget-object v1, Lg1/c;->DrawerLayout:[I
    ...
    :try_start_1
    sget p2, Lg1/c;->DrawerLayout_elevation:I
    ...
    sget p3, Lg1/b;->def_drawer_elevation:I
...
.method public final C(FFLandroid/view/View;)Z
    .locals 1
...
.method public final D(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p1}, Lk0/a;->f(Landroid/graphics/drawable/Drawable;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1, p2}, Lk0/a;->k(Landroid/graphics/drawable/Drawable;I)Z
...
.method public G(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, Lz0/c;->N(Landroid/view/View;II)Z

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;
    ...
    invoke-virtual {p2, p1, v0, v1}, Lz0/c;->N(Landroid/view/View;II)Z

    goto :goto_0

    :cond_2
    invoke-virtual {p0, p1, v2}, Landroidx/drawerlayout/widget/DrawerLayout;->E(Landroid/view/View;F)V
...
.method public H(Landroidx/drawerlayout/widget/DrawerLayout$e;)V
    .locals 1
...
.method public final I()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/drawerlayout/widget/DrawerLayout;->D(Landroid/graphics/drawable/Drawable;I)V
...
.method public final K()V
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->I()Landroid/graphics/drawable/Drawable;
...
.method public final M(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Lr0/k0$a;->b()I
    ...
    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->b0:Lr0/p0;

    invoke-static {p1, v0, v1, v2}, Landroidx/core/view/ViewCompat;->replaceAccessibilityAction(Landroid/view/View;Lr0/k0$a;Ljava/lang/CharSequence;Lr0/p0;)V
...
.method public O(ILandroid/view/View;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {v0}, Lz0/c;->y()I

    move-result v0

    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;

    invoke-virtual {v1}, Lz0/c;->y()I
...
.method public computeScroll()V
    ...
    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;

    invoke-virtual {v2, v1}, Lz0/c;->m(Z)Z
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v1, v2, v4}, Landroidx/drawerlayout/widget/DrawerLayout;->C(FFLandroid/view/View;)Z
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {v8}, Lz0/c;->v()I
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;

    invoke-virtual {v10}, Lz0/c;->v()I
...
.method public e(Landroid/view/View;Z)V
    ...
    :cond_2
    invoke-virtual {p0, p1, v3}, Landroidx/drawerlayout/widget/DrawerLayout;->E(Landroid/view/View;F)V
...
.method public g(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;
    ...
    invoke-virtual {v7, v4, v6, v8}, Lz0/c;->N(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;
    ...
    invoke-virtual {v6, v4, v7, v8}, Lz0/c;->N(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->x:Landroidx/drawerlayout/widget/DrawerLayout$i;

    invoke-virtual {p1}, Landroidx/drawerlayout/widget/DrawerLayout$i;->p()V

    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->y:Landroidx/drawerlayout/widget/DrawerLayout$i;
...
.method public final k(Landroid/view/MotionEvent;Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/drawerlayout/widget/DrawerLayout;->s(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {v1, p1}, Lz0/c;->M(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;

    invoke-virtual {v2, p1}, Lz0/c;->M(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {p1, v4}, Lz0/c;->d(I)Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, Lz0/c;->findTopChildUnder(II)Landroid/view/View;
    ...
    invoke-virtual {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->v()Z
...
.method public onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Lh1/a;->a(Landroidx/drawerlayout/widget/DrawerLayout;)Landroid/view/WindowInsets;

    move-result-object v1

    if-eqz v1, :cond_c

    invoke-static {v1}, Landroidx/core/view/WindowInsetsCompat;->s(Landroid/view/WindowInsets;)Landroidx/core/view/WindowInsetsCompat;

    move-result-object v1

    invoke-virtual {v1}, Landroidx/core/view/WindowInsetsCompat;->g()Lj0/c;

    move-result-object v1

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    invoke-virtual {v2}, Lz0/c;->u()I

    move-result v3

    iget v4, v1, Lj0/c;->a:I

    invoke-static {v3, v4}, Ljava/lang/Math;->max(II)I

    move-result v3

    invoke-virtual {v2, v3}, Lz0/c;->I(I)V

    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;
    ...
    invoke-virtual {v2, v1}, Lz0/c;->I(I)V
...
.method public onMeasure(II)V
    ...
    invoke-static {v15, v7}, Landroidx/core/view/u;->b(II)I
    ...
    invoke-static {v12}, Landroidx/core/view/ViewCompat;->o(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, Landroidx/core/view/ViewCompat;->Y(Landroid/view/View;F)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget v0, p1, Landroidx/drawerlayout/widget/DrawerLayout$g;->r:I
    ...
    :cond_1
    iget v0, p1, Landroidx/drawerlayout/widget/DrawerLayout$g;->s:I
    ...
    :cond_2
    iget v0, p1, Landroidx/drawerlayout/widget/DrawerLayout$g;->t:I
    ...
    :cond_3
    iget v0, p1, Landroidx/drawerlayout/widget/DrawerLayout$g;->u:I
    ...
    :cond_4
    iget p1, p1, Landroidx/drawerlayout/widget/DrawerLayout$g;->v:I
...
.method public onRtlPropertiesChanged(I)V
    ...
    invoke-virtual {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->K()V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput v0, v1, Landroidx/drawerlayout/widget/DrawerLayout$g;->s:I

    iget v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->D:I

    iput v0, v1, Landroidx/drawerlayout/widget/DrawerLayout$g;->t:I

    iget v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->E:I

    iput v0, v1, Landroidx/drawerlayout/widget/DrawerLayout$g;->u:I

    iget v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->F:I

    iput v0, v1, Landroidx/drawerlayout/widget/DrawerLayout$g;->v:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lz0/c;->C(Landroid/view/MotionEvent;)V

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->w:Lz0/c;
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->v:Lz0/c;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, Lz0/c;->findTopChildUnder(II)Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_2

    invoke-virtual {p0, v3}, Landroidx/drawerlayout/widget/DrawerLayout;->y(Landroid/view/View;)Z
...
.method public final s(Landroid/view/MotionEvent;Landroid/view/View;)Landroid/view/MotionEvent;
    .locals 3
...
.method public setDrawerElevation(F)V
    ...
    invoke-virtual {p0, v0}, Landroidx/drawerlayout/widget/DrawerLayout;->A(Landroid/view/View;)Z
    ...
    invoke-static {v0, v1}, Landroidx/core/view/ViewCompat;->Y(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroidx/drawerlayout/widget/DrawerLayout$e;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/drawerlayout/widget/DrawerLayout;->H(Landroidx/drawerlayout/widget/DrawerLayout$e;)V
...
.method public setDrawerLockMode(II)V
    ...
    invoke-static {p2, v0}, Landroidx/core/view/u;->b(II)I
...
.method public setDrawerLockMode(ILandroid/view/View;)V
    ...
    .line 3
    invoke-virtual {p0, p2}, Landroidx/drawerlayout/widget/DrawerLayout;->A(Landroid/view/View;)Z
