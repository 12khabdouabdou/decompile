...
.method public constructor <init>(Ljava/util/List;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Landroidx/media3/extractor/ts/g;->b:Ljava/lang/String;
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/g;->c:[Landroidx/media3/extractor/TrackOutput;

    const-wide p1, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide p1, p0, Landroidx/media3/extractor/ts/g;->g:J
...
.method public a()V
    ...
    iput-boolean v0, p0, Landroidx/media3/extractor/ts/g;->d:Z

    const-wide v0, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v0, p0, Landroidx/media3/extractor/ts/g;->g:J
...
.method public b(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/media3/extractor/ts/g;->d:Z
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media3/extractor/ts/g;->f(Landroidx/media3/common/util/ParsableByteArray;I)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/media3/extractor/ts/g;->f(Landroidx/media3/common/util/ParsableByteArray;I)Z
    ...
    iget-object v3, p0, Landroidx/media3/extractor/ts/g;->c:[Landroidx/media3/extractor/TrackOutput;
    ...
    :cond_2
    iget p1, p0, Landroidx/media3/extractor/ts/g;->f:I

    add-int/2addr p1, v2

    iput p1, p0, Landroidx/media3/extractor/ts/g;->f:I
...
.method public c(Z)V
    ...
    .line 1
    iget-boolean p1, p0, Landroidx/media3/extractor/ts/g;->d:Z

    if-eqz p1, :cond_2

    iget-wide v0, p0, Landroidx/media3/extractor/ts/g;->g:J
    ...
    iget-object v0, p0, Landroidx/media3/extractor/ts/g;->c:[Landroidx/media3/extractor/TrackOutput;
    ...
    iget-wide v4, p0, Landroidx/media3/extractor/ts/g;->g:J

    const/4 v6, 0x1

    iget v7, p0, Landroidx/media3/extractor/ts/g;->f:I
    ...
    :cond_1
    iput-boolean p1, p0, Landroidx/media3/extractor/ts/g;->d:Z
...
.method public d(Landroidx/media3/extractor/p;Landroidx/media3/extractor/ts/TsPayloadReader$c;)V
    ...
    :goto_0
    iget-object v1, p0, Landroidx/media3/extractor/ts/g;->c:[Landroidx/media3/extractor/TrackOutput;

    array-length v1, v1

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Landroidx/media3/extractor/ts/g;->a:Ljava/util/List;

    invoke-interface {v1, v0}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroidx/media3/extractor/ts/TsPayloadReader$a;
    ...
    iget-object v4, p0, Landroidx/media3/extractor/ts/g;->b:Ljava/lang/String;
    ...
    iget-object v4, v1, Landroidx/media3/extractor/ts/TsPayloadReader$a;->c:[B
    ...
    iget-object v1, v1, Landroidx/media3/extractor/ts/TsPayloadReader$a;->a:Ljava/lang/String;
...
.method public e(JI)V
    ...
    iput-boolean p3, p0, Landroidx/media3/extractor/ts/g;->d:Z
...
.method public final f(Landroidx/media3/common/util/ParsableByteArray;I)Z
    .locals 2
    ...
    iput-boolean v1, p0, Landroidx/media3/extractor/ts/g;->d:Z
