...
.method public constructor <init>(Ljava/util/List;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/v;->a:Ljava/util/List;

    iput-object p2, p0, Landroidx/media3/extractor/ts/v;->b:Ljava/lang/String;
    ...
    iput-object p1, p0, Landroidx/media3/extractor/ts/v;->c:[Landroidx/media3/extractor/TrackOutput;

    new-instance p1, Lt1/j;

    new-instance p2, Lc3/h;

    invoke-direct {p2, p0}, Lc3/h;-><init>(Landroidx/media3/extractor/ts/v;)V

    invoke-direct {p1, p2}, Lt1/j;-><init>(Lt1/j$b;)V

    iput-object p1, p0, Landroidx/media3/extractor/ts/v;->d:Lt1/j;

    return-void
.end method

.method public static synthetic a(Landroidx/media3/extractor/ts/v;JLandroidx/media3/common/util/ParsableByteArray;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/extractor/ts/v;->f(JLandroidx/media3/common/util/ParsableByteArray;)V
...
.method public b()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/media3/extractor/ts/v;->d:Lt1/j;
...
.method public c(JLandroidx/media3/common/util/ParsableByteArray;)V
    .locals 1
...
.method public d(Landroidx/media3/extractor/p;Landroidx/media3/extractor/ts/TsPayloadReader$c;)V
    ...
    :goto_0
    iget-object v2, p0, Landroidx/media3/extractor/ts/v;->c:[Landroidx/media3/extractor/TrackOutput;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/ts/v;->a:Ljava/util/List;
    ...
    iget-object v6, p0, Landroidx/media3/extractor/ts/v;->b:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/ts/v;->c:[Landroidx/media3/extractor/TrackOutput;
...
.method public final synthetic f(JLandroidx/media3/common/util/ParsableByteArray;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/media3/extractor/ts/v;->c:[Landroidx/media3/extractor/TrackOutput;
...
.method public g(I)V
    ...
    invoke-virtual {v0, p1}, Lt1/j;->g(I)V
