.class public Landroidx/media3/extractor/ts/TsExtractor$b;
...
# virtual methods
.method public final a(Landroidx/media3/common/util/ParsableByteArray;I)Landroidx/media3/extractor/ts/TsPayloadReader$EsInfo;
    .locals 17
    ...
    new-instance v12, Landroidx/media3/extractor/ts/TsPayloadReader$a;

    invoke-direct {v12, v7, v10, v13}, Landroidx/media3/extractor/ts/TsPayloadReader$a;-><init>(Ljava/lang/String;I[B)V
...
.method public b(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-static {v2}, Landroidx/media3/extractor/ts/TsExtractor;->c(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {v6}, Landroidx/media3/extractor/ts/TsExtractor;->i(Landroidx/media3/extractor/ts/TsExtractor;)Ljava/util/List;
    ...
    invoke-static {v2}, Landroidx/media3/extractor/ts/TsExtractor;->i(Landroidx/media3/extractor/ts/TsExtractor;)Ljava/util/List;
    ...
    invoke-static {v8, v9}, Landroidx/media3/extractor/ts/TsExtractor;->j(Landroidx/media3/extractor/ts/TsExtractor;I)I
    ...
    invoke-static {v8}, Landroidx/media3/extractor/ts/TsExtractor;->h(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {v8}, Landroidx/media3/extractor/ts/TsExtractor;->k(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/ts/TsPayloadReader;
    ...
    invoke-static {v14}, Landroidx/media3/extractor/ts/TsExtractor;->m(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/ts/TsPayloadReader$b;

    move-result-object v15

    invoke-interface {v15, v13, v8}, Landroidx/media3/extractor/ts/TsPayloadReader$b;->createPayloadReader(ILandroidx/media3/extractor/ts/TsPayloadReader$EsInfo;)Landroidx/media3/extractor/ts/TsPayloadReader;

    move-result-object v8

    invoke-static {v14, v8}, Landroidx/media3/extractor/ts/TsExtractor;->l(Landroidx/media3/extractor/ts/TsExtractor;Landroidx/media3/extractor/ts/TsPayloadReader;)Landroidx/media3/extractor/ts/TsPayloadReader;
    ...
    invoke-static {v14}, Landroidx/media3/extractor/ts/TsExtractor;->n(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/p;

    move-result-object v14

    new-instance v15, Landroidx/media3/extractor/ts/TsPayloadReader$c;

    invoke-direct {v15, v6, v13, v12}, Landroidx/media3/extractor/ts/TsPayloadReader$c;-><init>(III)V

    invoke-interface {v8, v2, v14, v15}, Landroidx/media3/extractor/ts/TsPayloadReader;->c(Landroidx/media3/common/util/TimestampAdjuster;Landroidx/media3/extractor/p;Landroidx/media3/extractor/ts/TsPayloadReader$c;)V
    ...
    invoke-virtual {v0, v1, v7}, Landroidx/media3/extractor/ts/TsExtractor$b;->a(Landroidx/media3/common/util/ParsableByteArray;I)Landroidx/media3/extractor/ts/TsPayloadReader$EsInfo;
    ...
    invoke-static {v7}, Landroidx/media3/extractor/ts/TsExtractor;->h(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {v10}, Landroidx/media3/extractor/ts/TsExtractor;->o(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseBooleanArray;
    ...
    invoke-static {v10}, Landroidx/media3/extractor/ts/TsExtractor;->h(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {v4}, Landroidx/media3/extractor/ts/TsExtractor;->k(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/ts/TsPayloadReader;
    ...
    invoke-static {v10}, Landroidx/media3/extractor/ts/TsExtractor;->m(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/ts/TsPayloadReader$b;

    move-result-object v10

    invoke-interface {v10, v4, v9}, Landroidx/media3/extractor/ts/TsPayloadReader$b;->createPayloadReader(ILandroidx/media3/extractor/ts/TsPayloadReader$EsInfo;)Landroidx/media3/extractor/ts/TsPayloadReader;
    ...
    invoke-static {v9}, Landroidx/media3/extractor/ts/TsExtractor;->h(Landroidx/media3/extractor/ts/TsExtractor;)I
    ...
    invoke-static {v9}, Landroidx/media3/extractor/ts/TsExtractor;->o(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseBooleanArray;
    ...
    invoke-static {v9}, Landroidx/media3/extractor/ts/TsExtractor;->p(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseBooleanArray;
    ...
    invoke-static {v10}, Landroidx/media3/extractor/ts/TsExtractor;->k(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/ts/TsPayloadReader;
    ...
    invoke-static {v10}, Landroidx/media3/extractor/ts/TsExtractor;->n(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/p;

    move-result-object v10

    new-instance v11, Landroidx/media3/extractor/ts/TsPayloadReader$c;

    invoke-direct {v11, v6, v7, v12}, Landroidx/media3/extractor/ts/TsPayloadReader$c;-><init>(III)V

    invoke-interface {v9, v2, v10, v11}, Landroidx/media3/extractor/ts/TsPayloadReader;->c(Landroidx/media3/common/util/TimestampAdjuster;Landroidx/media3/extractor/p;Landroidx/media3/extractor/ts/TsPayloadReader$c;)V

    :cond_d
    iget-object v7, v0, Landroidx/media3/extractor/ts/TsExtractor$b;->e:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {v7}, Landroidx/media3/extractor/ts/TsExtractor;->b(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseArray;
    ...
    invoke-static {v1}, Landroidx/media3/extractor/ts/TsExtractor;->d(Landroidx/media3/extractor/ts/TsExtractor;)Z
    ...
    invoke-static {v1}, Landroidx/media3/extractor/ts/TsExtractor;->n(Landroidx/media3/extractor/ts/TsExtractor;)Landroidx/media3/extractor/p;
    ...
    invoke-static {v1, v2}, Landroidx/media3/extractor/ts/TsExtractor;->f(Landroidx/media3/extractor/ts/TsExtractor;I)I

    :goto_7
    iget-object v1, v0, Landroidx/media3/extractor/ts/TsExtractor$b;->e:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {v1, v5}, Landroidx/media3/extractor/ts/TsExtractor;->e(Landroidx/media3/extractor/ts/TsExtractor;Z)Z
    ...
    invoke-static {v1}, Landroidx/media3/extractor/ts/TsExtractor;->b(Landroidx/media3/extractor/ts/TsExtractor;)Landroid/util/SparseArray;
    ...
    :goto_8
    invoke-static {v1, v4}, Landroidx/media3/extractor/ts/TsExtractor;->f(Landroidx/media3/extractor/ts/TsExtractor;I)I

    iget-object v1, v0, Landroidx/media3/extractor/ts/TsExtractor$b;->e:Landroidx/media3/extractor/ts/TsExtractor;

    invoke-static {v1}, Landroidx/media3/extractor/ts/TsExtractor;->c(Landroidx/media3/extractor/ts/TsExtractor;)I
