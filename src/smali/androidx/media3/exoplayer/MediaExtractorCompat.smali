...
.field private currentExtractorInput:Landroidx/media3/extractor/o;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private final extractorsFactory:Landroidx/media3/extractor/t;
...
.field private pendingSeek:Landroidx/media3/extractor/j0;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private final positionHolder:Landroidx/media3/extractor/h0;
...
.field private seekMap:Landroidx/media3/extractor/i0;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0, v1}, Landroidx/media3/exoplayer/MediaExtractorCompat;-><init>(Landroidx/media3/extractor/t;Landroidx/media3/datasource/DataSource$Factory;)V

    return-void
.end method

.method public constructor <init>(Landroidx/media3/extractor/t;Landroidx/media3/datasource/DataSource$Factory;)V
    .locals 1

    .line 2
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->extractorsFactory:Landroidx/media3/extractor/t;
    ...
    invoke-direct {p1}, Landroidx/media3/extractor/h0;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->positionHolder:Landroidx/media3/extractor/h0;
...
.method public static synthetic access$602(Landroidx/media3/exoplayer/MediaExtractorCompat;Landroidx/media3/extractor/i0;)Landroidx/media3/extractor/i0;
    .locals 0

    iput-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->seekMap:Landroidx/media3/extractor/i0;
...
.method private advanceToSampleOrEndOfInput()Z
    ...
    iget-object v6, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->currentExtractorInput:Landroidx/media3/extractor/o;
    ...
    iget-object v7, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->positionHolder:Landroidx/media3/extractor/h0;

    invoke-interface {v4, v6, v7}, Landroidx/media3/extractor/Extractor;->read(Landroidx/media3/extractor/o;Landroidx/media3/extractor/h0;)I
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->positionHolder:Landroidx/media3/extractor/h0;

    iget-wide v6, v4, Landroidx/media3/extractor/h0;->a:J

    invoke-direct {p0, v6, v7}, Landroidx/media3/exoplayer/MediaExtractorCompat;->reopenCurrentDataSource(J)Landroidx/media3/extractor/o;

    move-result-object v4

    iput-object v4, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->currentExtractorInput:Landroidx/media3/extractor/o;
    :try_end_1
...
.method private maybeResolvePendingSeek()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->pendingSeek:Landroidx/media3/extractor/j0;
    ...
    iget-wide v2, v0, Landroidx/media3/extractor/j0;->b:J

    iget-wide v4, v0, Landroidx/media3/extractor/j0;->a:J
    ...
    invoke-direct {p0, v0, v1}, Landroidx/media3/exoplayer/MediaExtractorCompat;->reopenCurrentDataSource(J)Landroidx/media3/extractor/o;

    move-result-object v0

    iput-object v0, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->currentExtractorInput:Landroidx/media3/extractor/o;

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->pendingSeek:Landroidx/media3/extractor/j0;
...
.method private populatePlatformCryptoInfoParameters(Landroid/media/MediaCodec$CryptoInfo;)V
    ...
    iget-object v0, v0, Landroidx/media3/decoder/DecoderInputBuffer;->cryptoInfo:Lv1/c;
    ...
    invoke-virtual {v0}, Lv1/c;->a()Landroid/media/MediaCodec$CryptoInfo;
...
.method private prepareDataSource(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;)V
    ...
    invoke-direct/range {v4 .. v9}, Landroidx/media3/extractor/i;-><init>(Landroidx/media3/common/DataReader;JJ)V

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/MediaExtractorCompat;->selectExtractor(Landroidx/media3/extractor/o;)Landroidx/media3/extractor/Extractor;
    ...
    invoke-interface {p2, v0}, Landroidx/media3/extractor/Extractor;->init(Landroidx/media3/extractor/p;)V
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->positionHolder:Landroidx/media3/extractor/h0;

    invoke-interface {p2, p1, v3}, Landroidx/media3/extractor/Extractor;->read(Landroidx/media3/extractor/o;Landroidx/media3/extractor/h0;)I
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->seekMap:Landroidx/media3/extractor/i0;
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->positionHolder:Landroidx/media3/extractor/h0;

    iget-wide v5, p1, Landroidx/media3/extractor/h0;->a:J

    invoke-direct {p0, v5, v6}, Landroidx/media3/exoplayer/MediaExtractorCompat;->reopenCurrentDataSource(J)Landroidx/media3/extractor/o;
    ...
    :cond_6
    iput-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->currentExtractorInput:Landroidx/media3/extractor/o;
...
.method private reopenCurrentDataSource(J)Landroidx/media3/extractor/o;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/media3/extractor/i;-><init>(Landroidx/media3/common/DataReader;JJ)V

    return-object v0
.end method

.method private selectExtractor(Landroidx/media3/extractor/o;)Landroidx/media3/extractor/Extractor;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->extractorsFactory:Landroidx/media3/extractor/t;

    invoke-interface {v0}, Landroidx/media3/extractor/t;->a()[Landroidx/media3/extractor/Extractor;
    ...
    :try_start_0
    invoke-interface {v3, p1}, Landroidx/media3/extractor/Extractor;->sniff(Landroidx/media3/extractor/o;)Z
    ...
    invoke-static {v2}, Lcom/google/common/base/f;->g(Ljava/lang/String;)Lcom/google/common/base/f;
    ...
    new-instance v3, Landroidx/media3/exoplayer/j3;

    invoke-direct {v3}, Landroidx/media3/exoplayer/j3;-><init>()V

    invoke-static {v0, v3}, Lcom/google/common/collect/Lists;->k(Ljava/util/List;Lcom/google/common/base/e;)Ljava/util/List;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/google/common/base/f;->d(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public getPsshInfo()Ljava/util/Map;
    ...
    :cond_1
    invoke-static {v4}, Lp2/n;->parsePsshAtom([B)Lp2/n$a;

    move-result-object v4

    if-eqz v4, :cond_2

    iget-object v5, v4, Lp2/n$a;->a:Ljava/util/UUID;

    iget-object v4, v4, Lp2/n$a;->c:[B
...
.method public getTrackFormat(I)Landroid/media/MediaFormat;
    ...
    :cond_0
    iget-object v1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->seekMap:Landroidx/media3/extractor/i0;
...
.method public release()V
    ...
    :cond_1
    iput-object v1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->currentExtractorInput:Landroidx/media3/extractor/o;

    iput-object v1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->pendingSeek:Landroidx/media3/extractor/j0;
...
.method public seekTo(JI)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->seekMap:Landroidx/media3/extractor/i0;
    ...
    invoke-virtual {v0, p1, p2, v2}, Landroidx/media3/extractor/mp4/Mp4Extractor;->l(JI)Landroidx/media3/extractor/i0$a;
    ...
    iget-object p3, v0, Landroidx/media3/extractor/i0$a;->b:Landroidx/media3/extractor/j0;

    iget-wide v1, p3, Landroidx/media3/extractor/j0;->a:J
    ...
    iget-object p3, v0, Landroidx/media3/extractor/i0$a;->a:Landroidx/media3/extractor/j0;

    iget-wide v3, p3, Landroidx/media3/extractor/j0;->a:J
    ...
    :cond_3
    :goto_1
    iget-object p1, v0, Landroidx/media3/extractor/i0$a;->b:Landroidx/media3/extractor/j0;

    goto :goto_2

    :cond_4
    iget-object p1, v0, Landroidx/media3/extractor/i0$a;->a:Landroidx/media3/extractor/j0;
    ...
    :cond_5
    iput-object p1, p0, Landroidx/media3/exoplayer/MediaExtractorCompat;->pendingSeek:Landroidx/media3/extractor/j0;
...
.method public setLogSessionId(Landroid/media/metrics/LogSessionId;)V
    ...
    invoke-static {p1, v0}, Landroidx/media3/exoplayer/i3;->a(Landroid/media/metrics/LogSessionId;Ljava/lang/Object;)Z
