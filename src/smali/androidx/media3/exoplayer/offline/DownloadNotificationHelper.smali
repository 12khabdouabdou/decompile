...
# instance fields
.field private final notificationBuilder:Landroidx/core/app/NotificationCompat$l;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2}, Landroidx/core/app/NotificationCompat$l;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;
...
.method private buildNotification(Landroid/content/Context;ILandroid/app/PendingIntent;Ljava/lang/String;IIIZZZ)Landroid/app/Notification;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {v0, p2}, Landroidx/core/app/NotificationCompat$l;->y(I)Landroidx/core/app/NotificationCompat$l;

    iget-object p2, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;
    ...
    :goto_0
    invoke-virtual {p2, p1}, Landroidx/core/app/NotificationCompat$l;->setContentTitle(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$l;

    iget-object p1, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {p1, p3}, Landroidx/core/app/NotificationCompat$l;->setContentIntent(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$l;
    ...
    :cond_1
    new-instance p2, Landroidx/core/app/NotificationCompat$j;

    invoke-direct {p2}, Landroidx/core/app/NotificationCompat$j;-><init>()V

    invoke-virtual {p2, p4}, Landroidx/core/app/NotificationCompat$j;->bigText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$j;

    move-result-object v0

    :goto_1
    invoke-virtual {p1, v0}, Landroidx/core/app/NotificationCompat$l;->setStyle(Landroidx/core/app/NotificationCompat$p;)Landroidx/core/app/NotificationCompat$l;

    iget-object p1, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {p1, p6, p7, p8}, Landroidx/core/app/NotificationCompat$l;->w(IIZ)Landroidx/core/app/NotificationCompat$l;

    iget-object p1, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {p1, p9}, Landroidx/core/app/NotificationCompat$l;->t(Z)Landroidx/core/app/NotificationCompat$l;

    iget-object p1, p0, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper;->notificationBuilder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {p1, p10}, Landroidx/core/app/NotificationCompat$l;->x(Z)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/offline/DownloadNotificationHelper$Api31;->setForegroundServiceBehavior(Landroidx/core/app/NotificationCompat$l;)V
