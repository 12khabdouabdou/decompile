...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/media3/exoplayer/hls/b0;

    invoke-direct {v0}, Landroidx/media3/exoplayer/hls/b0;-><init>()V
...
.method public static synthetic a(Landroid/net/Uri;Landroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/common/util/TimestampAdjuster;Ljava/util/Map;Landroidx/media3/extractor/o;Landroidx/media3/exoplayer/analytics/PlayerId;)Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;
    .locals 0

    .line 1
    invoke-static/range {p0 .. p6}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor;->lambda$static$0(Landroid/net/Uri;Landroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/common/util/TimestampAdjuster;Ljava/util/Map;Landroidx/media3/extractor/o;Landroidx/media3/exoplayer/analytics/PlayerId;)Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;
...
.method private static varargs createMediaParserInstance(Landroid/media/MediaParser$OutputConsumer;Landroidx/media3/common/Format;ZLcom/google/common/collect/ImmutableList;Landroidx/media3/exoplayer/analytics/PlayerId;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {p5, p0}, Landroidx/media3/exoplayer/hls/y;->a(Ljava/lang/String;Landroid/media/MediaParser$OutputConsumer;)Landroid/media/MediaParser;
    ...
    :cond_0
    invoke-static {p0, p5}, Landroidx/media3/exoplayer/hls/a0;->a(Landroid/media/MediaParser$OutputConsumer;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p5, p3}, Landroidx/media3/exoplayer/hls/z;->a(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p3, p2}, Landroidx/media3/exoplayer/hls/z;->a(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p3, p5}, Landroidx/media3/exoplayer/hls/z;->a(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {p0, p1, p2}, Landroidx/media3/exoplayer/hls/z;->a(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
...
.method private static synthetic lambda$static$0(Landroid/net/Uri;Landroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/common/util/TimestampAdjuster;Ljava/util/Map;Landroidx/media3/extractor/o;Landroidx/media3/exoplayer/analytics/PlayerId;)Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;
    .locals 9
    ...
    invoke-direct {p2, p4, p3, p5, v0}, Landroidx/media3/exoplayer/hls/WebvttExtractor;-><init>(Ljava/lang/String;Landroidx/media3/common/util/TimestampAdjuster;Ls2/r$a;Z)V
    ...
    invoke-virtual {p4, v1}, Lcom/google/common/collect/ImmutableList$a;->i(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$a;
    ...
    invoke-virtual {p4, v0}, Lcom/google/common/collect/ImmutableList$a;->i(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$a;
    ...
    invoke-direct {p2, p5, p3}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$PeekingInputReader;-><init>(Landroidx/media3/extractor/o;Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$1;)V

    invoke-static {v2, p2}, Landroidx/media3/exoplayer/hls/x;->a(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z

    invoke-static {v2}, Landroidx/media3/exoplayer/hls/u;->a(Landroid/media/MediaParser;)Ljava/lang/String;
...
.method public init(Landroidx/media3/extractor/p;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->setExtractorOutput(Landroidx/media3/extractor/p;)V
...
.method public isPackedAudioExtractor()Z
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/hls/u;->a(Landroid/media/MediaParser;)Ljava/lang/String;
...
.method public onTruncatedSegmentParsed()V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/hls/v;->a()Landroid/media/MediaParser$SeekPoint;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/hls/w;->a(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V

    return-void
.end method

.method public read(Landroidx/media3/extractor/o;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p1, v0}, Landroidx/media3/exoplayer/hls/x;->a(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
...
.method public recreate()Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;
    ...
    invoke-static {v6}, Landroidx/media3/exoplayer/hls/u;->a(Landroid/media/MediaParser;)Ljava/lang/String;
