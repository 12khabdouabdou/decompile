...
.field private output:Landroidx/media3/extractor/p;
...
.method public constructor <init>(Ljava/lang/String;Landroidx/media3/common/util/TimestampAdjuster;)V
    ...
    .line 1
    sget-object v0, Ls2/r$a;->a:Ls2/r$a;

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v0, v1}, Landroidx/media3/exoplayer/hls/WebvttExtractor;-><init>(Ljava/lang/String;Landroidx/media3/common/util/TimestampAdjuster;Ls2/r$a;Z)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Landroidx/media3/common/util/TimestampAdjuster;Ls2/r$a;Z)V
    .locals 0
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iput-object p3, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->subtitleParserFactory:Ls2/r$a;
...
.method private buildTrackOutput(J)Landroidx/media3/extractor/TrackOutput;
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->output:Landroidx/media3/extractor/p;
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->output:Landroidx/media3/extractor/p;
...
.method private processSample()V
    ...
    invoke-static {v0}, Lb3/g;->d(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    :cond_3
    invoke-static {v0}, Lb3/g;->findNextCueHeader(Landroidx/media3/common/util/ParsableByteArray;)Ljava/util/regex/Matcher;
    ...
    invoke-static {v0}, Lb3/g;->c(Ljava/lang/String;)J
...
.method public bridge synthetic getUnderlyingImplementation()Landroidx/media3/extractor/Extractor;
    .locals 1
...
.method public init(Landroidx/media3/extractor/p;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->subtitleParserFactory:Ls2/r$a;
    ...
    :cond_0
    iput-object p1, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->output:Landroidx/media3/extractor/p;
...
.method public read(Landroidx/media3/extractor/o;Landroidx/media3/extractor/h0;)I
    ...
    iget-object p2, p0, Landroidx/media3/exoplayer/hls/WebvttExtractor;->output:Landroidx/media3/extractor/p;
...
.method public sniff(Landroidx/media3/extractor/o;)Z
    ...
    invoke-interface {p1, v0, v1, v2, v1}, Landroidx/media3/extractor/o;->d([BIIZ)Z
    ...
    invoke-static {v0}, Lb3/g;->a(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    invoke-static {p1}, Lb3/g;->a(Landroidx/media3/common/util/ParsableByteArray;)Z
