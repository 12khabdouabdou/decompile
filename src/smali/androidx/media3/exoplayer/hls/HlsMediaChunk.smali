...
.field private final id3Decoder:Lj2/h;
...
.method private constructor <init>(Landroidx/media3/exoplayer/hls/HlsExtractorFactory;Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Landroidx/media3/common/Format;ZLandroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;ZLandroid/net/Uri;Ljava/util/List;ILjava/lang/Object;JJJIZIZZLandroidx/media3/common/util/TimestampAdjuster;JLandroidx/media3/common/DrmInitData;Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;Lj2/h;Landroidx/media3/common/util/ParsableByteArray;ZZLandroidx/media3/exoplayer/analytics/PlayerId;)V
    ...
    :goto_0
    iput-wide v0, v12, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->publishedDurationUs:J
    ...
    iput-object v0, v12, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->id3Decoder:Lj2/h;
    ...
    iput-boolean v0, v12, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->isIndependent:Z
...
.method public static createInstance(Landroidx/media3/exoplayer/hls/HlsExtractorFactory;Landroidx/media3/datasource/DataSource;Landroidx/media3/common/Format;JLandroidx/media3/exoplayer/hls/playlist/HlsMediaPlaylist;Landroidx/media3/exoplayer/hls/HlsChunkSource$SegmentBaseHolder;Landroid/net/Uri;Ljava/util/List;ILjava/lang/Object;ZLandroidx/media3/exoplayer/hls/TimestampAdjusterProvider;JLandroidx/media3/exoplayer/hls/HlsMediaChunk;[B[BZZLandroidx/media3/exoplayer/analytics/PlayerId;Landroidx/media3/exoplayer/upstream/CmcdData$Factory;)Landroidx/media3/exoplayer/hls/HlsMediaChunk;
    ...
    .param p17    # [B
        ...
        .end annotation
    .end param
    .param p21    # Landroidx/media3/exoplayer/upstream/CmcdData$Factory;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Signature;
    ...
    invoke-virtual/range {p21 .. p21}, Landroidx/media3/exoplayer/upstream/CmcdData$Factory;->createCmcdData()Landroidx/media3/exoplayer/upstream/CmcdData;
    ...
    :goto_8
    iget-object v6, v3, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->id3Decoder:Lj2/h;
...
.method private feedDataToExtractor(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;ZZ)V
    ...
    :goto_0
    :try_start_0
    invoke-direct {p0, p1, p3, p4}, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->prepareExtraction(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Z)Landroidx/media3/extractor/i;
    ...
    invoke-interface {p4, p3}, Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;->read(Landroidx/media3/extractor/o;)Z
    ...
    :cond_3
    :try_start_2
    invoke-interface {p3}, Landroidx/media3/extractor/o;->getPosition()J
...
.method private peekId3PrivTimestamp(Landroidx/media3/extractor/o;)J
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v2, v4, v3}, Landroidx/media3/extractor/o;->k([BII)V
    :try_end_0
    ...
    invoke-interface {p1, v5, v3, v2}, Landroidx/media3/extractor/o;->k([BII)V

    iget-object p1, p0, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->id3Decoder:Lj2/h;
    ...
    invoke-virtual {p1, v3, v2}, Lj2/h;->decode([BI)Landroidx/media3/common/Metadata;
    ...
    instance-of v6, v5, Lj2/m;

    if-eqz v6, :cond_3

    check-cast v5, Lj2/m;

    iget-object v6, v5, Lj2/m;->b:Ljava/lang/String;
...
.method private prepareExtraction(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Z)Landroidx/media3/extractor/i;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    :goto_0
    new-instance p3, Landroidx/media3/extractor/i;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/extractor/i;-><init>(Landroidx/media3/common/DataReader;JJ)V
    ...
    invoke-direct {p0, p3}, Landroidx/media3/exoplayer/hls/HlsMediaChunk;->peekId3PrivTimestamp(Landroidx/media3/extractor/o;)J

    move-result-wide v8

    invoke-virtual {p3}, Landroidx/media3/extractor/i;->h()V
    ...
    invoke-interface/range {v0 .. v7}, Landroidx/media3/exoplayer/hls/HlsExtractorFactory;->createExtractor(Landroid/net/Uri;Landroidx/media3/common/Format;Ljava/util/List;Landroidx/media3/common/util/TimestampAdjuster;Ljava/util/Map;Landroidx/media3/extractor/o;Landroidx/media3/exoplayer/analytics/PlayerId;)Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;
    ...
    invoke-interface {p1, p2}, Landroidx/media3/exoplayer/hls/HlsMediaChunkExtractor;->init(Landroidx/media3/extractor/p;)V
