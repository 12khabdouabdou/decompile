...
.method public static synthetic a(Landroidx/media3/common/Format;Landroidx/media3/exoplayer/mediacodec/MediaCodecInfo;)I
    .locals 0
...
.method private static applyWorkarounds(Ljava/lang/String;Ljava/util/List;)V
    ...
    :cond_0
    new-instance p0, Landroidx/media3/exoplayer/mediacodec/k0;

    invoke-direct {p0}, Landroidx/media3/exoplayer/mediacodec/k0;-><init>()V
...
.method public static getDecoderInfosSortedByFormatSupport(Ljava/util/List;Landroidx/media3/common/Format;)Ljava/util/List;
    ...
    new-instance p0, Landroidx/media3/exoplayer/mediacodec/i0;

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/mediacodec/i0;-><init>(Landroidx/media3/common/Format;)V
...
.method public static getDecoderInfosSortedByFullFormatSupport(Ljava/util/List;Landroidx/media3/common/Format;)Ljava/util/List;
    ...
    new-instance p0, Landroidx/media3/exoplayer/mediacodec/g0;

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/mediacodec/g0;-><init>(Landroidx/media3/common/Format;)V
...
.method public static getDecoderInfosSortedBySoftwareOnly(Ljava/util/List;)Ljava/util/List;
    ...
    new-instance p0, Landroidx/media3/exoplayer/mediacodec/h0;

    invoke-direct {p0}, Landroidx/media3/exoplayer/mediacodec/h0;-><init>()V
...
.method public static getHevcBaseLayerCodecProfileAndLevel(Landroidx/media3/common/Format;)Landroid/util/Pair;
    ...
    invoke-static {v0}, Lt1/h;->getH265BaseLayerCodecsString(Ljava/util/List;)Ljava/lang/String;
...
.method private static isHardwareAcceleratedV29(Landroid/media/MediaCodecInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/mediacodec/d0;->a(Landroid/media/MediaCodecInfo;)Z
...
.method private static isSoftwareOnlyV29(Landroid/media/MediaCodecInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/mediacodec/f0;->a(Landroid/media/MediaCodecInfo;)Z
...
.method private static isVendorV29(Landroid/media/MediaCodecInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/mediacodec/c0;->a(Landroid/media/MediaCodecInfo;)Z
...
.method private static sortByScore(Ljava/util/List;Landroidx/media3/exoplayer/mediacodec/MediaCodecUtil$ScoreProvider;)V
    ...
    new-instance v0, Landroidx/media3/exoplayer/mediacodec/j0;

    invoke-direct {v0, p1}, Landroidx/media3/exoplayer/mediacodec/j0;-><init>(Landroidx/media3/exoplayer/mediacodec/MediaCodecUtil$ScoreProvider;)V
