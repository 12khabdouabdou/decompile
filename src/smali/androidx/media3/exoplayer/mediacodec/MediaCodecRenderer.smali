...
.method private bypassRead()V
    ...
    invoke-virtual {v2}, Lv1/a;->isEndOfStream()Z
    ...
    invoke-virtual {v2}, Lv1/a;->isLastSample()Z
    ...
    invoke-static {v2}, Landroidx/media3/extractor/g0;->f([B)I
    ...
    invoke-virtual {v2}, Lv1/a;->hasSupplementalData()Z
    ...
    invoke-static {v2, v3, v4, v5}, Landroidx/media3/extractor/g0;->g(JJ)Z
...
.method private drainOutputBuffer(JJ)Z
    ...
    invoke-interface {v5, v0, v13}, Landroidx/media3/exoplayer/mediacodec/MediaCodecAdapter;->releaseOutputBuffer(IZ)V
    ...
    iget-boolean v0, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->skippedFlushAndWaitingForEarlierFrame:Z

    if-eqz v0, :cond_e

    iget-wide v3, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->skippedFlushLastOutputBufferPresentationTimeUs:J
    ...
    iput-boolean v13, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->skippedFlushAndWaitingForEarlierFrame:Z

    iput-wide v1, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->skippedFlushLastOutputBufferPresentationTimeUs:J
    ...
    iput-wide v0, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->skippedFlushLastOutputBufferPresentationTimeUs:J

    iput-boolean v14, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->isDecodeOnlyOutputBuffer:Z

    iput-boolean v13, v15, Landroidx/media3/exoplayer/mediacodec/MediaCodecRenderer;->isLastOutputBuffer:Z
...
.method private drmNeedsCodecReinitialization(Landroidx/media3/exoplayer/mediacodec/MediaCodecInfo;Landroidx/media3/common/Format;Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/DrmSession;)Z
    ...
    :cond_1
    invoke-interface {p4}, Landroidx/media3/exoplayer/drm/DrmSession;->getCryptoConfig()Lv1/b;
    ...
    :cond_2
    invoke-interface {p3}, Landroidx/media3/exoplayer/drm/DrmSession;->getCryptoConfig()Lv1/b;
...
.method private feedInputBuffer()Z
    ...
    invoke-virtual {v5}, Lv1/a;->isEndOfStream()Z
    ...
    invoke-virtual {v5}, Lv1/a;->isKeyFrame()Z
    ...
    iget-object v5, v5, Landroidx/media3/decoder/DecoderInputBuffer;->cryptoInfo:Lv1/c;

    invoke-virtual {v5, v0}, Lv1/c;->b(I)V
    ...
    invoke-virtual {v0}, Lv1/a;->isLastSample()Z
    ...
    invoke-virtual {v0}, Lv1/a;->hasSupplementalData()Z
    ...
    :cond_1a
    invoke-virtual/range {p0 .. p0}, Landroidx/media3/exoplayer/BaseRenderer;->getConfiguration()Landroidx/media3/exoplayer/RendererConfiguration;
    ...
    iget-object v15, v0, Landroidx/media3/decoder/DecoderInputBuffer;->cryptoInfo:Lv1/c;

    move-wide/from16 v16, v5

    invoke-interface/range {v12 .. v18}, Landroidx/media3/exoplayer/mediacodec/MediaCodecAdapter;->queueSecureInputBuffer(IILv1/c;JI)V
...
.method private initCodec(Landroidx/media3/exoplayer/mediacodec/MediaCodecInfo;Landroid/media/MediaCrypto;)V
    ...
    invoke-interface {p2, v1}, Landroidx/media3/exoplayer/mediacodec/MediaCodecAdapter;->registerOnBufferAvailableListener(Landroidx/media3/exoplayer/mediacodec/MediaCodecAdapter$OnBufferAvailableListener;)Z
...
.method private initMediaCryptoIfDrmSessionReady()Z
    ...
    invoke-interface {v0}, Landroidx/media3/exoplayer/drm/DrmSession;->getCryptoConfig()Lv1/b;
...
.method private isDecodeOnly(JJ)Z
    ...
    invoke-static {p1, p2, p3, p4}, Landroidx/media3/extractor/g0;->g(JJ)Z
...
.method private updateDrmSessionV23()V
    ...
    invoke-static {v1, v0}, Landroidx/media3/exoplayer/mediacodec/x;->a(Landroid/media/MediaCrypto;[B)V
    :try_end_0
    .catch Landroid/media/MediaCryptoException; {:try_start_0 .. :try_end_0} :catch_0
