...
.method public static areResolutionAndFrameRateCovered(Landroid/media/MediaCodecInfo$VideoCapabilities;IID)I
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/mediacodec/u;->a(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {}, Landroidx/media3/exoplayer/mediacodec/w;->a()V

    double-to-int p3, p3

    invoke-static {p1, p2, p3}, Landroidx/media3/exoplayer/mediacodec/v;->a(III)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
...
.method private static evaluateH264RequiredSupport(Z)I
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/mediacodec/u;->a(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    invoke-static {v3, p0, v1}, Landroidx/media3/exoplayer/mediacodec/v;->a(III)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
...
.method private static evaluatePerformancePointCoverage(Ljava/util/List;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)I
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/mediacodec/s;->a(Ljava/lang/Object;)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;

    move-result-object v1

    invoke-static {v1, p1}, Landroidx/media3/exoplayer/mediacodec/t;->a(Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)Z
