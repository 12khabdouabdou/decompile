...
# instance fields
.field private final cueDecoder:Ls2/a;
...
.field private nextSubtitle:Ls2/o;
...
.field private nextSubtitleInputBuffer:Ls2/n;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private subtitle:Ls2/o;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private subtitleDecoder:Ls2/k;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroidx/media3/exoplayer/text/TextOutput;Landroid/os/Looper;Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoder:Ls2/a;
...
.method private getCurrentEventTimeUs(J)J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    invoke-virtual {v0, p1, p2}, Ls2/o;->e(J)I

    move-result p1

    if-eqz p1, :cond_2

    iget-object p2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    invoke-virtual {p2}, Ls2/o;->l()I
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    invoke-virtual {p1}, Ls2/o;->l()I

    move-result p2

    add-int/lit8 p2, p2, -0x1

    invoke-virtual {p1, p2}, Ls2/o;->j(I)J
    ...
    invoke-virtual {p2, p1}, Ls2/o;->j(I)J
    ...
    iget-wide p1, p1, Lv1/h;->timeUs:J
...
.method private getNextEventTime()J
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    invoke-virtual {v1}, Ls2/o;->l()I
    ...
    invoke-virtual {v0, v1}, Ls2/o;->j(I)J
...
.method private static hasEventsAfter(Ls2/j;J)Z
    .locals 4
    .param p0    # Ls2/j;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-interface {p0, v0}, Ls2/j;->j(I)J
...
.method private initSubtitleDecoder()V
    ...
    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/text/SubtitleDecoderFactory;->createDecoder(Landroidx/media3/common/Format;)Ls2/k;

    move-result-object v0

    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Ls2/k;

    invoke-virtual {p0}, Landroidx/media3/exoplayer/BaseRenderer;->getLastResetPositionUs()J

    move-result-wide v1

    invoke-interface {v0, v1, v2}, Lv1/g;->setOutputStartTimeUs(J)V
...
.method private readAndDecodeCuesWithTiming(J)Z
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->cueDecoder:Ls2/a;
    ...
    invoke-virtual/range {v1 .. v6}, Ls2/a;->a(J[BII)Ls2/d;
    ...
    invoke-interface {v1, v0, p1, p2}, Landroidx/media3/exoplayer/text/CuesResolver;->addCues(Ls2/d;J)Z
...
.method private releaseSubtitleBuffers()V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Ls2/n;
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    :cond_0
    iget-object v1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ls2/o;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lv1/h;->release()V

    iput-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ls2/o;
...
.method private releaseSubtitleDecoder()V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Ls2/k;
    ...
    invoke-interface {v0}, Lv1/g;->release()V
...
.method private renderFromSubtitles(J)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ls2/o;
    ...
    invoke-interface {v0, p1, p2}, Ls2/k;->setPositionUs(J)V
    ...
    invoke-interface {v0}, Ls2/k;->dequeueOutputBuffer()Ljava/lang/Object;
    ...
    :cond_3
    iget-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ls2/o;

    const/4 v5, 0x0

    if-eqz v4, :cond_7

    invoke-virtual {v4}, Lv1/a;->isEndOfStream()Z
    ...
    :cond_5
    iget-wide v6, v4, Lv1/h;->timeUs:J
    ...
    invoke-virtual {v0}, Lv1/h;->release()V

    :cond_6
    invoke-virtual {v4, p1, p2}, Ls2/o;->e(J)I

    move-result v0

    iput v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleEventIndex:I

    iput-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    iput-object v5, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitle:Ls2/o;
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitle:Ls2/o;

    invoke-virtual {v4, p1, p2}, Ls2/o;->k(J)Ljava/util/List;
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Ls2/n;

    if-nez p1, :cond_b

    iget-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Ls2/k;
    ...
    invoke-interface {p1}, Ls2/k;->dequeueInputBuffer()Ljava/lang/Object;
    ...
    :cond_a
    iput-object p1, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Ls2/n;
    ...
    invoke-virtual {p1, p2}, Lv1/a;->setFlags(I)V

    iget-object p2, p0, Landroidx/media3/exoplayer/text/TextRenderer;->subtitleDecoder:Ls2/k;
    ...
    invoke-interface {p2, p1}, Lv1/g;->queueInputBuffer(Ljava/lang/Object;)V

    iput-object v5, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Ls2/n;
    ...
    invoke-virtual {p1}, Lv1/a;->isKeyFrame()Z
...
.method public isReady()Z
    ...
    invoke-static {v0, v3, v4}, Landroidx/media3/exoplayer/text/TextRenderer;->hasEventsAfter(Ls2/j;J)Z
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/text/TextRenderer;->nextSubtitleInputBuffer:Ls2/n;
...
.method public onPositionReset(JZ)V
    ...
    invoke-interface {p1}, Lv1/g;->flush()V

    invoke-virtual {p0}, Landroidx/media3/exoplayer/BaseRenderer;->getLastResetPositionUs()J

    move-result-wide p2

    invoke-interface {p1, p2, p3}, Lv1/g;->setOutputStartTimeUs(J)V
