...
.method public static generatePayloadFormat(Landroidx/media3/exoplayer/rtsp/MediaDescription;)Landroidx/media3/exoplayer/rtsp/RtpPayloadFormat;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/rtsp/RtspMediaTrack;->parseAacStreamMuxConfig(Ljava/lang/String;)Landroidx/media3/extractor/AacUtil$b;

    move-result-object p0

    iget v1, p0, Landroidx/media3/extractor/AacUtil$b;->a:I

    invoke-virtual {v0, v1}, Landroidx/media3/common/Format$Builder;->setSampleRate(I)Landroidx/media3/common/Format$Builder;

    move-result-object v1

    iget v3, p0, Landroidx/media3/extractor/AacUtil$b;->b:I

    invoke-virtual {v1, v3}, Landroidx/media3/common/Format$Builder;->setChannelCount(I)Landroidx/media3/common/Format$Builder;

    move-result-object v1

    iget-object p0, p0, Landroidx/media3/extractor/AacUtil$b;->c:Ljava/lang/String;
...
.method private static parseAacStreamMuxConfig(Ljava/lang/String;)Landroidx/media3/extractor/AacUtil$b;
    .locals 4
    ...
    :try_start_0
    invoke-static {v0, v2}, Landroidx/media3/extractor/AacUtil;->e(Landroidx/media3/common/util/ParsableBitArray;Z)Landroidx/media3/extractor/AacUtil$b;
...
.method private static processAacFmtpAttribute(Landroidx/media3/common/Format$Builder;Lcom/google/common/collect/ImmutableMap;Ljava/lang/String;II)V
    ...
    invoke-static {p4, p3}, Landroidx/media3/extractor/AacUtil;->a(II)[B
...
.method private static processH264FmtpAttribute(Landroidx/media3/common/Format$Builder;Lcom/google/common/collect/ImmutableMap;)V
    ...
    invoke-static {v1, v0}, Lcom/google/common/collect/ImmutableList;->J(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList;
    ...
    invoke-static {v0, v1, v2}, Lt1/h;->w([BII)Lt1/h$m;

    move-result-object v0

    iget v1, v0, Lt1/h$m;->h:F
    ...
    iget v1, v0, Lt1/h$m;->g:I

    invoke-virtual {p0, v1}, Landroidx/media3/common/Format$Builder;->setHeight(I)Landroidx/media3/common/Format$Builder;

    iget v1, v0, Lt1/h$m;->f:I
    ...
    :cond_1
    iget p1, v0, Lt1/h$m;->a:I

    iget v1, v0, Lt1/h$m;->b:I

    iget v0, v0, Lt1/h$m;->c:I
...
.method private static processH265FmtpAttribute(Landroidx/media3/common/Format$Builder;Lcom/google/common/collect/ImmutableMap;)V
    ...
    invoke-static {v0, v1, p1}, Lcom/google/common/collect/ImmutableList;->K(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList;
    ...
    invoke-static {p1, v0, v1, v2}, Lt1/h;->parseH265SpsNalUnit([BIILt1/h$k;)Lt1/h$h;

    move-result-object p1

    iget v0, p1, Lt1/h$h;->k:F
    ...
    iget-object p1, p1, Lt1/h$h;->profileTierLevel:Lt1/h$c;

    if-eqz p1, :cond_2

    iget v0, p1, Lt1/h$c;->a:I

    iget-boolean v1, p1, Lt1/h$c;->b:Z

    iget v2, p1, Lt1/h$c;->c:I

    iget v3, p1, Lt1/h$c;->d:I

    iget-object v4, p1, Lt1/h$c;->e:[I

    iget v5, p1, Lt1/h$c;->f:I
