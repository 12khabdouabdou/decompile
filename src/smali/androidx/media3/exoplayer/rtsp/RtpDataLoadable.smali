...
.field private extractorInput:Landroidx/media3/extractor/i;

.field private volatile loadCancelled:Z

.field private volatile nextRtpTimestamp:J

.field private final output:Landroidx/media3/extractor/p;
...
# direct methods
.method public constructor <init>(ILandroidx/media3/exoplayer/rtsp/RtspMediaTrack;Landroidx/media3/exoplayer/rtsp/RtpDataLoadable$EventListener;Landroidx/media3/extractor/p;Landroidx/media3/exoplayer/rtsp/RtpDataChannel$Factory;)V
    .locals 0
    ...
    iput-object p4, p0, Landroidx/media3/exoplayer/rtsp/RtpDataLoadable;->output:Landroidx/media3/extractor/p;
...
.method public load()V
    ...
    new-instance v2, Landroidx/media3/extractor/i;
    ...
    invoke-direct/range {v6 .. v11}, Landroidx/media3/extractor/i;-><init>(Landroidx/media3/common/DataReader;JJ)V

    iput-object v2, p0, Landroidx/media3/exoplayer/rtsp/RtpDataLoadable;->extractorInput:Landroidx/media3/extractor/i;
    ...
    iget-object v3, p0, Landroidx/media3/exoplayer/rtsp/RtpDataLoadable;->output:Landroidx/media3/extractor/p;

    invoke-virtual {v2, v3}, Landroidx/media3/exoplayer/rtsp/RtpExtractor;->init(Landroidx/media3/extractor/p;)V
    ...
    iget-object v3, p0, Landroidx/media3/exoplayer/rtsp/RtpDataLoadable;->extractorInput:Landroidx/media3/extractor/i;

    invoke-static {v3}, Landroidx/media3/common/util/Assertions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroidx/media3/extractor/o;

    new-instance v4, Landroidx/media3/extractor/h0;

    invoke-direct {v4}, Landroidx/media3/extractor/h0;-><init>()V

    invoke-virtual {v2, v3, v4}, Landroidx/media3/exoplayer/rtsp/RtpExtractor;->read(Landroidx/media3/extractor/o;Landroidx/media3/extractor/h0;)I
