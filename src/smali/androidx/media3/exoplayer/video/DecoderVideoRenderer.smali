...
.field private outputBuffer:Lv1/k;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method private drainOutputBuffer(JJ)Z
    ...
    iget-object p1, p0, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->decoder:Lv1/g;
    ...
    invoke-interface {p1}, Lv1/g;->dequeueOutputBuffer()Ljava/lang/Object;
...
.method private feedInputBuffer()Z
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->decoder:Lv1/g;
    ...
    invoke-virtual {v0, v2}, Lv1/a;->setFlags(I)V

    iget-object v2, p0, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->decoder:Lv1/g;
    ...
    invoke-interface {v2, v0}, Lv1/g;->queueInputBuffer(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->decoder:Lv1/g;
...
.method private maybeInitDecoder()V
    ...
    invoke-virtual {p0, v4, v0}, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->createDecoder(Landroidx/media3/common/Format;Lv1/b;)Lv1/g;

    move-result-object v0

    iput-object v0, p0, Landroidx/media3/exoplayer/video/DecoderVideoRenderer;->decoder:Lv1/g;
...
.method public dropOutputBuffer(Lv1/k;)V
    .locals 1
...
.method public flushDecoder()V
    ...
    invoke-interface {v1}, Lv1/g;->flush()V

    invoke-virtual {p0}, Landroidx/media3/exoplayer/BaseRenderer;->getLastResetPositionUs()J

    move-result-wide v2

    invoke-interface {v1, v2, v3}, Lv1/g;->setOutputStartTimeUs(J)V
...
.method public onInputFormatChanged(Landroidx/media3/exoplayer/FormatHolder;)V
    ...
    invoke-interface {v1}, Lv1/g;->getName()Ljava/lang/String;
...
.method public renderOutputBuffer(Lv1/k;JLandroidx/media3/common/Format;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/media3/decoder/DecoderException;
...
.method public abstract renderOutputBufferToSurface(Lv1/k;Landroid/view/Surface;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroidx/media3/decoder/DecoderException;
        }
...
.method public skipOutputBuffer(Lv1/k;)V
    .locals 1
