...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/media3/exoplayer/drm/f0;

    invoke-direct {v0}, Landroidx/media3/exoplayer/drm/f0;-><init>()V
...
.method private static adjustRequestInitData(Ljava/util/UUID;[B)[B
    ...
    invoke-static {p1, p0}, Lp2/n;->parseSchemeSpecificData([BLjava/util/UUID;)[B
    ...
    invoke-static {v0, p1}, Lp2/n;->buildPsshAtom(Ljava/util/UUID;[B)[B
    ...
    invoke-static {p1}, Lp2/n;->parsePsshAtom([B)Lp2/n$a;
    ...
    iget-object v2, v1, Lp2/n$a;->keyIds:[Ljava/util/UUID;

    iget-object v1, v1, Lp2/n$a;->c:[B

    invoke-static {p1, v2, v1}, Lp2/n;->buildPsshAtom(Ljava/util/UUID;[Ljava/util/UUID;[B)[B
...
.method private synthetic lambda$setOnKeyStatusChangeListener$2(Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnKeyStatusChangeListener;Landroid/media/MediaDrm;[BLjava/util/List;Z)V
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/drm/b0;->a(Ljava/lang/Object;)Landroid/media/MediaDrm$KeyStatus;

    move-result-object v0

    new-instance v1, Landroidx/media3/exoplayer/drm/ExoMediaDrm$KeyStatus;

    invoke-static {v0}, Landroidx/media3/exoplayer/drm/c0;->a(Landroid/media/MediaDrm$KeyStatus;)I

    move-result v2

    invoke-static {v0}, Landroidx/media3/exoplayer/drm/d0;->a(Landroid/media/MediaDrm$KeyStatus;)[B
...
.method public bridge synthetic createCryptoConfig([B)Lv1/b;
    .locals 0
    .annotation build Landroidx/media3/common/util/UnstableApi;
    .end annotation
...
.method public getKeyRequest([BLjava/util/List;ILjava/util/HashMap;)Landroidx/media3/exoplayer/drm/ExoMediaDrm$KeyRequest;
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/drm/w;->a(Landroid/media/MediaDrm$KeyRequest;)I
...
.method public getMetrics()Landroid/os/PersistableBundle;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/drm/a0;->a(Landroid/media/MediaDrm;)Landroid/os/PersistableBundle;
...
.method public requiresSecureDecoder([BLjava/lang/String;)Z
    ...
    invoke-static {v0, p1}, Landroidx/media3/exoplayer/drm/v;->a(Landroid/media/MediaDrm;[B)I
...
.method public setOnEventListener(Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnEventListener;)V
    ...
    :cond_0
    new-instance v1, Landroidx/media3/exoplayer/drm/g0;

    invoke-direct {v1, p0, p1}, Landroidx/media3/exoplayer/drm/g0;-><init>(Landroidx/media3/exoplayer/drm/FrameworkMediaDrm;Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnEventListener;)V
...
.method public setOnExpirationUpdateListener(Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnExpirationUpdateListener;)V
    ...
    :cond_0
    new-instance v2, Landroidx/media3/exoplayer/drm/e0;

    invoke-direct {v2, p0, p1}, Landroidx/media3/exoplayer/drm/e0;-><init>(Landroidx/media3/exoplayer/drm/FrameworkMediaDrm;Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnExpirationUpdateListener;)V

    :goto_0
    invoke-static {v0, v2, v1}, Landroidx/media3/exoplayer/drm/y;->a(Landroid/media/MediaDrm;Landroid/media/MediaDrm$OnExpirationUpdateListener;Landroid/os/Handler;)V
...
.method public setOnKeyStatusChangeListener(Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnKeyStatusChangeListener;)V
    ...
    :cond_0
    new-instance v2, Landroidx/media3/exoplayer/drm/h0;

    invoke-direct {v2, p0, p1}, Landroidx/media3/exoplayer/drm/h0;-><init>(Landroidx/media3/exoplayer/drm/FrameworkMediaDrm;Landroidx/media3/exoplayer/drm/ExoMediaDrm$OnKeyStatusChangeListener;)V

    :goto_0
    invoke-static {v0, v2, v1}, Landroidx/media3/exoplayer/drm/z;->a(Landroid/media/MediaDrm;Landroid/media/MediaDrm$OnKeyStatusChangeListener;Landroid/os/Handler;)V
