...
.method public static synthetic a(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
...
.method private acquireFirstSessionOnHandlerThread(I[BLandroidx/media3/common/Format;)Landroidx/media3/exoplayer/drm/DrmSession;
    ...
    new-instance v8, Landroidx/media3/exoplayer/drm/m0;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/media3/exoplayer/drm/m0;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/google/common/util/concurrent/x;Landroidx/media3/common/Format;)V
    ...
    new-instance v0, Landroidx/media3/exoplayer/drm/n0;

    invoke-direct {v0, p0, p1, p2}, Landroidx/media3/exoplayer/drm/n0;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/x;)V

    invoke-virtual {p3, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :try_start_1
    invoke-virtual {p2}, Lcom/google/common/util/concurrent/x;->get()Ljava/lang/Object;
...
.method private acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(I[BLandroidx/media3/common/Format;)[B
    ...
    invoke-direct {v0, p0, p2, p1}, Landroidx/media3/exoplayer/drm/q0;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
...
.method public static synthetic b(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V

    return-void
.end method

.method public static synthetic c(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/google/common/util/concurrent/x;Landroidx/media3/common/Format;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/x;Landroidx/media3/common/Format;)V

    return-void
.end method

.method public static synthetic d(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/x;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/x;)V

    return-void
.end method

.method public static synthetic e(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/x;)V

    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/google/common/util/concurrent/x;Landroidx/media3/common/Format;)V
    .locals 3
    ...
    invoke-virtual {p3, p1}, Lcom/google/common/util/concurrent/x;->B(Ljava/lang/Object;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {p3, p1}, Lcom/google/common/util/concurrent/x;->C(Ljava/lang/Throwable;)Z

    :goto_0
    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/google/common/util/concurrent/x;)V
    .locals 3
    ...
    :cond_0
    :goto_0
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/x;->B(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_1
    invoke-virtual {p2, v0}, Lcom/google/common/util/concurrent/x;->C(Ljava/lang/Throwable;)Z
...
.method private synthetic lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
    ...
    :try_start_1
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/x;->C(Ljava/lang/Throwable;)Z
    :try_end_1
...
.method private synthetic lambda$getLicenseDurationRemainingSec$0(Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
...
.method private synthetic lambda$releaseManagerOnHandlerThread$4(Lcom/google/common/util/concurrent/x;)V
    .locals 1
...
.method private releaseManagerOnHandlerThread()V
    ...
    new-instance v2, Landroidx/media3/exoplayer/drm/p0;

    invoke-direct {v2, p0, v0}, Landroidx/media3/exoplayer/drm/p0;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;)V
...
.method public declared-synchronized getLicenseDurationRemainingSec([B)Landroid/util/Pair;
    ...
    invoke-direct {v2, p0, v0, p1}, Landroidx/media3/exoplayer/drm/o0;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/google/common/util/concurrent/x;Landroidx/media3/exoplayer/drm/DrmSession;)V
