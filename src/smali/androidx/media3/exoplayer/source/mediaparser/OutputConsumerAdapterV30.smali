...
.field private extractorOutput:Landroidx/media3/extractor/p;

.field private lastChunkIndex:Landroidx/media3/extractor/f;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroidx/media3/common/Format;IZ)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Landroidx/media3/extractor/p;
...
.method private maybeEndTracks()V
    ...
    :cond_2
    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Landroidx/media3/extractor/p;
...
.method private maybeObtainChunkIndex(Landroid/media/MediaFormat;)Z
    ...
    invoke-direct {p1, v3, v4, v5, v6}, Landroidx/media3/extractor/f;-><init>([I[J[J[J)V

    iput-object p1, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Landroidx/media3/extractor/f;
...
.method private toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Landroidx/media3/extractor/TrackOutput$a;
    .locals 5
    ...
    :goto_0
    new-instance v2, Landroidx/media3/extractor/TrackOutput$a;

    iget v3, p2, Landroid/media/MediaCodec$CryptoInfo;->mode:I

    iget-object v4, p2, Landroid/media/MediaCodec$CryptoInfo;->key:[B

    invoke-direct {v2, v3, v4, v1, v0}, Landroidx/media3/extractor/TrackOutput$a;-><init>(I[BII)V
...
.method public getChunkIndex()Landroidx/media3/extractor/f;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->lastChunkIndex:Landroidx/media3/extractor/f;
...
.method public onSampleCompleted(IJIIILandroid/media/MediaCodec$CryptoInfo;)V
    ...
    invoke-direct {p0, p1, p7}, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->toExoPlayerCryptoData(ILandroid/media/MediaCodec$CryptoInfo;)Landroidx/media3/extractor/TrackOutput$a;
...
.method public onSampleDataFound(ILandroid/media/MediaParser$InputReader;)V
    ...
    invoke-interface {v0, p1, v1}, Landroidx/media3/extractor/p;->track(II)Landroidx/media3/extractor/TrackOutput;
...
.method public onSeekMapFound(Landroid/media/MediaParser$SeekMap;)V
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/source/mediaparser/OutputConsumerAdapterV30;->extractorOutput:Landroidx/media3/extractor/p;
    ...
    :goto_1
    invoke-interface {v2, p1}, Landroidx/media3/extractor/p;->seekMap(Landroidx/media3/extractor/i0;)V
...
.method public onTrackDataFound(ILandroid/media/MediaParser$TrackData;)V
    ...
    invoke-interface {v2, p1, v1}, Landroidx/media3/extractor/p;->track(II)Landroidx/media3/extractor/TrackOutput;
...
.method public setExtractorOutput(Landroidx/media3/extractor/p;)V
    .locals 0
