...
# direct methods
.method public constructor <init>(Landroidx/media3/extractor/t;Ls2/r$a;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->extractorsFactory:Landroidx/media3/extractor/t;

    iput-object p2, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->subtitleParserFactory:Ls2/r$a;
...
.method private ensureAllSuppliersAreLoaded()V
    ...
    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->maybeLoadSupplier(I)Lcom/google/common/base/q;
...
.method private synthetic lambda$loadSupplier$4(Landroidx/media3/datasource/DataSource$Factory;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->extractorsFactory:Landroidx/media3/extractor/t;

    invoke-direct {v0, p1, v1}, Landroidx/media3/exoplayer/source/ProgressiveMediaSource$Factory;-><init>(Landroidx/media3/datasource/DataSource$Factory;Landroidx/media3/extractor/t;)V

    return-object v0
.end method

.method private loadSupplier(I)Lcom/google/common/base/q;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
...
.method private maybeLoadSupplier(I)Lcom/google/common/base/q;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->loadSupplier(I)Lcom/google/common/base/q;
...
.method public getMediaSourceFactory(I)Landroidx/media3/exoplayer/source/MediaSource$Factory;
    ...
    :cond_3
    iget-object v1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->subtitleParserFactory:Ls2/r$a;

    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/source/MediaSource$Factory;->setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
...
.method public setCodecsToParseWithinGopSampleDependencies(I)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->extractorsFactory:Landroidx/media3/extractor/t;

    invoke-interface {v0, p1}, Landroidx/media3/extractor/t;->experimentalSetCodecsToParseWithinGopSampleDependencies(I)Landroidx/media3/extractor/t;
...
.method public setJpegExtractorFlags(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/extractor/l;->j(I)Landroidx/media3/extractor/l;
...
.method public setParseSubtitlesDuringExtraction(Z)V
    ...
    invoke-interface {v0, p1}, Landroidx/media3/extractor/t;->b(Z)Landroidx/media3/extractor/t;
...
.method public setSubtitleParserFactory(Ls2/r$a;)V
    .locals 2

    .line 1
    iput-object p1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->subtitleParserFactory:Ls2/r$a;

    iget-object v0, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->extractorsFactory:Landroidx/media3/extractor/t;

    invoke-interface {v0, p1}, Landroidx/media3/extractor/t;->setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/extractor/t;
    ...
    invoke-interface {v1, p1}, Landroidx/media3/exoplayer/source/MediaSource$Factory;->setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
