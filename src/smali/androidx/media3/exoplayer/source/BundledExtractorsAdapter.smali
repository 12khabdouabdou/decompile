...
.field private extractorInput:Landroidx/media3/extractor/o;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Landroidx/media3/extractor/t;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorsFactory:Landroidx/media3/extractor/t;
...
.method public disableSeekingOnMp3Streams()V
    ...
    invoke-virtual {v0}, Landroidx/media3/extractor/mp3/Mp3Extractor;->f()V
...
.method public getCurrentInputPosition()J
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorInput:Landroidx/media3/extractor/o;
...
.method public init(Landroidx/media3/common/DataReader;Landroid/net/Uri;Ljava/util/Map;JJLandroidx/media3/extractor/p;)V
    .locals 7
    ...
    iput-object v6, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorInput:Landroidx/media3/extractor/o;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorsFactory:Landroidx/media3/extractor/t;

    invoke-interface {p1, p2, p3}, Landroidx/media3/extractor/t;->c(Landroid/net/Uri;Ljava/util/Map;)[Landroidx/media3/extractor/Extractor;

    move-result-object p1

    array-length p3, p1

    invoke-static {p3}, Lcom/google/common/collect/ImmutableList;->z(I)Lcom/google/common/collect/ImmutableList$a;
    ...
    :try_start_0
    invoke-interface {v2, v6}, Landroidx/media3/extractor/Extractor;->sniff(Landroidx/media3/extractor/o;)Z
    ...
    invoke-interface {v6}, Landroidx/media3/extractor/o;->h()V
    ...
    invoke-virtual {p3, v2}, Lcom/google/common/collect/ImmutableList$a;->k(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableList$a;
    :try_end_1
    ...
    invoke-interface {v6}, Landroidx/media3/extractor/o;->getPosition()J
    ...
    invoke-interface {p1, p8}, Landroidx/media3/extractor/Extractor;->init(Landroidx/media3/extractor/p;)V
    ...
    invoke-static {p6}, Lcom/google/common/base/f;->g(Ljava/lang/String;)Lcom/google/common/base/f;
    ...
    invoke-static {p1, p7}, Lcom/google/common/collect/Lists;->k(Ljava/util/List;Lcom/google/common/base/e;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {p6, p1}, Lcom/google/common/base/f;->d(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public read(Landroidx/media3/extractor/h0;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorInput:Landroidx/media3/extractor/o;
    ...
    invoke-interface {v0, v1, p1}, Landroidx/media3/extractor/Extractor;->read(Landroidx/media3/extractor/o;Landroidx/media3/extractor/h0;)I
...
.method public release()V
    ...
    :cond_0
    iput-object v1, p0, Landroidx/media3/exoplayer/source/BundledExtractorsAdapter;->extractorInput:Landroidx/media3/extractor/o;
