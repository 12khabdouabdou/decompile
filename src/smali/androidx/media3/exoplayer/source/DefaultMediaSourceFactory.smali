...
.method public constructor <init>(Landroid/content/Context;Landroidx/media3/extractor/t;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p2}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;-><init>(Landroidx/media3/datasource/DataSource$Factory;Landroidx/media3/extractor/t;)V
...
.method public constructor <init>(Landroidx/media3/datasource/DataSource$Factory;)V
    ...
    invoke-direct {p0, p1, v0}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;-><init>(Landroidx/media3/datasource/DataSource$Factory;Landroidx/media3/extractor/t;)V
...
.method public constructor <init>(Landroidx/media3/datasource/DataSource$Factory;Landroidx/media3/extractor/t;)V
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->subtitleParserFactory:Ls2/r$a;

    new-instance v1, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;

    invoke-direct {v1, p2, v0}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;-><init>(Landroidx/media3/extractor/t;Ls2/r$a;)V
...
.method private synthetic lambda$createMediaSource$0(Landroidx/media3/common/Format;)[Landroidx/media3/extractor/Extractor;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->subtitleParserFactory:Ls2/r$a;

    invoke-interface {v1, p1}, Ls2/r$a;->supportsFormat(Landroidx/media3/common/Format;)Z
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->subtitleParserFactory:Ls2/r$a;

    invoke-interface {v2, p1}, Ls2/r$a;->b(Landroidx/media3/common/Format;)Ls2/r;

    move-result-object p1

    const/4 v2, 0x0

    invoke-direct {v1, p1, v2}, Ls2/m;-><init>(Ls2/r;Landroidx/media3/common/Format;)V
...
.method public createMediaSource(Landroidx/media3/common/MediaItem;)Landroidx/media3/exoplayer/source/MediaSource;
    ...
    invoke-direct {v8, v9, v7}, Landroidx/media3/exoplayer/source/ProgressiveMediaSource$Factory;-><init>(Landroidx/media3/datasource/DataSource$Factory;Landroidx/media3/extractor/t;)V

    iget-object v7, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->subtitleParserFactory:Ls2/r$a;

    invoke-interface {v7, v6}, Ls2/r$a;->supportsFormat(Landroidx/media3/common/Format;)Z
    ...
    iget-object v9, p0, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->subtitleParserFactory:Ls2/r$a;

    invoke-interface {v9, v6}, Ls2/r$a;->a(Landroidx/media3/common/Format;)I
...
.method public setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;
    .locals 1
    .annotation build Landroidx/media3/common/util/UnstableApi;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory$DelegateFactoryLoader;->setSubtitleParserFactory(Ls2/r$a;)V
...
.method public bridge synthetic setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/exoplayer/source/MediaSource$Factory;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;->setSubtitleParserFactory(Ls2/r$a;)Landroidx/media3/exoplayer/source/DefaultMediaSourceFactory;
