...
.field private final chunkIndex:Landroidx/media3/extractor/f;
...
# direct methods
.method public constructor <init>(Landroidx/media3/datasource/cache/Cache;Ljava/lang/String;Landroidx/media3/extractor/f;)V
    .locals 2
    ...
    iput-object p3, p0, Landroidx/media3/exoplayer/upstream/CachedRegionTracker;->chunkIndex:Landroidx/media3/extractor/f;
...
.method private mergeSpan(Landroidx/media3/datasource/cache/CacheSpan;)V
    ...
    :goto_1
    iget-object v1, p0, Landroidx/media3/exoplayer/upstream/CachedRegionTracker;->chunkIndex:Landroidx/media3/extractor/f;

    iget v2, v1, Landroidx/media3/extractor/f;->a:I

    add-int/lit8 v2, v2, -0x1

    if-ge v0, v2, :cond_2

    iget-object v1, v1, Landroidx/media3/extractor/f;->c:[J
    ...
    :cond_3
    iget-object p1, p0, Landroidx/media3/exoplayer/upstream/CachedRegionTracker;->chunkIndex:Landroidx/media3/extractor/f;

    iget-object p1, p1, Landroidx/media3/extractor/f;->c:[J
...
.method public declared-synchronized getRegionEndTimeMs(J)I
    ...
    :cond_0
    iget-object p2, p0, Landroidx/media3/exoplayer/upstream/CachedRegionTracker;->chunkIndex:Landroidx/media3/extractor/f;

    iget v0, p2, Landroidx/media3/extractor/f;->a:I

    add-int/lit8 v0, v0, -0x1

    if-ne p1, v0, :cond_1

    iget-object v0, p2, Landroidx/media3/extractor/f;->c:[J

    aget-wide v4, v0, p1

    iget-object v0, p2, Landroidx/media3/extractor/f;->b:[I
    ...
    :cond_1
    :try_start_1
    iget-object v0, p2, Landroidx/media3/extractor/f;->d:[J
    ...
    iget-object p2, p2, Landroidx/media3/extractor/f;->e:[J
...
.method public declared-synchronized onSpanRemoved(Landroidx/media3/datasource/cache/Cache;Landroidx/media3/datasource/cache/CacheSpan;)V
    ...
    iget-object v0, p0, Landroidx/media3/exoplayer/upstream/CachedRegionTracker;->chunkIndex:Landroidx/media3/extractor/f;

    iget-object v0, v0, Landroidx/media3/extractor/f;->c:[J
