...
.method public constructor <init>(Landroid/media/AudioTrack;Landroidx/media3/exoplayer/audio/AudioCapabilitiesReceiver;)V
    ...
    new-instance p2, Landroidx/media3/exoplayer/audio/c1;

    invoke-direct {p2, p0}, Landroidx/media3/exoplayer/audio/c1;-><init>(Landroidx/media3/exoplayer/audio/DefaultAudioSink$OnRoutingChangedListenerApi24;)V
    ...
    invoke-static {p1, v0, p2}, Landroidx/media3/exoplayer/audio/z0;->a(Landroid/media/AudioTrack;Landroid/media/AudioRouting$OnRoutingChangedListener;Landroid/os/Handler;)V
...
.method private onRoutingChanged(Landroid/media/AudioRouting;)V
    ...
    :cond_0
    invoke-static {p1}, Landroidx/media3/exoplayer/audio/y0;->a(Landroid/media/AudioRouting;)Landroid/media/AudioDeviceInfo;
...
.method public release()V
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/audio/a1;->a(Ljava/lang/Object;)Landroid/media/AudioRouting$OnRoutingChangedListener;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/audio/b1;->a(Landroid/media/AudioTrack;Landroid/media/AudioRouting$OnRoutingChangedListener;)V
