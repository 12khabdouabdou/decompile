...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/u;->a(Ljava/util/List;Z)Landroid/media/RouteDiscoveryPreference$Builder;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/t;->a(Landroid/media/RouteDiscoveryPreference$Builder;)Landroid/media/RouteDiscoveryPreference;
...
.method public static synthetic b(Landroidx/media3/exoplayer/DefaultSuitableOutputChecker$ImplApi35;Landroid/content/Context;)V
    .locals 0
...
.method public static synthetic c(Landroidx/media3/exoplayer/SuitableOutputChecker$Callback;Ljava/lang/Boolean;Ljava/lang/Boolean;)V
    .locals 0
...
.method private static isSelectedOutputSuitableForPlayback(Landroid/media/MediaRouter2;)Z
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/p;->a(Ljava/lang/Object;)Landroid/media/MediaRouter2;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/a0;->a(Landroid/media/MediaRouter2;)Landroid/media/MediaRouter2$RoutingController;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/b0;->a(Landroid/media/MediaRouter2$RoutingController;)Landroid/media/RoutingSessionInfo;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/a0;->a(Landroid/media/MediaRouter2;)Landroid/media/MediaRouter2$RoutingController;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/c0;->a(Landroid/media/MediaRouter2$RoutingController;)Ljava/util/List;
    ...
    invoke-static {v2}, Landroidx/media3/exoplayer/d0;->a(Ljava/lang/Object;)Landroid/media/MediaRoute2Info;
...
.method private synthetic lambda$disable$2()V
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/w;->a(Ljava/lang/Object;)Landroid/media/MediaRouter2$ControllerCallback;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/x;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRouter2$ControllerCallback;)V
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/y;->a(Ljava/lang/Object;)Landroid/media/MediaRouter2$RouteCallback;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/z;->a(Landroid/media/MediaRouter2;Landroid/media/MediaRouter2$RouteCallback;)V
...
.method private synthetic lambda$enable$1(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Landroidx/media3/exoplayer/i0;-><init>(Landroidx/media3/common/util/BackgroundThreadStateHandler;)V
    ...
    invoke-static {p1, v0, v1, v2}, Landroidx/media3/exoplayer/q;->a(Landroid/media/MediaRouter2;Ljava/util/concurrent/Executor;Landroid/media/MediaRouter2$RouteCallback;Landroid/media/RouteDiscoveryPreference;)V
    ...
    invoke-static {v1, v0, p1}, Landroidx/media3/exoplayer/s;->a(Landroid/media/MediaRouter2;Ljava/util/concurrent/Executor;Landroid/media/MediaRouter2$ControllerCallback;)V
...
.method public disable()V
    ...
    invoke-direct {v1, p0}, Landroidx/media3/exoplayer/h0;-><init>(Landroidx/media3/exoplayer/DefaultSuitableOutputChecker$ImplApi35;)V
...
.method public enable(Landroidx/media3/exoplayer/SuitableOutputChecker$Callback;Landroid/content/Context;Landroid/os/Looper;Landroid/os/Looper;Landroidx/media3/common/util/Clock;)V
    ...
    invoke-direct {v5, p1}, Landroidx/media3/exoplayer/f0;-><init>(Landroidx/media3/exoplayer/SuitableOutputChecker$Callback;)V
    ...
    new-instance p1, Landroidx/media3/exoplayer/g0;

    invoke-direct {p1, p0, p2}, Landroidx/media3/exoplayer/g0;-><init>(Landroidx/media3/exoplayer/DefaultSuitableOutputChecker$ImplApi35;Landroid/content/Context;)V
