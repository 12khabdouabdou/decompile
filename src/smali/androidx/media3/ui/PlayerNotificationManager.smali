...
.field private builder:Landroidx/core/app/NotificationCompat$l;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILandroidx/media3/ui/PlayerNotificationManager$MediaDescriptionAdapter;Landroidx/media3/ui/PlayerNotificationManager$NotificationListener;Landroidx/media3/ui/PlayerNotificationManager$CustomActionReceiver;IIIIIIIILjava/lang/String;)V
    ...
    invoke-direct {v4, p0}, Landroidx/media3/ui/c0;-><init>(Landroidx/media3/ui/PlayerNotificationManager;)V
    ...
    invoke-static {v11}, Landroidx/core/app/NotificationManagerCompat;->c(Landroid/content/Context;)Landroidx/core/app/NotificationManagerCompat;
...
.method private static setLargeIcon(Landroidx/core/app/NotificationCompat$l;Landroid/graphics/Bitmap;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/NotificationCompat$l;->setLargeIcon(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$l;
...
.method private startOrUpdateNotification(Landroidx/media3/common/Player;Landroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Landroidx/media3/ui/PlayerNotificationManager;->builder:Landroidx/core/app/NotificationCompat$l;

    invoke-virtual {p0, p1, v1, v0, p2}, Landroidx/media3/ui/PlayerNotificationManager;->createNotification(Landroidx/media3/common/Player;Landroidx/core/app/NotificationCompat$l;ZLandroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$l;

    move-result-object p1

    iput-object p1, p0, Landroidx/media3/ui/PlayerNotificationManager;->builder:Landroidx/core/app/NotificationCompat$l;
    ...
    :cond_0
    invoke-virtual {p1}, Landroidx/core/app/NotificationCompat$l;->a()Landroid/app/Notification;
    ...
    invoke-virtual {v1, v2, p1}, Landroidx/core/app/NotificationManagerCompat;->g(ILandroid/app/Notification;)V
...
# virtual methods
.method public createNotification(Landroidx/media3/common/Player;Landroidx/core/app/NotificationCompat$l;ZLandroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$l;
    .locals 8
    .param p2    # Landroidx/core/app/NotificationCompat$l;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    :cond_4
    new-instance p2, Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-direct {p2, v5, v6}, Landroidx/core/app/NotificationCompat$l;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v6}, Landroidx/core/app/NotificationCompat$l;->addAction(Landroidx/core/app/NotificationCompat$Action;)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-virtual {p2, v3}, Landroidx/core/app/NotificationCompat$l;->setStyle(Landroidx/core/app/NotificationCompat$p;)Landroidx/core/app/NotificationCompat$l;

    iget-object v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->dismissPendingIntent:Landroid/app/PendingIntent;

    invoke-virtual {p2, v0}, Landroidx/core/app/NotificationCompat$l;->setDeleteIntent(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$l;

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->badgeIconType:I

    invoke-virtual {p2, v0}, Landroidx/core/app/NotificationCompat$l;->j(I)Landroidx/core/app/NotificationCompat$l;

    move-result-object v0

    invoke-virtual {v0, p3}, Landroidx/core/app/NotificationCompat$l;->t(Z)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->color:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->l(I)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget-boolean v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->colorized:Z

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->m(Z)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->smallIconResourceId:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->y(I)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->visibility:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->A(I)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->priority:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->v(I)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->defaults:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$l;->n(I)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-virtual {p2, v3, v4}, Landroidx/core/app/NotificationCompat$l;->B(J)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroidx/core/app/NotificationCompat$l;->x(Z)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroidx/core/app/NotificationCompat$l;->z(Z)Landroidx/core/app/NotificationCompat$l;

    goto :goto_4

    :cond_6
    invoke-virtual {p2, v4}, Landroidx/core/app/NotificationCompat$l;->x(Z)Landroidx/core/app/NotificationCompat$l;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroidx/core/app/NotificationCompat$l;->z(Z)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$l;->setContentTitle(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$l;->setContentText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$l;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$l;->setSubText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$l;
    ...
    :cond_7
    invoke-static {p2, p4}, Landroidx/media3/ui/PlayerNotificationManager;->setLargeIcon(Landroidx/core/app/NotificationCompat$l;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/core/app/NotificationCompat$l;->setContentIntent(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$l;

    iget-object p1, p0, Landroidx/media3/ui/PlayerNotificationManager;->groupKey:Ljava/lang/String;

    if-eqz p1, :cond_8

    invoke-virtual {p2, p1}, Landroidx/core/app/NotificationCompat$l;->setGroup(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$l;

    :cond_8
    invoke-virtual {p2, v2}, Landroidx/core/app/NotificationCompat$l;->u(Z)Landroidx/core/app/NotificationCompat$l;
