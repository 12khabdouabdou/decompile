...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;

    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->r:Ljava/io/File;

    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->r(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->q:J
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;
    ...
    :goto_1
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;
...
.method public static C(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2

    .line 1
    invoke-static {p0}, Landroidx/multidex/MultiDexExtractor;->j(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-wide v0, p4, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
...
.method public static r(Ljava/io/File;)J
    ...
    .line 1
    invoke-static {p0}, Lf3/b;->c(Ljava/io/File;)J
...
.method public static t(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, Landroidx/multidex/MultiDexExtractor;->n(Ljava/io/File;)J
...
.method public final b()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->r:Ljava/io/File;
    ...
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->r:Ljava/io/File;
...
.method public close()V
    ...
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/spi/AbstractInterruptibleChannel;->close()V

    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;
...
.method public u(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;

    iget-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->q:J

    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/MultiDexExtractor;->t(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, Landroidx/multidex/MultiDexExtractor;->w(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_0
    invoke-virtual {p0}, Landroidx/multidex/MultiDexExtractor;->y()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->n(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroidx/multidex/MultiDexExtractor;->q:J
    ...
    invoke-static/range {v2 .. v8}, Landroidx/multidex/MultiDexExtractor;->C(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public final w(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Landroidx/multidex/MultiDexExtractor;->j(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Landroidx/multidex/MultiDexExtractor;->r:Ljava/io/File;
    ...
    invoke-static {v8}, Landroidx/multidex/MultiDexExtractor;->r(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
    ...
    iget-wide v2, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
    ...
    iget-wide v4, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
...
.method public final y()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/multidex/MultiDexExtractor;->b()V
    ...
    iget-object v0, v1, Landroidx/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    iget-object v12, v1, Landroidx/multidex/MultiDexExtractor;->r:Ljava/io/File;
    ...
    invoke-static {v8, v9, v11, v6}, Landroidx/multidex/MultiDexExtractor;->g(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Landroidx/multidex/MultiDexExtractor;->r(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
    :try_end_1
    ...
    iget-wide v12, v11, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->p:J
