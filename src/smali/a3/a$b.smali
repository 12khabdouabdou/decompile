...
.method public constructor <init>()V
    ...
    iput-object v0, p0, La3/a$b;->a:[I

    const/4 v0, -0x1

    iput v0, p0, La3/a$b;->g:I

    iput v0, p0, La3/a$b;->h:I
...
.method public static j(Landroidx/media3/common/util/ParsableBitArray;ILa3/a$b$a;)V
    .locals 5
    ...
    iput p0, p2, La3/a$b$a;->a:I

    iput v0, p2, La3/a$b$a;->b:I
...
.method public build(Landroidx/media3/common/util/ParsableByteArray;)Landroidx/media3/common/text/Cue;
    ...
    .line 1
    iget-object v0, p0, La3/a$b;->d:[I

    if-eqz v0, :cond_1

    iget-boolean v0, p0, La3/a$b;->b:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, La3/a$b;->c:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, La3/a$b;->boundingBox:Landroid/graphics/Rect;

    if-eqz v0, :cond_1

    iget v1, p0, La3/a$b;->g:I

    const/4 v2, -0x1

    if-eq v1, v2, :cond_1

    iget v1, p0, La3/a$b;->h:I
    ...
    invoke-virtual {p0, v2, v3, v0, v1}, La3/a$b;->i(Landroidx/media3/common/util/ParsableBitArray;ZLandroid/graphics/Rect;[I)V

    iget v3, p0, La3/a$b;->h:I
    ...
    invoke-virtual {p0, v2, p1, v0, v1}, La3/a$b;->i(Landroidx/media3/common/util/ParsableBitArray;ZLandroid/graphics/Rect;[I)V
...
.method public final c([ILandroidx/media3/common/util/ParsableByteArray;I)V
    .locals 1
    ...
    :pswitch_1
    invoke-virtual {p0, p2}, La3/a$b;->g(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    :pswitch_2
    invoke-virtual {p0, p2}, La3/a$b;->e(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    :pswitch_3
    invoke-virtual {p0, p2}, La3/a$b;->d(Landroidx/media3/common/util/ParsableByteArray;)Z
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p2}, La3/a$b;->f([ILandroidx/media3/common/util/ParsableByteArray;)Z
...
.method public final d(Landroidx/media3/common/util/ParsableByteArray;)Z
    .locals 7
    ...
    invoke-static {v5, v6}, La3/a$b;->m(II)I
    ...
    invoke-static {v4, v0}, La3/a$b;->m(II)I

    move-result v0

    aput v0, v3, v2

    iget-object v0, p0, La3/a$b;->a:[I
    ...
    invoke-static {v3, v4}, La3/a$b;->m(II)I
    ...
    invoke-static {v3, p1}, La3/a$b;->m(II)I
...
.method public final e(Landroidx/media3/common/util/ParsableByteArray;)Z
    .locals 5
    ...
    iput-object v3, p0, La3/a$b;->boundingBox:Landroid/graphics/Rect;

    return v4
.end method

.method public final f([ILandroidx/media3/common/util/ParsableByteArray;)Z
    .locals 6
    ...
    invoke-static {p1, v4}, La3/a$b;->a([II)I
    ...
    invoke-static {p1, v0}, La3/a$b;->a([II)I
    ...
    invoke-static {p1, v2}, La3/a$b;->a([II)I
    ...
    invoke-static {p1, p2}, La3/a$b;->a([II)I

    move-result p1

    aput p1, v0, v1

    iput-boolean v3, p0, La3/a$b;->c:Z

    return v3
.end method

.method public final g(Landroidx/media3/common/util/ParsableByteArray;)Z
    .locals 2
...
.method public h(Ljava/lang/String;)V
    ...
    invoke-static {v6}, La3/a$b;->b(Ljava/lang/String;)I
    ...
    iput v3, p0, La3/a$b;->f:I

    iput-boolean v4, p0, La3/a$b;->b:Z
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final i(Landroidx/media3/common/util/ParsableBitArray;ZLandroid/graphics/Rect;[I)V
    .locals 9
    ...
    new-instance v2, La3/a$b$a;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, La3/a$b$a;-><init>(La3/a$a;)V
    ...
    :cond_0
    invoke-static {p1, v0, v2}, La3/a$b;->j(Landroidx/media3/common/util/ParsableBitArray;ILa3/a$b$a;)V

    iget v5, v2, La3/a$b$a;->b:I
    ...
    iget-object v7, p0, La3/a$b;->a:[I

    iget v8, v2, La3/a$b$a;->a:I
...
.method public k(Landroidx/media3/common/util/ParsableByteArray;)V
    .locals 2
    ...
    iget-boolean v1, p0, La3/a$b;->b:Z
    ...
    invoke-virtual {p0, v0, p1, v1}, La3/a$b;->c([ILandroidx/media3/common/util/ParsableByteArray;I)V
...
.method public l()V
    ...
    iput-boolean v0, p0, La3/a$b;->c:Z

    const/4 v0, 0x0

    iput-object v0, p0, La3/a$b;->boundingBox:Landroid/graphics/Rect;
