...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj4/k;->c:Ljava/lang/String;
    ...
    invoke-static {v0}, Luf/o;->g([Ljava/lang/Object;)Ljava/util/ArrayList;

    move-result-object v0

    sput-object v0, Lj4/k;->d:Ljava/util/ArrayList;
...
# virtual methods
.method public a(Landroid/app/Activity;)Lj4/g;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lj4/k;->d(Landroid/content/Context;)Lj4/g;
...
.method public b(Landroid/app/Activity;)Lj4/g;
    .locals 3
    ...
    sget-object v2, Ln4/h;->a:Ln4/h;

    invoke-virtual {v2, p1}, Ln4/h;->a(Landroid/content/Context;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->h(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->g(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lj4/k;->e(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->i(Landroid/content/Context;)Landroidx/core/view/WindowInsetsCompat;
    ...
    invoke-direct {v1, v2}, Lh4/b;-><init>(Landroid/graphics/Rect;)V

    invoke-direct {v0, v1, p1}, Lj4/g;-><init>(Lh4/b;Landroidx/core/view/WindowInsetsCompat;)V

    return-object v0
.end method

.method public c(Landroid/content/Context;)Lj4/g;
    .locals 3
    ...
    invoke-virtual {v0, p1}, Ln4/h;->c(Landroid/content/Context;)Lj4/g;
    ...
    invoke-virtual {v0, p1}, Ln4/c;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->b(Landroid/app/Activity;)Lj4/g;
    ...
    invoke-virtual {p0, p1}, Lj4/k;->l(Landroid/view/Display;)Landroid/graphics/Point;
    ...
    invoke-direct {p1, v0, v2, v1, v2}, Lj4/g;-><init>(Landroid/graphics/Rect;Landroidx/core/view/WindowInsetsCompat;ILjg/f;)V
...
.method public d(Landroid/content/Context;)Lj4/g;
    .locals 6
    ...
    invoke-virtual {v2, p1}, Ln4/h;->d(Landroid/content/Context;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v2}, Lj4/k;->l(Landroid/view/Display;)Landroid/graphics/Point;
...
.method public final f(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, p1}, Ln4/b;->a(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0, v1}, Lj4/k;->l(Landroid/view/Display;)Landroid/graphics/Point;

    move-result-object v1

    invoke-virtual {p0, p1}, Lj4/k;->k(Landroid/content/Context;)I
...
.method public final g(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    sget-object v3, Ln4/b;->a:Ln4/b;

    invoke-virtual {v3, p1}, Ln4/b;->a(Landroid/app/Activity;)Z
    ...
    :goto_1
    sget-object v3, Lj4/k;->c:Ljava/lang/String;

    invoke-static {v3, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/Throwable;)I

    invoke-virtual {p0, p1, v0}, Lj4/k;->m(Landroid/app/Activity;Landroid/graphics/Rect;)V
    ...
    sget-object v4, Ln4/i;->a:Ln4/i;

    const-string v5, "currentDisplay"

    invoke-static {v1, v5}, Ljg/i;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v4, v1, v3}, Ln4/i;->a(Landroid/view/Display;Landroid/graphics/Point;)V

    sget-object v4, Ln4/b;->a:Ln4/b;

    invoke-virtual {v4, p1}, Ln4/b;->a(Landroid/app/Activity;)Z
    ...
    invoke-virtual {p0, v1}, Lj4/k;->j(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    sget-object v4, Ln4/n;->a:Ln4/n;

    invoke-virtual {v4, p1}, Ln4/n;->b(Landroid/view/DisplayCutout;)I
    ...
    invoke-virtual {v4, p1}, Ln4/n;->c(Landroid/view/DisplayCutout;)I
    ...
    invoke-virtual {v4, p1}, Ln4/n;->d(Landroid/view/DisplayCutout;)I
    ...
    invoke-virtual {v4, p1}, Ln4/n;->a(Landroid/view/DisplayCutout;)I
...
.method public final h(Landroid/app/Activity;)Landroid/graphics/Rect;
    ...
    :goto_0
    sget-object v1, Lj4/k;->c:Ljava/lang/String;
...
.method public final i(Landroid/content/Context;)Landroidx/core/view/WindowInsetsCompat;
    ...
    invoke-virtual {v0, p1}, Ln4/h;->b(Landroid/content/Context;)Landroidx/core/view/WindowInsetsCompat;
...
.method public final j(Landroid/view/Display;)Landroid/view/DisplayCutout;
    ...
    invoke-static {p1}, Lj4/i;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p1}, Lj4/j;->a(Ljava/lang/Object;)Landroid/view/DisplayCutout;
    ...
    :goto_0
    sget-object v0, Lj4/k;->c:Ljava/lang/String;
...
.method public final l(Landroid/view/Display;)Landroid/graphics/Point;
    ...
    invoke-virtual {v1, p1, v0}, Ln4/i;->a(Landroid/view/Display;Landroid/graphics/Point;)V
