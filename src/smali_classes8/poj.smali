...
.method public constructor <init>(Lcom/snapchat/client/grpc/UnifiedGrpcService;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lpoj;->a:Lcom/snapchat/client/grpc/UnifiedGrpcService;
...
# virtual methods
.method public final a(LH36;LUM8;LqN8;)V
    .locals 3
    ...
    .line 8
    .line 9
    invoke-direct {v0, p3, v1}, LGG1;-><init>(LqN8;Ljava/lang/Class;)V

    .line 10
    .line 11
    .line 12
    iget-object v1, p0, Lpoj;->a:Lcom/snapchat/client/grpc/UnifiedGrpcService;

    .line 13
    .line 14
    const-string v2, "/snapchat.lens.inlenscreation.InLensCreationService/DeleteAllCustomizations"
    ...
    .line 39
    invoke-interface {p3, p1, p2}, LqN8;->a(Lcom/google/protobuf/nano/MessageNano;Lcom/snapchat/client/grpc/Status;)V
