...
# direct methods
.method public static final a(LpC3;)Lio/reactivex/rxjava3/internal/operators/observable/ObservableOnErrorReturn;
    .locals 2

    .line 1
    sget-object v0, LQAd;->N0:LQAd;

    .line 2
    .line 3
    invoke-interface {p0, v0}, LpC3;->B(LBI3;)Lio/reactivex/rxjava3/core/Observable;
...
.method public static final b(LTla;)LRz8;
    .locals 10

    .line 1
    iget-wide v0, p0, LTla;->c:D
    ...
    .line 7
    iget-object p0, p0, LTla;->b:[LTla$a;
    ...
    .line 22
    .line 23
    iget-object v7, v5, LTla$a;->c:LFe3;

    .line 24
    .line 25
    invoke-static {v7}, Lprk;->z(LFe3;)I
    ...
    .line 32
    invoke-direct {v6, v7, v5}, Lef3;-><init>(IF)V
    ...
    .line 42
    .line 43
    invoke-direct {p0, v2, v0, v1}, LRz8;-><init>(Ljava/util/List;D)V
