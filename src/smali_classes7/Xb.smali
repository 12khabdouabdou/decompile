...
# direct methods
.method public constructor <init>(Lcom/snap/mushroom/app/MushroomApplication;Lio/reactivex/rxjava3/disposables/CompositeDisposable;LJ7d;LYb;)V
    .locals 0
    ...
    .line 3
    .line 4
    iput-object p2, p0, LXb;->a:Lio/reactivex/rxjava3/disposables/CompositeDisposable;

    .line 5
    .line 6
    iput-object p3, p0, LXb;->b:LJ7d;

    .line 7
    .line 8
    iput-object p4, p0, LXb;->c:LYb;
...
.method public final presentActionSheetForGroup(Ljava/lang/String;Lcom/snap/composer/blizzard/schema/AnalyticsContext;)V
    ...
    .line 6
    .line 7
    invoke-direct {v1, p1, p2, v0}, LeE8;-><init>(Ljava/lang/String;LcSa;LZ8d;)V

    .line 8
    .line 9
    .line 10
    iget-object p1, p0, LXb;->b:LJ7d;
    ...
    .line 16
    iget-object p2, p0, LXb;->a:Lio/reactivex/rxjava3/disposables/CompositeDisposable;
    ...
    .line 45
    .line 46
    invoke-static {v1, v2}, LDDi;->f(J)Landroid/os/VibrationEffect;
    ...
    .line 50
    invoke-virtual {p2, p1, v0}, LhU;->q(Landroid/os/Vibrator;Landroid/os/VibrationEffect;)V
    :try_end_0
