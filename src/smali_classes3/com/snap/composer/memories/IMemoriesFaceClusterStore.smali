...
.annotation runtime LZw3;
    ...
    proxyClass = LhW8;
    schema = "\'getAllClusters\':f|m|(): g<c>:\'[0]\'<a<r:\'[1]\'>>,\'loadCluster\':f|m|(d): g:\'[2]\'<r:\'[3]\'>,\'getClusteringProgress\':f?|m|(): g<c>:\'[0]\'<r:\'[4]\'>,\'tagCluster\':f?|m|(d, r:\'[5]\'): g<c>:\'[0]\'<b@>,\'tagCustomNameForCluster\':f?|m|(d, s): g<c>:\'[0]\'<b@>,\'untagCluster\':f?|m|(d): g<c>:\'[0]\'<b@>,\'updateTag\':f?|m|(a<r:\'[3]\'>, r:\'[5]\'): g<c>:\'[0]\'<d@>,\'mergeClusters\':f?|m|(d, d): g<c>:\'[0]\'<b@>,\'setClusterHidden\':f?|m|(d, b): g<c>:\'[0]\'<b@>,\'observeClusterTagInfo\':f?|m|(d): g<c>:\'[0]\'<r:\'[1]\'>,\'isCustomThresholdEnabled\':f?|m|(): g<c>:\'[0]\'<b@>,\'getClusteringThreshold\':f?|m|(): g<c>:\'[0]\'<d@>,\'recluster\':f?|m|(d): g<c>:\'[0]\'<b@>,\'removeSnapsFromFaceCluster\':f?|m|(a<s>, d): g<c>:\'[0]\'<b@>"
    typeReferences = {
...
.method public abstract tagCustomNameForCluster(DLjava/lang/String;)Lcom/snap/composer/bridge_observables/BridgeObservable;
    .annotation runtime LUy3;
    .end annotation
