...
.method public static declared-synchronized checkVersion(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 5
    .line 6
    invoke-direct {v1, p1, p2}, Lquk;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 7
    .line 8
    .line 9
    invoke-static {v1}, Lcom/google/vr/dynamite/client/DynamiteClient;->getRemoteLibraryLoaderFromInfo(Lquk;)Liuk;
    ...
    .line 14
    :try_start_1
    invoke-virtual {p1, p0}, Liuk;->b(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 18
    invoke-virtual {p1, p0}, Liuk;->a(Landroid/content/Context;)Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    ...
    .line 37
    .line 38
    invoke-virtual {v1}, Lquk;->toString()Ljava/lang/String;
    ...
    :try_end_1
    .catch Lduk; {:try_start_1 .. :try_end_1} :catch_0
    ...
    move-result p0
    :try_end_2
    .catch Lduk; {:try_start_2 .. :try_end_2} :catch_0
...
.method private static declared-synchronized getRemoteLibraryLoaderFromInfo(Lquk;)Liuk;
    .locals 3
    .annotation build Lcom/google/vr/dynamite/client/UsedByNative;
    .end annotation
    ...
    .line 15
    .line 16
    invoke-direct {v2, p0}, Liuk;-><init>(Lquk;)V
